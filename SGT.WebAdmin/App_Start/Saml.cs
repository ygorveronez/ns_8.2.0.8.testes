...
namespace SGT.WebAdmin.App_Start
{
    ...
    public partial class Response
    {
        ...
        private X509Certificate2 LoadCertificateFromMetadataUrl(string metadataUrl)
        {
            try
            {
                HttpClient client = HttpClientFactoryWrapper.GetClient(nameof(RSAPKCS1SHA256SignatureDescription));
        ...
        public bool IsValid(ref string msg)
        {
            ...
            if (IsExpired())
            {
                msg = Localization.Resources.Login.Login.NaoFoiPossivelValidarUsuarioAutenticacaoSAMLCertificadoExpirado;
                return false;
            }
