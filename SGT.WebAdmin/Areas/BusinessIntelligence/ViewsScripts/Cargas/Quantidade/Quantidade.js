/// <reference path="C:\Users\Willian\Documents\Visual Studio 2015\Projects\MultiCTe\SGT.WebAdmin\ViewsScripts/Enumeradores/EnumTipoQuantidadeCarga.js" />
...
var _pesquisaQuantidades, _graficoQuantidades;
...
function loadQuantidades() {
    _pesquisaQuantidades = new PesquisaQuantidades();
    KoBindings(_pesquisaQuantidades, "knockoutPesquisaQuantidade", false);

    new BuscarClientes(_pesquisaQuantidades.Destinatario);
    new BuscarCentrosCarregamento(_pesquisaQuantidades.CentroCarregamento);
    new BuscarRotasFrete(_pesquisaQuantidades.Rota);
    new BuscarFilial(_pesquisaQuantidades.Filial);
    new BuscarVeiculos(_pesquisaQuantidades.Veiculo);
    new BuscarTransportadores(_pesquisaQuantidades.Transportador);
    ...
    var options = {
        ...
        title: "Gráfico de Quantidade de Cargas",
        breadcumbTitle: "Quantidades Gerais",
        xTitle: "Quantidade",
        yTitle: "Situação",
        fileName: "Gráfico de Quantidades de Cargas",
        url: "BusinessIntelligence/Quantidade/ObterQuantidadesGerais",
        knockoutParams: _pesquisaQuantidades,
        drillDownSettings: function (obj) {
            ...
            //    url: "BusinessIntelligence/Quantidade/ObterQuantidadesPorTipo",
            //    drillDownSettings: {
            //        properties: {
            //            x: 'DiasAtraso',
            //            xType: ChartPropertyType.int,
            ...
            //        yTitle: 'Carga',
            //        breadcumbTitle: function (obj) {
            //            var title = "(" + obj.CPFCNPJFormatado + ") " + obj.Nome;
            //            if (title.length > 50)
            ...
            //        },
            //        drillDownParams: [{ property: 'Tipo', as: 'Tipo' },
            //                          { property: 'CPFCNPJFormatado', as: 'Destinatario' }],
            //        url: "BusinessIntelligence/Quantidade/ObterCargasPorTipoEDestinatario"
            //    }
            //};
