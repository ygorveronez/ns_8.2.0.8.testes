...
var _pesquisaValorMedioFrete, _graficoValorMedioFrete;

var PesquisaValorMedioFrete = function () {
...
function LoadValorMedioFrete() {
    _pesquisaValorMedioFrete = new PesquisaValorMedioFrete();
    KoBindings(_pesquisaValorMedioFrete, "knockoutPesquisaValorMedioFrete", false);

    new BuscarClientes(_pesquisaValorMedioFrete.Destinatario);
    new BuscarCentrosCarregamento(_pesquisaValorMedioFrete.CentroCarregamento);
    new BuscarTransportadores(_pesquisaValorMedioFrete.Transportador);
    new BuscarOperador(_pesquisaValorMedioFrete.Operador);
    new BuscarFilial(_pesquisaValorMedioFrete.Filial);
    new BuscarRotasFrete(_pesquisaValorMedioFrete.Rota);
    new BuscarTiposdeCarga(_pesquisaValorMedioFrete.TipoCarga);
    new BuscarModelosVeicularesCarga(_pesquisaValorMedioFrete.ModeloVeiculo);
    ...
    var options = {
        ...
        title: "Gráfico de Valor Médio de Frete",
        yTitle: "Valor Médio (em reais)",
        xTitle: "Unidade Utilizada",
        fileName: "Gráfico de Valor Médio de Frete",
        url: "BusinessIntelligence/ValorMedioFrete/ObterValoresGerais",
        knockoutParams: _pesquisaValorMedioFrete
    };

    _graficoValorMedioFrete = new Chart(options);

    _graficoValorMedioFrete.init();
}
...
function DownloadGraficoClick() {
    _graficoValorMedioFrete.download();
}