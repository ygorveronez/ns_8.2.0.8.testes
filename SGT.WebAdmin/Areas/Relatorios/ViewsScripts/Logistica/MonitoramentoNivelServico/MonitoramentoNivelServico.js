...
var PesquisaNivelServico = function () {
    ...
    this.DataConfirmacaoDocumentosInicial = PropertyEntity({ text: "Dt. Inicial Confir. Doc.:", dateRangeInit: this.DataConfirmacaoDocumentosInicial, getType: typesKnockout.date });
    this.DataConfirmacaoDocumentosFinal = PropertyEntity({ text: "Dt. Final Confir. Doc.:", getType: typesKnockout.date });
...
function LoadNivelServico() {
    ...
    }, null, "knockoutCRUDConfiguracaoRelatorio", _pesquisaNivelServico);
}
...
function GerarRelatorioPDFClick() {
    _relatorioNivelServico.gerarRelatorio("Relatorios/MonitoramentoNivelServico/GerarRelatorio", EnumTipoArquivoRelatorio.PDF);
}

function GerarRelatorioExcelClick() {
    _relatorioNivelServico.gerarRelatorio("Relatorios/MonitoramentoNivelServico/GerarRelatorio", EnumTipoArquivoRelatorio.XLS);
}