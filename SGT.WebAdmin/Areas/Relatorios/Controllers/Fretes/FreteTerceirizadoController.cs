...
namespace SGT.WebAdmin.Areas.Relatorios.Controllers.Fretes
{
    ...
    public class FreteTerceirizadoController : BaseController
    {
		#region Construtores

		public FreteTerceirizadoController(Conexao conexao) : base(conexao) { }

		#endregion

        #region Atributos

        Dominio.Relatorios.Embarcador.Enumeradores.CodigoControleRelatorios CodigoControleRelatorio = Dominio.Relatorios.Embarcador.Enumeradores.CodigoControleRelatorios.R055_FreteTerceirizado;
        ...
        public async Task<IActionResult> BuscarDadosRelatorio(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                Dominio.Entidades.Embarcador.Relatorios.Relatorio relatorio = await serRelatorio.BuscarConfiguracaoPadraoAsync(CodigoControleRelatorio, TipoServicoMultisoftware, "Relatório de Fretes Terceirizados", "Fretes", "FreteTerceirizado.rpt", Dominio.Relatorios.Embarcador.Enumeradores.OrientacaoRelatorio.Retrato, "ContratoFrete", "asc", "", "", codigoRelatorio, unitOfWork, true, true);
        ...
        public async Task<IActionResult> Pesquisa(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                Dominio.ObjetosDeValor.Embarcador.Frete.FiltroPesquisaRelatorioFreteTerceirizado filtrosPesquisa = ObterFiltrosPesquisa();
                ...
                Servicos.Embarcador.Relatorios.Fretes.FreteTerceirizado servicoRelatorioFreteTerceirizado = new Servicos.Embarcador.Relatorios.Fretes.FreteTerceirizado(unitOfWork, TipoServicoMultisoftware, Cliente, cancellationToken);

                var listaFrete = await servicoRelatorioFreteTerceirizado.ConsultarRegistrosAsync(filtrosPesquisa, agrupamentos, parametrosConsulta);

                grid.setarQuantidadeTotal(await servicoRelatorioFreteTerceirizado.ContarConsultarRegistrosAsync(filtrosPesquisa, agrupamentos));                
        ...
        private async Task<Models.Grid.Grid> GridPadrao(Repositorio.UnitOfWork unitOfWork, CancellationToken cancellationToken)
        {
            ...
            grid.AdicionarCabecalho("Vl. do ICMS", "ValorICMS", TamanhoColunaPequena, Models.Grid.Align.right, true, false, false, false, TipoSumarizacao.sum);
            grid.AdicionarCabecalho("Vl. do Frete", "ValorFrete", TamanhoColunaPequena, Models.Grid.Align.right, true, false, false, false, TipoSumarizacao.sum);
            grid.AdicionarCabecalho("Vl. a Receber", "ValorReceber", TamanhoColunaPequena, Models.Grid.Align.right, true, false, false, true, TipoSumarizacao.sum);
            ...
            grid.AdicionarCabecalho("Vl. Adiantamento", "ValorAdiantamento", TamanhoColunaPequena, Models.Grid.Align.left, true, false, false, false, TipoSumarizacao.sum);
            ...
            grid.AdicionarCabecalho("Vl. Abastecimento", "ValorAbastecimento", TamanhoColunaPequena, Models.Grid.Align.left, true, false, false, false, TipoSumarizacao.sum);
            grid.AdicionarCabecalho("Frete Sem Abastecimento", "ValorFreteMenosAbastecimento", TamanhoColunaPequena, Models.Grid.Align.left, true, false, false, false, TipoSumarizacao.sum);
            grid.AdicionarCabecalho("Vl. Pago", "ValorPago", TamanhoColunaPequena, Models.Grid.Align.left, true, false, false, true, TipoSumarizacao.sum);
            grid.AdicionarCabecalho("Vl. Saldo", "ValorSaldo", TamanhoColunaPequena, Models.Grid.Align.left, true, false, false, false, TipoSumarizacao.sum);
            grid.AdicionarCabecalho("Vl. Bruto", "ValorBruto", TamanhoColunaPequena, Models.Grid.Align.left, true, false, false, false, TipoSumarizacao.sum);
            ...
            grid.AdicionarCabecalho("Acréscimos", "ValorAcrescimos", TamanhoColunaPequena, Models.Grid.Align.left, true, false, false, false, TipoSumarizacao.sum);
            grid.AdicionarCabecalho("Descontos", "ValorDescontos", TamanhoColunaPequena, Models.Grid.Align.left, true, false, false, false, TipoSumarizacao.sum);
            ...
            grid.AdicionarCabecalho("Tipo documento", "TipoDocumento", TamanhoColunaPequena, Models.Grid.Align.left, true, false, false, true, false);
            ...
            grid.AdicionarCabecalho("Série CT-es", "SerieCTes", TamanhoColunaGrande, Models.Grid.Align.left, false, false, false, false, false);
            grid.AdicionarCabecalho("Status CT-es", "StatusCTes", TamanhoColunaGrande, Models.Grid.Align.left, false, false, false, false, false);
            grid.AdicionarCabecalho("B.C. do ICMS", "BCICMS", TamanhoColunaMedia, Models.Grid.Align.right, false, false, false, false, TipoSumarizacao.sum);
            ...
            grid.AdicionarCabecalho("Peso (Kg)", "PesoKg", TamanhoColunaMedia, Models.Grid.Align.right, false, false, false, false, TipoSumarizacao.sum);
            ...
            grid.AdicionarCabecalho("Total de Descontos", "TotalDescontos", TamanhoColunaPequena, Models.Grid.Align.left, true, false, false, false, TipoSumarizacao.sum);
            grid.AdicionarCabecalho("Saldo Frete", "SaldoFrete", TamanhoColunaPequena, Models.Grid.Align.left, true, false, false, false, TipoSumarizacao.sum);
            ...
            for (int i = 0; i < componentes.Count; i++)
            {
                ...
                {
                    grid.AdicionarCabecalho(componentes[i].Descricao, "ValorComponente" + UltimaColunaDinanica.ToString(), TamanhoColunaPequena, Models.Grid.Align.right, false, false, false, false, TipoSumarizacao.sum, componentes[i].Codigo);
            ...
            grid.AdicionarCabecalho("Valor a Receber da Carga", "ValorReceberCTes", TamanhoColunaPequena, Models.Grid.Align.right, false, TipoSumarizacao.sum, false);
            ...
            grid.AdicionarCabecalho("Data Carga", "DataCargaFormatada", TamanhoColunaMedia, Models.Grid.Align.center, true, false, false, true, false);
            ...
            grid.AdicionarCabecalho("Código Retorno ST", "CodigoRetornoST", TamanhoColunaGrande, Models.Grid.Align.right, false, false, false, false, false);
            grid.AdicionarCabecalho("Código Retorno SU", "CodigoRetornoSUFormatado", TamanhoColunaGrande, Models.Grid.Align.right, false, false, false, false, false);
            grid.AdicionarCabecalho("Código Integração", "CodigoIntegracao", TamanhoColunaGrande, Models.Grid.Align.right, false, false, false, false, false);
            grid.AdicionarCabecalho("Operadora", "OperadoraDescricao", TamanhoColunaGrande, Models.Grid.Align.right, false, false, false, false, false);
            grid.AdicionarCabecalho("Centro Custo de Viagem", "CentroCustoViagem", TamanhoColunaGrande, Models.Grid.Align.left, false, false, false, false, false);

            return grid;
        }

        private Dominio.ObjetosDeValor.Embarcador.Frete.FiltroPesquisaRelatorioFreteTerceirizado ObterFiltrosPesquisa()
        {
            return new Dominio.ObjetosDeValor.Embarcador.Frete.FiltroPesquisaRelatorioFreteTerceirizado()
            {
