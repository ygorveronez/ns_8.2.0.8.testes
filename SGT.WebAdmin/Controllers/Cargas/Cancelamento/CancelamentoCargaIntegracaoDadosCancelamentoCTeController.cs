...
{
    public class CancelamentoCargaIntegracaoDadosCancelamentoCTeController : BaseController
    {
		#region Construtores

		public CancelamentoCargaIntegracaoDadosCancelamentoCTeController(Conexao conexao) : base(conexao) { }
        ...
        public async Task<IActionResult> Pesquisa()
        {
            ...
            try
            {
                Repositorio.Embarcador.Cargas.CargaCancelamentoCargaCTeIntegracaoDados repIntegracaoDadosCancelamento = new Repositorio.Embarcador.Cargas.CargaCancelamentoCargaCTeIntegracaoDados(unitOfWork);
                ...
                List<Dominio.Entidades.Embarcador.Cargas.CargaCancelamentoCargaCTeIntegracaoDados> listaDadosCancelamento = repIntegracaoDadosCancelamento.Consultar(codigo, situacao, "Codigo", grid.dirOrdena, grid.inicio, grid.limite);
        ...
        public async Task<IActionResult> ObterTotais()
        {
            ...
            try
            {
                ...
                Repositorio.Embarcador.Cargas.CargaCancelamentoCargaCTeIntegracaoDados repIntegracao = new Repositorio.Embarcador.Cargas.CargaCancelamentoCargaCTeIntegracaoDados(unitOfWork);
        ...
        public async Task<IActionResult> ReenviarDadosCancelamento()
        {
            ...
            try
            {
                ...
                Dominio.Entidades.Embarcador.Cargas.CargaCancelamentoCargaCTeIntegracaoDados integracaoDadosCancelamento = repIntegracao.BuscarPorCodigo(codigo, false);
        ...
        public async Task<IActionResult> ReenviarTodosDadosCancelamento()
        {
            ...
            try
            {
                ...
                Repositorio.Embarcador.Cargas.CargaCancelamentoCargaCTeIntegracaoDados repIntegracaoDadosCancelamento = new Repositorio.Embarcador.Cargas.CargaCancelamentoCargaCTeIntegracaoDados(unitOfWork);
                List<Dominio.Entidades.Embarcador.Cargas.CargaCancelamentoCargaCTeIntegracaoDados> integracoesPendentes = repIntegracaoDadosCancelamento.BuscarIntegracoesPorCargaCancelamento(codigo);
        ...
        public async Task<IActionResult> ConsultarHistoricoIntegracao()
        {
            ...
            try
            {
                ...
                Dominio.Entidades.Embarcador.Cargas.CargaCancelamentoCargaCTeIntegracaoDados integracao = repIntegracaoDadosCancelamento.BuscarPorCodigo(codigo);
        ...
        public async Task<IActionResult> DownloadArquivosHistoricoIntegracao()
        {
            ...
            try
            {
                ...
                Dominio.Entidades.Embarcador.Cargas.CargaCancelamentoCargaCTeIntegracaoDados integracao = repIntegracaoDadosCancelamento.BuscarPorCodigoArquivo(codigo);
