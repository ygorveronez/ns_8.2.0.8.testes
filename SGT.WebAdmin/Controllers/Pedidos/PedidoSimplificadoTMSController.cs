...
namespace SGT.WebAdmin.Controllers.Pedidos
{
    ...
    public class PedidoSimplificadoTMSController : BaseController
    {
        #region Construtores

        public PedidoSimplificadoTMSController(Conexao conexao) : base(conexao) { }
        ...
        public async Task<IActionResult> Adicionar()
        {
            ...
            try
            {
                ...
                if (IsGerarCargaAutomaticamente(pedidoBase) && pedido.SituacaoPedido != SituacaoPedido.AutorizacaoPendente && pedido.EtapaPedido != EtapaPedido.AgAutorizacao)
                {
        ...
        public async Task<IActionResult> Atualizar()
        {
            ...
            try
            {
                ...
                decimal novaQtdePalletFracionado = Request.GetDecimalParam("QuantidadePallets");
                ...
                if (pedido.TipoOperacao != null && !pedido.TipoOperacao.GeraCargaAutomaticamente)
                {
                    ...
                    if (cargasPedido.Count == 0)
                    {
                        ...
                        Servicos.Log.TratarErro($"Pedido {pedido.NumeroPedidoEmbarcador} - Liberou saldo pedido {pedido.PesoSaldoRestante} - Peso Total.: {pedido.PesoTotal} - Totalmente carregado.: {pedido.PedidoTotalmenteCarregado}. PedidoSimplificadoTMSController.Atualizar", "SaldoPedido");
                    }
                }
        ...
        public async Task<IActionResult> BuscarPorCodigo()
        {
            ...
            try
            {
                ...
                var dynPedido = new
                {
                    ...
                    QuantidadePallets = pedido.NumeroPaletesFracionado > 0 ? pedido.NumeroPaletesFracionado.ToString("n3") : "",
                    ...
                    TipoCarga = pedido.TipoDeCarga != null ? new { pedido.TipoDeCarga?.Codigo, pedido.TipoDeCarga?.Descricao } : null,
        ...
        private Dominio.Entidades.Embarcador.Pedidos.Pedido ObterPedidoBase(Repositorio.UnitOfWork unitOfWork)
        {
            ...
            pedido.NumeroPaletesFracionado = Request.GetDecimalParam("QuantidadePallets");
            ...
            int modeloVeicularCarga = Request.GetIntParam("ModeloVeicularCarga");
            ...
            if (pedido.TipoOperacao != null)
            {
                if (!pedido.TipoOperacao.GeraCargaAutomaticamente)
                {
                    ...
                    pedido.PedidoTotalmenteCarregado = false;
                    //TODO: PPC - Adicionado log temporário para identificar problema de retorno de saldo de pedido.
                    Servicos.Log.TratarErro($"Pedido {pedido.NumeroPedidoEmbarcador} - Liberou saldo pedido {pedido.PesoSaldoRestante} - Peso Total.: {pedido.PesoTotal} - Totalmente carregado.: {pedido.PedidoTotalmenteCarregado}. PedidoSimplificadoTMSController.ObterPedidoBase", "SaldoPedido");
                }
            ...
            pedido.Filial = repFilial.BuscarPorCodigo(codigoFilial > 0 ? codigoFilial : 0);
