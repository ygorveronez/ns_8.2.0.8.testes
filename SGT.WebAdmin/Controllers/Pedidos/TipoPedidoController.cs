...
{
    [CustomAuthorize("Pedidos/TipoPedido")]
    public class TipoPedidoController : BaseController
    {
		#region Construtores

		public TipoPedidoController(Conexao conexao) : base(conexao) { }
        ...
        public async Task<IActionResult> Pesquisa()
        {
            ...
            try
            {
                ...
                Repositorio.TipoColeta repTipoCarga = new Repositorio.TipoColeta(unitOfWork);

                List<Dominio.Entidades.TipoColeta> tiposDeCarga = repTipoCarga.Consultar(descricao, grid.header[grid.indiceColunaOrdena].data, grid.dirOrdena, grid.inicio, grid.limite);
