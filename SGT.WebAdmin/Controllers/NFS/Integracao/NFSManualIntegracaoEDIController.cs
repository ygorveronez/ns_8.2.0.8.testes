...
namespace SGT.WebAdmin.Controllers.NFS.Integracao
{
    ...
    public class NFSManualIntegracaoEDIController : BaseController
    {
		#region Construtores

		public NFSManualIntegracaoEDIController(Conexao conexao) : base(conexao) { }
        ...
        public async Task<IActionResult> Pesquisa()
        {
            ...
            try
            {
                ...
                Repositorio.Embarcador.NFS.NFSManualEDIIntegracao repIntegracao = new Repositorio.Embarcador.NFS.NFSManualEDIIntegracao(unidadeDeTrabalho);

                int countEDIs = repIntegracao.ContarConsulta(codigoLancamentoNFSManual, situacao);

                List<Dominio.Entidades.Embarcador.NFS.NFSManualEDIIntegracao> listaIntegracao = new List<Dominio.Entidades.Embarcador.NFS.NFSManualEDIIntegracao>();
                ...
                if (countEDIs > 0)
                {
                    ...
                    listaIntegracao = repIntegracao.Consultar(codigoLancamentoNFSManual, situacao, propOrdena, grid.dirOrdena, grid.inicio, grid.limite);
                }
        ...
        public async Task<IActionResult> ObterTotais()
        {
            ...
            try
            {
                ...
                Repositorio.Embarcador.NFS.NFSManualEDIIntegracao repLancamentoNFSManualEDIIntegracao = new Repositorio.Embarcador.NFS.NFSManualEDIIntegracao(unidadeDeTrabalho);

                int totalAguardandoIntegracao = repLancamentoNFSManualEDIIntegracao.ContarPorLancamentoNFSManual(codigoLancamentoNFSManual, Dominio.ObjetosDeValor.Embarcador.Enumeradores.SituacaoIntegracao.AgIntegracao);
                int totalIntegrado = repLancamentoNFSManualEDIIntegracao.ContarPorLancamentoNFSManual(codigoLancamentoNFSManual, Dominio.ObjetosDeValor.Embarcador.Enumeradores.SituacaoIntegracao.Integrado);
                int totalProblemaIntegracao = repLancamentoNFSManualEDIIntegracao.ContarPorLancamentoNFSManual(codigoLancamentoNFSManual, Dominio.ObjetosDeValor.Embarcador.Enumeradores.SituacaoIntegracao.ProblemaIntegracao);
        ...
        public async Task<IActionResult> Reenviar()
        {
            ...
            try
            {
                ...
                Dominio.Entidades.Embarcador.NFS.NFSManualEDIIntegracao cargaEDIIntegracao = repLancamentoNFSManualEDIIntegracao.BuscarPorCodigo(codigo);
                ...
                //if (!permissoesPersonalizadas.Contains(AdminMultisoftware.Dominio.Enumeradores.PermissaoPersonalizada.LancamentoNFSManual_ReenviarIntegracoes) && cargaEDIIntegracao.SituacaoIntegracao != Dominio.ObjetosDeValor.Embarcador.Enumeradores.SituacaoIntegracao.ProblemaIntegracao)
                ...
                repLancamentoNFSManualEDIIntegracao.Atualizar(cargaEDIIntegracao);
        ...
        public async Task<IActionResult> ReenviarTodos()
        {
            ...
            try
            {
                ...
                List<Dominio.Entidades.Embarcador.NFS.NFSManualEDIIntegracao> integracoes = repLancamentoNFSManualEDIIntegracao.BuscarPorLancamentoNFSManual(codigoLancamentoNFSManual, situacao);

                foreach (Dominio.Entidades.Embarcador.NFS.NFSManualEDIIntegracao integracao in integracoes)
                {
                    if (integracao.TipoIntegracao.Tipo != Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoIntegracao.NaoPossuiIntegracao)
                    {
                        ...
                        repLancamentoNFSManualEDIIntegracao.Atualizar(integracao);
                    }
                }
        ...
        public async Task<IActionResult> Download()
        {
            ...
            try
            {
                ...
                Dominio.Entidades.Embarcador.NFS.NFSManualEDIIntegracao nfsManualEDIIntegracao = repLancamentoNFSManualEDIIntegracao.BuscarPorCodigo(codigo);
                ...
                System.IO.MemoryStream edi = Servicos.Embarcador.Integracao.IntegracaoEDI.GerarEDI(nfsManualEDIIntegracao, TipoServicoMultisoftware, unidadeDeTrabalho, _conexao.StringConexao, out extensao);
                    ...
                    nfsManualEDIIntegracao.SituacaoIntegracao == Dominio.ObjetosDeValor.Embarcador.Enumeradores.SituacaoIntegracao.AgIntegracao)
                {
                    ...
                    repLancamentoNFSManualEDIIntegracao.Atualizar(nfsManualEDIIntegracao);
                    ...
                    Servicos.Embarcador.Integracao.IntegracaoNFSManual.AtualizarSituacaoNFSManualIntegracao(nfsManualEDIIntegracao.LancamentoNFSManual, configuracao, unidadeDeTrabalho, _conexao.StringConexao, TipoServicoMultisoftware);
