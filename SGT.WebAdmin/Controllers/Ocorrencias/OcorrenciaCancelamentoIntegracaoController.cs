...
namespace SGT.WebAdmin.Controllers.Ocorrencias
{
    ...
    public class OcorrenciaCancelamentoIntegracaoController : BaseController
    {
		#region Construtores

		public OcorrenciaCancelamentoIntegracaoController(Conexao conexao) : base(conexao) { }
        ...
        public async Task<IActionResult> Pesquisa()
        {
            ...
            try
            {
                ...
                Repositorio.Embarcador.Ocorrencias.OcorrenciaCancelamentoIntegracao repositorioIntegracao = new Repositorio.Embarcador.Ocorrencias.OcorrenciaCancelamentoIntegracao(unitOfWork);
                ...
                List<Dominio.Entidades.Embarcador.Ocorrencias.OcorrenciaCancelamentoIntegracao> listaIntegracao = (totalRegistros > 0) ? repositorioIntegracao.Consultar(codigoOcorrenciaCancelamento, situacao, parametrosConsulta) : new List<Dominio.Entidades.Embarcador.Ocorrencias.OcorrenciaCancelamentoIntegracao>();
        ...
        public async Task<IActionResult> Reenviar()
        {
            ...
            try
            {
                ...
                Dominio.Entidades.Embarcador.Ocorrencias.OcorrenciaCancelamentoIntegracao integracao = repositorioIntegracao.BuscarPorCodigo(codigo);
                ...
                Servicos.Auditoria.Auditoria.Auditar(Auditado, integracao.OcorrenciaCancelamento.Ocorrencia, null, "Reenviou integração.", unitOfWork);
        ...
        public async Task<IActionResult> ReenviarTodos()
        {
            ...
            try
            {
                ...
                List<Dominio.Entidades.Embarcador.Ocorrencias.OcorrenciaCancelamentoIntegracao> listaIntegracao = repositorioIntegracao.Consultar(codigoOcorrenciaCancelamento, situacao, parametrosConsulta: null);
        ...
        public async Task<IActionResult> DownloadArquivosHistoricoIntegracao()
        {
            ...
            {
                int codigo = Request.GetIntParam("Codigo");
                Repositorio.Embarcador.Ocorrencias.OcorrenciaCancelamentoIntegracao repositorioIntegracao = new Repositorio.Embarcador.Ocorrencias.OcorrenciaCancelamentoIntegracao(unidadeDeTrabalho);
                Dominio.Entidades.Embarcador.Ocorrencias.OcorrenciaCancelamentoIntegracao integracao = repositorioIntegracao.BuscarPorCodigoArquivo(codigo);

                if (integracao == null)
                    return new JsonpResult(true, false, "Histórico não encontrado.");

                Dominio.Entidades.Embarcador.Ocorrencias.OcorrenciaCancelamentoIntegracaoArquivo arquivoIntegracao = integracao.ArquivosTransacao.Where(o => o.Codigo == codigo).FirstOrDefault();
