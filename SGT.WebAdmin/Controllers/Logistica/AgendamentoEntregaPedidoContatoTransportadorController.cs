...
namespace SGT.WebAdmin.Controllers.Logistica
{
    ...
    public class AgendamentoEntregaPedidoContatoTransportadorController : BaseController
    {
        #region Construtores

        public AgendamentoEntregaPedidoContatoTransportadorController(Conexao conexao) : base(conexao) { }
        ...
        public async Task<IActionResult> AnexarArquivos()
        {
            ...
            try
            {
                ...
                List<Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo> anexos = new();
                if (arquivos.Count <= 0)
                {
                    for (int i = 0; i < descricoes?.Count(); i++)
                    {
                        Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo anexo = new Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo()
                        {
                ...
                foreach (Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo anexo in anexos)
                {
                    foreach (Dominio.Entidades.Embarcador.Pedidos.Pedido pedido in pedidos)
                    {
                        Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo anexoTemp = anexo.Clonar<Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo>();
        ...
        public async Task<IActionResult> DownloadAnexo()
        {
            ...
            try
            {
                int codigo = Request.GetIntParam("Codigo");
                Repositorio.Embarcador.Anexo.Anexo<Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo, Dominio.Entidades.Embarcador.Pedidos.Pedido> repositorioAnexo = new Repositorio.Embarcador.Anexo.Anexo<Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo, Dominio.Entidades.Embarcador.Pedidos.Pedido>(unitOfWork);
                Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo anexo = repositorioAnexo.BuscarPorCodigo(codigo, true);
        ...
        public async Task<IActionResult> ExcluirAnexo()
        {
            ...
            try
            {
                ...
                int codigo = Request.GetIntParam("Codigo");
                Repositorio.Embarcador.Anexo.Anexo<Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo, Dominio.Entidades.Embarcador.Pedidos.Pedido> repositorioAnexo = new Repositorio.Embarcador.Anexo.Anexo<Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo, Dominio.Entidades.Embarcador.Pedidos.Pedido>(unitOfWork);
                Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo anexo = repositorioAnexo.BuscarPorCodigo(codigo);
        ...
        public async Task<IActionResult> ObterAnexo()
        {
            ...
            try
            {
                ...
                List<Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo> anexos;
                ...
                if (pedidos.Count > 0)
                {
                    ...
                    anexos = new List<Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoTransportadorAnexo>();
