...
namespace SGT.WebAdmin.Controllers.Bidding
{
    ...
    public class BiddingConviteAprovacaoController : BaseController
    {
		#region Construtores

		public BiddingConviteAprovacaoController(Conexao conexao) : base(conexao) { }
        ...
        public async Task<IActionResult> DetalhesAutorizacao()
        {
            ...
            try
            {
                ...
                Dominio.Entidades.Embarcador.Bidding.AlcadasBidding.AprovacaoAlcadaBiddingConvite autorizacao = repositorioAprovacao.BuscarPorCodigo(codigo);
        ...
        public async Task<IActionResult> ObterDetalhesGeraisAprovacao()
        {
            ...
            try
            {
                ...
                Dominio.Entidades.Embarcador.Bidding.BiddingConvite biddingConvite = repBiddingConvite.BuscarPorCodigo(codigo, false);

                if (biddingConvite == null)
                    return new JsonpResult(false, true, "Bidding Convite não encontrado.");

                return new JsonpResult(Servicos.Embarcador.Bidding.BiddingConviteAprovacao.ObterDetalhesAprovacao(biddingConvite, unitOfWork));
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> PesquisaAutorizacoes()
        {
            ...
            try
            {
                ...
                Repositorio.Embarcador.Bidding.AlcadasBidding.AprovacaoAlcadaBiddingConvite repositorioAprovacao = new Repositorio.Embarcador.Bidding.AlcadasBidding.AprovacaoAlcadaBiddingConvite(unitOfWork);
                List<Dominio.Entidades.Embarcador.Bidding.AlcadasBidding.AprovacaoAlcadaBiddingConvite> listaAutorizacao = repositorioAprovacao.ConsultarAutorizacoes(codigo, parametrosConsulta);
        ...
        public async Task<IActionResult> ReprocessarRegras()
        {
            ...
            try
            {
                ...
                if (biddingConvite.Status != StatusBiddingConvite.SemRegra)
