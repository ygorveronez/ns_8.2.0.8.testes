    ...
    $.fn.rowReordering = function (options) {
        ...
        function fnGetStartPosition(oTable, sSelector) {
            ...
            $(sSelector, oTable).each(function () {
                let iPosition = parseInt(oTable.fnGetData(this, properties.iIndexColumn), 10);
                if (iPosition < iStart)
                    iStart = iPosition;
            });
            return iStart;
        ...
        $.each(tables, function () {
            ...
            $("tbody", oTable).sortable({
                ...
                update: function (event, ui) {
                    let $dataTable = oTable;
                    let tbody = $(this);
                    let sSelector = "tbody tr";
                    let sGroup = "";
                    let tr = $(ui.item[0]);

                    if (properties.bGroupingUsed) {
                        sGroup = tr.attr(properties.sDataGroupAttribute);
                    ...
                    let oState = fnGetState($dataTable, sSelector, tr);
                    /// ### END ###
                        ...
                        let oAjaxRequest = {
                            ...
                            success: function (data) {
                                ...
                                if (!properties.avoidMovingRows)
                                    fnMoveRows($dataTable, sSelector, oState.iCurrentPosition, oState.iNewPosition, oState.sDirection, itemId, sGroup);
                                // ### END ###
                            ...
                            error: function (jqXHR) {
                                ...
                                let err = (jqXHR.responseText != "" ? jqXHR.responseText : jqXHR.statusText);
