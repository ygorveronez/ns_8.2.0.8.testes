...
var Responsive = function (settings, opts) {
	...
	this.c = $.extend(true, {}, Responsive.defaults, $.fn.dataTable.defaults.responsive, opts);
...
$.extend(Responsive.prototype, {
	...
	_constructor: function () {
		...
		// resize
		$(window).on('resize.dtr orientationchange.dtr', $.fn.dataTable.util.throttle(function () {
