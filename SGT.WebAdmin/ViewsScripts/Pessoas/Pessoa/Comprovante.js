...
var Comprovante = function () {
    ...
    this.Comprovante = PropertyEntity({ type: types.event, text: Localization.Resources.Pessoas.Pessoa.AdicionarComprovante, idBtnSearch: guid() });
    this.NaoUtilizarConfiguracoesDeComprovantesDoGrupoPessoa = PropertyEntity({ getType: typesKnockout.bool, text: Localization.Resources.Pessoas.Pessoa.NaoUtilizarConfiguracoesDeComprovantesDoGrupoPessoa });
    this.ExigirComprovantesLiberacaoPagamentoContratoFrete = PropertyEntity({ getType: typesKnockout.bool, text: Localization.Resources.Pessoas.Pessoa.ExigirComprovantesLiberacaoPagamentoContratoFrete });
}
...
function loadComprovante() {
    ...
    { data: "Descricao", title: Localization.Resources.Pessoas.Pessoa.Descricao, width: "80%" }];
...
function recarregarGridComprovante() {
    ...
    if (!string.IsNullOrWhiteSpace(_pessoa.Comprovantes.val())) {

        $.each(_pessoa.Comprovantes.val(), function (i, comprovante) {
