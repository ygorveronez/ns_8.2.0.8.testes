...
function criarHTMLModulosMobile(modulos) {
    ...
    $.each(modulos, function (i, modulo) {
        html += "<li>";
        html += "<span><i class='fa fa-lg " + modulo.Icone + "'></i> " + modulo.Descricao + "</span> &nbsp; <text style='position:absolute; margin-top:7px;'><input type='checkbox' onclick='ckbModuloLiberadoMobileClick(" + modulo.CodigoModulo + ");' id='ckbModuloLiberadoMobile_" + modulo.CodigoModulo + "' name='checkbox-inline'>&nbsp; <label for='ckbModuloLiberadoMobile_" + modulo.CodigoModulo + "' > " + Localization.Resources.Pessoas.Usuario.LiberarAcessoTotalAoMenu + " " + modulo.Descricao + "</label></text>";
...
function criarHTMLFormulariosMobile(modulo) {
    ...
    html += "<thead>";
    html += "<tr>";
    html += "<td style='width:8%' title='" + Localization.Resources.Pessoas.Usuario.LiberarAcesso + "'><input type='checkbox' style='margin-top:0px' onclick='ckbTodosFormulariosMobileClick(" + modulo.CodigoModulo + ");' id='ckb_liberarTodosMobile_" + modulo.CodigoModulo + "' />&nbsp;<label for='ckb_liberarTodosMobile_" + modulo.CodigoModulo + "'>" + Localization.Resources.Pessoas.Usuario.LiberarAcesso + "</label></td>";
    html += "<td style='width:8%' title='" + Localization.Resources.Pessoas.Usuario.LiberarAcesso + "'><input type='checkbox' style='margin-top:0px'  onclick='ckbSomenteLeituraTodosFormulariosMobileClick(" + modulo.CodigoModulo + ");' id='ckb_SomenteLeituraTodos_" + modulo.CodigoModulo + "' />&nbsp;<label for='ckb_SomenteLeituraTodos_" + modulo.CodigoModulo + "'>" + Localization.Resources.Pessoas.Usuario.LiberarAcesso + " </label></td>";
...
function buscarPermissoesFormulariosMobile() {
    _usuario.FormulariosUsuarioMobile.list = new Array();
    _usuario.ModulosUsuarioMobile.list = new Array();
...
function PreencherPermissoesMobile(modulos) {
    $.each(modulos, function (i, modulo) {
        if ($("#ckbModuloLiberadoMobile_" + modulo.CodigoModulo).prop("checked")) {
            ...
            _usuario.ModulosUsuarioMobile.list.push(moduloMap);
        }
        ...
        $.each(modulo.Formularios, function (j, formulario) {
            if ($("#ckbLiberarMobile_" + formulario.CodigoFormulario).prop("checked")) {
                ...
                _usuario.FormulariosUsuarioMobile.list.push(formularioMap);
            }
        });
...
function setarPermissoesModulosFormulariosMobile() {
    $.each(_usuario.ModulosUsuarioMobile.list, function (i, modulo) {
    ...
    $.each(_usuario.FormulariosUsuarioMobile.list, function (i, formulario) {
