var EnumTipoFreeTimeTabelaFreteHelper = function () {
    this.Nenhum = 0;
    this.Coleta = 1;
    this.Fronteira = 2;
    this.Entrega = 3;
...
EnumTipoFreeTimeTabelaFreteHelper.prototype = {
...
var EnumTipoFreeTimeTabelaFrete = Object.freeze(new EnumTipoFreeTimeTabelaFreteHelper());