...
var DetalheDocumento = function () {
    ...
    this.AliquotaICMS = PropertyEntity({ text: "Aliquota ICMS:", val: ko.observable(""), icon: ko.observable("fas fa-check"), color: ko.observable("green"), bgColor: ko.observable(""), aprovado: _CONFIGURACAO_TMS.ValidarSomenteFreteLiquidoNaImportacaoCTe });
    this.BaseCalculoICMS = PropertyEntity({ text: "Base de Calculo:", val: ko.observable(""), icon: ko.observable("fas fa-check"), color: ko.observable("green"), bgColor: ko.observable(""), aprovado: _CONFIGURACAO_TMS.ValidarSomenteFreteLiquidoNaImportacaoCTe });
    this.ValorICMS = PropertyEntity({ text: "Valor ICMS:", val: ko.observable(""), icon: ko.observable("fas fa-check"), color: ko.observable("green"), bgColor: ko.observable(""), aprovado: _CONFIGURACAO_TMS.ValidarSomenteFreteLiquidoNaImportacaoCTe });
    ...
    this.CST = PropertyEntity({ text: "CST:", val: ko.observable(""), icon: ko.observable("fas fa-check"), color: ko.observable("green"), bgColor: ko.observable(""), aprovado: _CONFIGURACAO_TMS.ValidarSomenteFreteLiquidoNaImportacaoCTe });
    ...
    this.Rota = PropertyEntity({ text: "Rota:", val: ko.observable(""), icon: ko.observable("fas fa-check"), color: ko.observable("green"), bgColor: ko.observable("") });
    this.CFOP = PropertyEntity({ text: "CFOP:", val: ko.observable(""), icon: ko.observable("fas fa-check"), color: ko.observable("green"), bgColor: ko.observable(""), visible: !_CONFIGURACAO_TMS.ValidarSomenteFreteLiquidoNaImportacaoCTe });
    ...
    this.DonwloadDacteCTe = PropertyEntity({ eventClick: baixarDacteControleDocumentoClick, type: types.event, text: "Donwload DACTE", idGrid: guid(), visible: ko.observable(true), icon: ko.observable("fas fa-check"), color: ko.observable("green"), bgColor: ko.observable("") });
    this.DetalhesCTe = PropertyEntity({ eventClick: detalhesCTeControleDocumentoClick, type: types.event, text: "Detalhes CT-e", idGrid: guid(), visible: ko.observable(true), icon: ko.observable("fa fa-check"), color: ko.observable("green"), bgColor: ko.observable("") });
}
...
function baixarDacteControleDocumentoClick(detalhesDocumento) {
    var data = { CodigoCTe: detalhesDocumento.Codigo.val(), CodigoEmpresa: detalhesDocumento.CodigoEmpresa.val() };
    executarDownload("CargaCTe/DownloadDacte", data);
}

function detalhesCTeControleDocumentoClick(detalhesDocumento) {
