...
var _configuracaoRegras = {
    ...
    Alcadas: [
        ...
        {
            descricao: "Motivo de Rejeição",
            prop: "MotivoRejeicao",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Enum,
            opcoes: EnumMotivoInconsistenciaGestaoDocumento.obterOpcoes(),
            visivel: true
        },
        {
        ...
        },
        {
            ...
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.MultiplasEntidades,
            busca: function (ko) {
                new BuscarTransportadores(ko, null, null, true);
            },
            visivel: true
        },
        {
            descricao: "Canal de Entrega",
            prop: "CanalEntrega",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.MultiplasEntidades,
            busca: function (ko) {
                new BuscarCanaisEntrega(ko);
            },
            visivel: true
        },
        {
...
var _nomeControllerRegrasAutorizacao = "RegraAutorizacaoGestaoDocumentos";
