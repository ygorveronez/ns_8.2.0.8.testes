...
function SetarEtapaMDFe() {
    var situacao = _cargaMDFeManual.Situacao.val();

    if (situacao == EnumSituacaoMDFeManual.Cancelado)
        situacao = _cargaMDFeManual.SituacaoCancelamento.val();
...
function Etapa4Aguardando() {
    ...
    Etapa3Aprovada();
    _etapa.Etapa4.eventClick = BuscarDadosIntegracoesMDFeManual;
    Global.ExibirStep(_etapa.Etapa4.idTab);
    BuscarDadosIntegracoesMDFeManual();
}
