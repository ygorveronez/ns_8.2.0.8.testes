...
function LoadConexaoSignalRCargaMDFeManual() {
    SignalRCargaMDFeManualAlteradoEvent = VerificarCargaMDFeManaulAlteradaEvent;
}

function VerificarCargaMDFeManaulAlteradaEvent(retorno) {
    if (retorno.CodigoCargaMDFeManual == _cargaMDFeManual.Codigo.val()) {
        _RequisicaoIniciada = true;
        BuscarCargaMDFeManualPorCodigo(function () {
