...
var _configuracaoRegras = {
    ...
    Alcadas: [
        ...
        {
            descricao: "Centro de Carregamento",
            prop: "CentroCarregamento",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Entidade,
            busca: function (ko) {
                new BuscarCentrosCarregamento(ko);
            }
        },
        {
            ...
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Entidade,
            busca: function (ko) {
                new BuscarEmpresa(ko);
            }
        },
        {
            descricao: "Valor do Leilão",
            prop: "Valor",
...
var _nomeControllerRegrasAutorizacao = "RegraAutorizacaoLeilao";
...
var CRUDRegrasAutorizacao = function () {
    this.Adicionar = PropertyEntity({ eventClick: adicionarClick, type: types.event, text: "Adicionar", visible: ko.observable(true) });
    this.Cancelar = PropertyEntity({ eventClick: cancelarClick, type: types.event, text: "Limpar / Nova", visible: ko.observable(true) });
...
function loadRegrasAutorizacao() {
    ...
    _CRUDRegrasAutorizacao = new CRUDRegrasAutorizacao();
    KoBindings(_CRUDRegrasAutorizacao, "knockoutCRUDRegras");
...
function editarRegraAprovacao(data) {
    ...
    BuscarPorCodigo(_regrasAutorizacao, _nomeControllerRegrasAutorizacao + "/BuscarPorCodigo", function (arg) {
        ...
        _CRUDRegrasAutorizacao.Adicionar.visible(false);
        _CRUDRegrasAutorizacao.Cancelar.visible(true);
        _CRUDRegrasAutorizacao.Atualizar.visible(true);
        _CRUDRegrasAutorizacao.Excluir.visible(true);
    }, null);
}
...
function limparTodosCampos() {
    ...
    _CRUDRegrasAutorizacao.Adicionar.visible(true);
    _CRUDRegrasAutorizacao.Cancelar.visible(true);
    _CRUDRegrasAutorizacao.Atualizar.visible(false);
    _CRUDRegrasAutorizacao.Excluir.visible(false);
}
...
function obterObjetoRegraSalvar() {
    var dados = {
        ...
        Status: _regrasAutorizacao.Ativo.val(),
