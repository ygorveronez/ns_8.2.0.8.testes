...
var _situacaoIntegracaoEDI = [{ value: "", text: Localization.Resources.Gerais.Geral.Todas },
...
var IntegracaoEDI = function () {
    ...
    this.Situacao = PropertyEntity({ val: ko.observable(""), options: _situacaoIntegracaoEDI, text: Localization.Resources.Gerais.Geral.Situacao.getFieldDescription(), def: "", issue: 272 });
...
function LoadIntegracaoEDI(cargaCancelamento, idKnockoutIntegracaoEDI) {

    _integracaoEDI = new IntegracaoEDI();

    _integracaoEDI.CargaCancelamento.val(cargaCancelamento.Codigo.val());
...
function ConfigurarPesquisaIntegracaoEDI() {
    var download = { descricao: Localization.Resources.Gerais.Geral.Download, id: guid(), metodo: DownloadIntegracaoEDI, tamanho: "20", icone: "" };
    var reenviar = { descricao: Localization.Resources.Gerais.Geral.Reenviar, id: guid(), metodo: ReenviarIntegracaoEDI, tamanho: "20", icone: "", visibilidade: VisibilidadeOpcaoReenviarIntegracaoEDI };
    var auditar = { descricao: Localization.Resources.Gerais.Geral.Auditar, id: guid(), metodo: OpcaoAuditoria("CargaCancelamentoIntegracaoEDI"), icone: "", visibilidade: VisibilidadeOpcaoAuditoria };
    ...
    _gridIntegracaoEDI = new GridView(_integracaoEDI.Pesquisar.idGrid, "CancelamentoCargaIntegracaoEDI/Pesquisa", _integracaoEDI, menuOpcoes);
...
function DownloadIntegracaoEDI(data) {
    executarDownload("CancelamentoCargaIntegracaoEDI/Download", { Codigo: data.Codigo });
}

function ReenviarIntegracaoEDI(data) {
    executarReST("CancelamentoCargaIntegracaoEDI/Reenviar", { Codigo: data.Codigo }, function (r) {
        if (r.Success) {
...
function ReenviarTodosIntegracaoEDI() {
    exibirConfirmacao("Atenção!", Localization.Resources.CArgas.CancelamentoCarga.ReenviarIntegraçõesEDI, function () {
        executarReST("CancelamentoCargaIntegracaoEDI/ReenviarTodos", { CancelamentoCarga: _integracaoEDI.CargaCancelamento.val(), Situacao: _integracaoEDI.Situacao.val() }, function (r) {
            if (r.Success) {
                exibirMensagem(tipoMensagem.ok, Localization.Resources.Gerais.Geral.Sucesso, Localization.Resources.Gerais.Geral.ReenvioSolicitadoComSucesso);
                _gridIntegracaoEDI.CarregarGrid();
            } else {
...
function ObterTotaisIntegracaoEDI() {
    executarReST("CancelamentoCargaIntegracaoEDI/ObterTotais", { CancelamentoCarga: _integracaoEDI.CargaCancelamento.val() }, function (r) {
        if (r.Success) {
