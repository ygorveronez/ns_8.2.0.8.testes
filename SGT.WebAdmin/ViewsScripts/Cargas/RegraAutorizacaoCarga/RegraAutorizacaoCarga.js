...
var _configuracaoRegras = {
    ...
    Alcadas: [
        {
            descricao: "Componente de Frete",
            prop: "ComponenteFrete",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Entidade,
            busca: function (ko) {
                BuscarComponentesDeFrete(ko);
            },
            visivel: true
        },
        {
        ...
        },
        {
            ...
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Entidade,
            busca: function (ko) {
                BuscarModelosVeicularesCarga(ko);
            },
            visivel: true
        },
        {
        ...
        },
        {
            ...
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.MultiplasEntidades,
            busca: function (ko) {
                BuscarTiposOperacao(ko);
            },
            visivel: true
        },
        {
            descricao: "Motivo Solicitação de Frete",
            prop: "MotivoSolicitacaoFrete",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.MultiplasEntidades,
            busca: function (ko) {
                BuscarMotivoSolicitacaoFrete(ko);
            },
            visivel: true
        },
        {
            descricao: "Valor de Frete",
            prop: "ValorFrete",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Decimal,
            visivel: true
        },
        {
            descricao: "Margem do peso máximo do Container",
            prop: "PesoContainer",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Decimal,
            visivel: true
        },
        {
            descricao: "Percentual de Acréscimo no Valor da Tabela de Frete",
            prop: "PercentualAcrescimoValorTabelaFrete",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Decimal,
            visivel: true
        },
        {
            descricao: "Percentual de Desconto no Valor da Tabela de Frete",
            prop: "PercentualDescontoValorTabelaFrete",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Decimal,
            visivel: true
        },
        {
            descricao: "Percentual de Diferença do Frete Bruto para o Frete com Terceiro",
            prop: "PercentualDiferencaFreteLiquidoFreteTerceiro",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Decimal,
            visivel: true
        },
        {
            descricao: "Percentual de Diferença do Frete Liquido para o Frete com Terceiro",
            prop: "PercentualDiferencaFreteLiquidoTotalFreteTerceiro",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Decimal,
            visivel: true
        },
        {
            descricao: "Valor de Acréscimo no Valor da Tabela de Frete",
            prop: "ValorAcrescimoValorTabelaFrete",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Decimal,
            visivel: true
        },
        {
            descricao: "Percentual de frete sobre a nota",
            prop: "PercentualFreteSobreNota",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Decimal,
            visivel: true
        },
        {
            descricao: "Dif. Valor de Frete",
            prop: "DiferencaValorFrete",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Decimal,
            visivel: true
        },
        {
            descricao: "Tipo de Terceiro",
            prop: "AutorizacaoTipoTerceiro",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Entidade,
            busca: function (ko) {
                BuscarTipoTerceiro(ko);
            },
            visivel: true
        },
    ]
...
var _nomeControllerRegrasAutorizacao = "RegraAutorizacaoCarga";
...
var PesquisaRegrasAutorizacao = function () {
    ...
    this.TipoRegra = PropertyEntity({ val: ko.observable(""), options: EnumTipoRegraAutorizacaoCarga.ObterOpcoesPesquisa(), def: "", text: "Tipo:" });
...
var RegrasAutorizacao = function () {
    ...
    this.TipoRegra = PropertyEntity({ val: ko.observable(EnumTipoRegraAutorizacaoCarga.InformadoManualmente), options: EnumTipoRegraAutorizacaoCarga.ObterOpcoes(), def: EnumTipoRegraAutorizacaoCarga.InformadoManualmente, text: "*Tipo: " });
    ...
    _configuracaoRegras.Alcadas.forEach(function (alcada) {
        ...
        if (alcada.prop == "ComponenteFrete") {
            this["ValidarAcrescimoValorTabelaFretePorComponenteFrete"] = PropertyEntity({ val: ko.observable(false), def: false, text: "Validar o Acréscimo no Valor da Tabela de Frete pelo Componente de Frete", visible: ko.observable(true) });
        }
    ...
    this.ExigirInformarJustificativaCustoExtraCadastrado = PropertyEntity({ val: ko.observable(false), def: false, text: "Exigir informar a justificativa do custo extra cadastrado", visible: ko.observable(_CONFIGURACAO_TMS.HabilitarFuncionalidadesProjetoGollum) });
}
...
function obterObjetoRegraSalvar() {
    ...
    let dados = {
        ...
        TipoRegra: _regrasAutorizacao.TipoRegra.val(),
        EnviarLinkParaAprovacaoPorEmail: _regrasAutorizacao.EnviarLinkParaAprovacaoPorEmail.val(),
        ExigirInformarJustificativaCustoExtraCadastrado: _regrasAutorizacao.ExigirInformarJustificativaCustoExtraCadastrado.val(),
        ValidarAcrescimoValorTabelaFretePorComponenteFrete: _regrasAutorizacao.ValidarAcrescimoValorTabelaFretePorComponenteFrete.val()
    };
...
function salvarRegras(url, mensagemSucesso) {
    ...
    let listaMensagemErros = validarRegras();
