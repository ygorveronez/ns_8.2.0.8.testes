...
var _nomeControllerRegrasAutorizacao = "RegraAutorizacaoCargaCancelamento";
...
var RegrasAutorizacao = function () {
    ...
    this.TipoAprovadorRegra = PropertyEntity({ val: ko.observable(EnumTipoAprovadorRegra.Usuario), options: EnumTipoAprovadorRegra.obterOpcoesPorTransportador(), def: EnumTipoAprovadorRegra.Usuario, text: "*Tipo do Aprovador: ", visible: true });
    ...
    this.TipoAprovadorRegra.val.subscribe(function (novoValor) {
        if (novoValor == EnumTipoAprovadorRegra.Transportador) {
            _regrasAutorizacao.NumeroAprovadores.val("1");
            _regrasAutorizacao.NumeroAprovadores.enable(false);
        }
        else
            _regrasAutorizacao.NumeroAprovadores.enable(true);
    });
