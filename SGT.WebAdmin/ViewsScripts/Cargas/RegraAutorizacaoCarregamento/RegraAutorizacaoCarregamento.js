...
var _configuracaoRegras = {
    ...
    Alcadas: [
        ...
        {
            descricao: "Percentual de Ocupação da Cubagem",
            prop: "PercentualOcupacaoCubagem",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Decimal,
            visivel: !_CONFIGURACAO_TMS.UtilizaEmissaoMultimodal
        },
        {
            descricao: "Percentual de Ocupação de Pallets",
            prop: "PercentualOcupacaoPallet",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Decimal,
            visivel: !_CONFIGURACAO_TMS.UtilizaEmissaoMultimodal
        },
        {
            descricao: "Percentual de Ocupação do Peso",
            prop: "PercentualOcupacaoPeso",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Decimal,
            visivel: !_CONFIGURACAO_TMS.UtilizaEmissaoMultimodal
        },
        {
            descricao: "Diferença no Valor da Apólice do Transportador",
            prop: "DiferencaValorApoliceTransportador",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Decimal,
            visivel: _CONFIGURACAO_TMS.TipoServicoMultisoftware == EnumTipoServicoMultisoftware.MultiEmbarcador
        }
    ]
};

var _nomeControllerRegrasAutorizacao = "RegraAutorizacaoCarregamento";
