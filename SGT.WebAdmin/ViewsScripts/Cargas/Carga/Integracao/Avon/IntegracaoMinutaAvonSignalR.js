...
function LoadConexaoSignalRMinutaAvon() {
    SignalRMinutaAvonAtualizadaEvent = VerificarMinutaAvonAtualizadaEvent;
}

function VerificarMinutaAvonAtualizadaEvent(retorno) {
    if (_listaKnoutsCarga != null) {
        ...
        if (podeAtualizar)
            HandleAtualizacaoMinutaAvonSignalR(retorno, _listaKnoutsCarga[indiceKnout]);
    }
}