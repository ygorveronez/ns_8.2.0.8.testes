...
function buscarCargasCargaDocumentoParaEmissaoNFSManual(callback) {

    //var retornoNFS = { descricao: "Mensagem Retorno", id: guid(), metodo: retornoNFSClick, icone: "", visibilidade: VisibilidadeRetorno };
    //var emitirNFS = {
    //    descricao: "Emitir", id: guid(), metodo: function (datagrid) {
    //        emitirNFSeClick(datagrid, _cargaAtual);
    //    }, icone: "", visibilidade: VisibilidadePendente
    //};
    //var baixarDANFSE = { descricao: "Baixar DANFSE", id: guid(), metodo: baixarDANFSEClick, icone: "", visibilidade: VisibilidadeAutorizado };
    //var baixarXMLNFSe = { descricao: "Baixar XML", id: guid(), metodo: baixarXMLNFSeClick, icone: "", visibilidade: VisibilidadeAutorizado };
    //var menuOpcoesNFS = { tipo: TypeOptionMenu.list, descricao: "Opções", tamanho: 7, opcoes: [emitirNFS, retornoNFS, baixarXMLNFSe, baixarDANFSE] };

    _gridDocumentoParaMessiaoNFSManual = new GridView(_cargaCTe.PesquisarDocumentosParaEmissaoNFSManual.idGrid, "CargaNFS/ConsultarCargaDocumentoParaEmissaoNFSManual", _cargaCTe, null, null);
    _gridDocumentoParaMessiaoNFSManual.CarregarGrid(callback);
}
