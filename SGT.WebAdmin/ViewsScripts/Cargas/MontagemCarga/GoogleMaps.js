...
function MensagemDirectionsStatus(status) {
    switch (status) {
        case google.maps.DirectionsStatus.NOT_FOUND: return Localization.Resources.Cargas.MontagemCarga.ServidorAPINaoConseguiuResolverAlgumDosPontosInformadosNaRota;
        case google.maps.DirectionsStatus.ZERO_RESULTS: return Localization.Resources.Cargas.MontagemCarga.NaoFoiEncontradaNenhumaRotaEntreOrigemDestinoVerifiqueOsPontosQueCompoeCarregamento;
        case google.maps.DirectionsStatus.MAX_WAYPOINTS_EXCEEDED: return Localization.Resources.Cargas.MontagemCarga.QuantidadeDePontosParaRoterizacaoFoiExcedida;
        case google.maps.DirectionsStatus.MAX_ROUTE_LENGTH_EXCEEDED: return Localization.Resources.Cargas.MontagemCarga.RotaMuitoLongaOuCOmplexaNaoPodeSerProcessadaPeloServidorAPI;
        case google.maps.DirectionsStatus.INVALID_REQUEST: return Localization.Resources.Cargas.MontagemCarga.RotaInvalidaParaProcessamento;
        case google.maps.DirectionsStatus.OVER_QUERY_LIMIT: return Localization.Resources.Cargas.MontagemCarga.PaginaUltrapassouLimiteDeRequisicoesDentroDoPeriodoPermitido;
        case google.maps.DirectionsStatus.REQUEST_DENIED: return Localization.Resources.Cargas.MontagemCarga.PaginaEstaSemPermissaoParaUsarServico;
        default: return Localization.Resources.Cargas.MontagemCarga.ServidorRetornouUmaSituacaoInesperada;
    }
}
