...
var Anexos = function () {
    ...
    this.config = PropertyEntity({
        ...
        url: {
            excluir: "SolicitacaoAvaria/ExcluirAnexao",
            download: "SolicitacaoAvaria/DownloadAnexo",
            anexar: "SolicitacaoAvaria/AnexarArquivos?callback=?"
        }
    });
}
...
function GetCodigoTela() {
    return _solicitacaoAvaria.Codigo.val();
}
...
function PodeGerenciarAnexos() {
    ...
    return EnumSituacaoAvaria.Todas == situacao || EnumSituacaoAvaria.Aberta == situacao || EnumSituacaoAvaria.EmCriacao == situacao
}
