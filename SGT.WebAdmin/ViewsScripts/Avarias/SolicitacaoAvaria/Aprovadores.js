...
var _detalhesSolicitacao;
var _gridAutorizacoes;
var _detalheAutorizacao;

var DetalheSolicitacao = function () {
...
function loadAutorizadores() {
    _detalhesSolicitacao = new DetalheSolicitacao();
    KoBindings(_detalhesSolicitacao, "knockoutAvariaAprovacao");
...
function GridAprovadores() {
    ...
    _gridAutorizacoes = new GridView(_detalhesSolicitacao.UsuariosAutorizadores.idGrid, "SolicitacaoAvaria/ConsultarAutorizacoes", _solicitacaoAvaria, menuOpcoes);
}
...
function BuscarRegrasDaEtapa() {
    ...
    executarReST("SolicitacaoAvaria/AtualizarRegrasEtapas", dados, function (arg) {
        if (arg.Success) {
            if (arg.Data != null) {
                _solicitacaoAvaria.Situacao.val(arg.Data.Situacao);
                setarEtapasAvaria();
