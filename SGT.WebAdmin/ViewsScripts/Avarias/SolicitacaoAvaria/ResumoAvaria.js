...
function PreecherResumoAvaria() {
    BuscarPorCodigo(_resumoAvaria, "SolicitacaoAvaria/ResumoSolicitacao", function (arg) {
...
function AtualizarValorAvaria() {
    executarReST("SolicitacaoAvaria/ValorAvaria", { Codigo: _solicitacaoAvaria.Codigo.val() }, function (arg) {
