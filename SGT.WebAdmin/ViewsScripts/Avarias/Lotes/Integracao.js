...
function CarregaIntegracao() {
    _integracao.Lote.val(_lote.Codigo.val());
    ObterTotaisIntegracaoEDI();
...
function ConfigurarPesquisaIntegracaoEDI() {
    ...
    _gridIntegracao = new GridView(_integracao.Pesquisar.idGrid, "LoteIntegracaoEDI/Pesquisa", _integracao, menuOpcoes);
    _gridIntegracao.CarregarGrid();
}