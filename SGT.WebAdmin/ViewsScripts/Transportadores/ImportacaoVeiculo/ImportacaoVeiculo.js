...
function loadImportacaoVeiculo() {
...
function importarClick() {
    if (ValidarCamposObrigatorios(_importacao)) {
        exibirConfirmacao("Atenção!", "Deseja realmente importar os veículos do transportador " + _importacao.TransportadorOrigem.val() + " para o transportador " + _importacao.TransportadorDestino.val() + "?", function () {
            Salvar(_importacao, "ImportacaoVeiculo/Importar", function (r) {
                if (r.Success) {
