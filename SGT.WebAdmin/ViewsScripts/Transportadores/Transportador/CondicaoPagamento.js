...
var CadastroCondicaoPagamento = function () {
    ...
    this.DiaEmissaoLimite = PropertyEntity({ val: ko.observable(0), options: _diaMes, def: "", text: Localization.Resources.Transportadores.Transportador.DiaEmissaoLimite.getFieldDescription(), required: false });
    this.DiaMes = PropertyEntity({ val: ko.observable(0), options: _diaMes, def: "", text: Localization.Resources.Transportadores.Transportador.DiaMes.getFieldDescription(), required: false });
    this.DiasDePrazoPagamento = PropertyEntity({ text: ko.observable(Localization.Resources.Transportadores.Transportador.DiasPrazoPagamento.getFieldDescription()), required: false, visible: ko.observable(true), maxlength: 4, getType: typesKnockout.int, val: ko.observable(""), def: "" });
    this.DiaSemana = PropertyEntity({ val: ko.observable(0), options: EnumDiaSemana.obterOpcoesSemConfiguracao(), def: 0, text: Localization.Resources.Transportadores.Transportador.DiaSemana.getFieldDescription(), required: false });
    this.TipoCarga = PropertyEntity({ type: types.entity, codEntity: ko.observable(0), required: false, text: Localization.Resources.Transportadores.Transportador.TipoCarga.getFieldDescription(), idBtnSearch: guid() });
    ...
    this.TipoPrazoPagamento = PropertyEntity({ val: ko.observable(1), options: EnumTipoPrazoPagamento.obterOpcoes(), def: 1, text: Localization.Resources.Transportadores.Transportador.TipoPrazoPagamento.getFieldDescription(), required: false });
    this.VencimentoForaMes = PropertyEntity({ text: Localization.Resources.Transportadores.Transportador.VencimentoForaMes.getFieldDescription(), getType: typesKnockout.bool, val: ko.observable(false), def: false });
    this.ConsiderarDiaUtilVencimento = PropertyEntity({ text: Localization.Resources.Transportadores.Transportador.ConsiderarDiaUtilVencimento.getFieldDescription(), getType: typesKnockout.bool, val: ko.observable(false), def: false });
}

var CondicaoPagamento = function () {
    this.AtivarCondicao = PropertyEntity({ text: Localization.Resources.Transportadores.Transportador.AtivarCondicaoPagamento, getType: typesKnockout.bool, val: ko.observable(false), def: false });
    ...
    this.Adicionar = PropertyEntity({ eventClick: adicionarCondicaoPagamentoModalClick, type: types.event, text: Localization.Resources.Transportadores.Transportador.AdicionarCondicaoPagamento });
}
...
function loadGridCondicaoPagamento() {
    ...
    var opcaoEditar = { descricao: Localization.Resources.Gerais.Geral.Editar, id: guid(), metodo: editarCondicaoPagamentoClick, icone: "" };
    ...
    var header = [
        ...
        { data: "DiaSemanaDescricao", title: Localization.Resources.Transportadores.Transportador.DiaSemana, width: "10%", className: "text-align-center", orderable: false },
        { data: "DiaMesDescricao", title: Localization.Resources.Transportadores.Transportador.DiaMes, width: "10%", className: "text-align-center", orderable: false },
        { data: "DiaEmissaoLimiteDescricao", title: Localization.Resources.Transportadores.Transportador.DiaEmissaoLimite, width: "10%", className: "text-align-center", orderable: false },
        { data: "VencimentoForaMesDescricao", title: Localization.Resources.Transportadores.Transportador.VencimentoForaMes, width: "10%", className: "text-align-center", orderable: false },
        { data: "TipoPrazoPagamentoDescricao", title: Localization.Resources.Transportadores.Transportador.TipoPrazo, width: "10%", className: "text-align-center", orderable: false },
        { data: "DiasDePrazoPagamento", title: Localization.Resources.Transportadores.Transportador.DiasPrazo, width: "10%", className: "text-align-center", orderable: false },
        { data: "DescricaoTipoCarga", title: Localization.Resources.Transportadores.Transportador.TipoCarga, width: "10%", className: "text-align-left", orderable: false },
        { data: "DescricaoTipoOperacao", title: Localization.Resources.Transportadores.Transportador.TipoOperacao, width: "10%", className: "text-align-left", orderable: false }
    ];
...
function loadCondicaoPagamento() {
    ...
    _diaMes = [
        { text: Localization.Resources.Transportadores.Transportador.SemConfiguracao, value: "" }
    ];
    ...
    new BuscarTiposdeCarga(_cadastroCondicaoPagamento.TipoCarga);
    new BuscarTiposOperacao(_cadastroCondicaoPagamento.TipoOperacao);
...
function atualizarCondicaoPagamentoClick() {
    if (ValidarCamposObrigatorios(_cadastroCondicaoPagamento)) {
        var listaCondicaoPagamento = obterListaCondicaoPagamento();
...
function excluirCondicaoPagamentoClick() {
    exibirConfirmacao(Localization.Resources.Gerais.Geral.Confirmacao, Localization.Resources.Transportadores.Transportador.RealmenteDesejaExcluirCondicãoPagamento, function () {
...
function preencherCondicaoPagamentoSalvar(transportador) {
    transportador["AtivarCondicao"] = _condicaoPagamento.AtivarCondicao.val();
    transportador["CondicoesPagamento"] = obterCondicaoPagamentosSalvar();
}
