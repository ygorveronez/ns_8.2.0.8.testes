...
//    this.Layout = PropertyEntity({ type: types.entity, codEntity: ko.observable(0), text: "*Layout EDI: ", idBtnSearch: guid(), required: true });
...
//    //if (_permissao_acesso_layouts_edi == null || !_permissao_acesso_layouts_edi.Acesso) {
//    //    $("#liTabLayoutsEDI").addClass("d-none");
//    //    return;
//    //}
...
//    $.each(_transportador.LayoutsEDI.list, function (i, layoutEDI) {
...
//            _transportador.LayoutsEDI.list.splice(i, 1);
//    });
...
//        _transportador.LayoutsEDI.list.push(SalvarListEntity(_layoutEDI));
