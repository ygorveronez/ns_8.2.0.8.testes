...
var Filial = function () {
    ...
    // Controle de uso
    this.RegraPorFilial = PropertyEntity({ getType: typesKnockout.bool, text: "Ativar Regra de autorização por Filial:", val: ko.observable(false), def: false, visible: ko.observable(true) });
    this.RegraPorFilial.val.subscribe(function (novoValor) {
        SincronzarRegras();
        RegraPorFilial(novoValor);
    });
