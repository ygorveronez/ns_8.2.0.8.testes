...
var _modalEnvioDetalhesCargaEmail;
...
function loadEnvioDetalhesCargaEmail() {
    ...
    _modalEnvioDetalhesCargaEmail = new bootstrap.Modal(document.getElementById("divModalEnvioDetalhesCargaEmail"), { backdrop: 'static', keyboard: true });
}
...
function enviarEmailEnvioDetalhesCargaClick(e, sender) {
    ...
    executarReST("Guarita/EnviarDetalhesCargaPorEmail", { Codigo: _detalhesCargaEmail.Codigo.val(), Emails: JSON.stringify(_emailsEnvioDetalhesCarga), Observacao: _detalhesCargaEmail.Observacao.val() }, function (r) {
        if (r.Success) {
            if (r.Data) {
                _modalEnvioDetalhesCargaEmail.hide();
...
function abrirTelaEnvioDetalhesCargaEmailClick(e) {
    ...
    _modalEnvioDetalhesCargaEmail.show();
}
