...
function LoadConexaoSignalRNFSManualCancelamento() {
    SignalRNFSManualAlteradoCancelamentoEvent = VerificarCargaMDFeManaulAlteradaCancelamentoEvent;
}

function VerificarCargaMDFeManaulAlteradaCancelamentoEvent(retorno) {
    if (retorno.CodigoNFSManualCancelamento == _cancelamento.Codigo.val()) {
