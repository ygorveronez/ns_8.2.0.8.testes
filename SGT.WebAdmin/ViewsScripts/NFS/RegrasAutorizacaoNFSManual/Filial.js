...
function loadFilial() {
    ...
    //-- Grid Regras
    _gridRegrasFilial = new GridReordering(_configRegras.infoTable, _filial.Regras.idGrid, GeraHeadTable("Filial de Ocorrência"));
    _gridRegrasFilial.CarregarGrid();
    $("#" + _filial.Regras.idGrid).on('sortstop', function () {
        LinhasReordenadasNFSManual(_filial);
    });
}
