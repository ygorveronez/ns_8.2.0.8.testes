...
var _alcadas = [
    ...
    {
        descricao: "Motivo Avaria",
        prop: "MotivoAvaria",
        tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Entidade,
        busca: function (ko) {
            new BuscarMotivoAvariaPallet(ko);
        }
    },
    {
        descricao: "Setor",
...
var _configuracaoRegras = {
    ...
    Alcadas: (_CONFIGURACAO_TMS.TipoServicoMultisoftware == EnumTipoServicoMultisoftware.MultiTMS ? _alcadasTMS : _alcadas)
};

var _nomeControllerRegrasAutorizacao = "RegraAutorizacaoAvaria";
