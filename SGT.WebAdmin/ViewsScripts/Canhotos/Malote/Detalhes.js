...
var DetalhesCanhoto = function () {
    ...
    this.Auditar = PropertyEntity({ eventClick: auditarCanhotoClick, type: types.event, text: "Auditar", visible: ko.observable(true) });
...
function loadDetalhesCanhoto() {
    ...
    GridCanhotos();
    _modalDetalhesCanhoto = new bootstrap.Modal(document.getElementById("ModalDivDetalhesCanhoto"), { backdrop: true, keyboard: true });
}
...
function detalhesCanhotoClick(e) {
    BuscarDetalhesCanhoto(e.Codigo, function () {
        _modalDetalhesCanhoto.show();
    });
}

function GridCanhotos() {
    //-- Grid
    // Opcoes
    var detalhes = { descricao: "Detalhes", id: "clasEditar", evento: "onclick", metodo: detalhesCanhotoClick, tamanho: "10", icone: "" };
    ...
    _gridCanhoto = new GridView(_malote.Codigo.idGrid, "MaloteCanhoto/PesquisaCanhotos", _malote, menuOpcoes, null);
