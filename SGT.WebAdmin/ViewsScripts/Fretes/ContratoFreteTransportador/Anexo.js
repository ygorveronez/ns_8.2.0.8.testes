...
var Anexos = function () {
    ...
    this.config = PropertyEntity({
        msg: {
            situacaonaopermite: "Situação do Contrato de Frete não permite excluir arquivos."
        },
        url: {
            excluir: "ContratoFreteTransportadorAnexo/ExcluirAnexo",
            download: "ContratoFreteTransportadorAnexo/DownloadAnexo",
            anexar: "ContratoFreteTransportadorAnexo/AnexarArquivos?callback=?"
        }
    });
}
...
function GetCodigoTela() {
    return _contratoFreteTransportador.Codigo.val();
}
...
function PodeGerenciarAnexos() {
    ...
    return EnumSituacaoContratoFreteTransportador.Novo == situacao || EnumSituacaoContratoFreteTransportador.AgAprovacao == situacao || EnumSituacaoContratoFreteTransportador.SemRegra == situacao;
}
