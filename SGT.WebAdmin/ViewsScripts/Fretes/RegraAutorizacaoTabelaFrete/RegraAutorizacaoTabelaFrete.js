...
var _nomeControllerRegrasAutorizacao = "RegraAutorizacaoTabelaFrete";
...
var RegrasAutorizacao = function () {
    ...
    this.TipoAprovadorRegra = PropertyEntity({ val: ko.observable(EnumTipoAprovadorRegra.Usuario), options: EnumTipoAprovadorRegra.obterOpcoesPorTransportador(), def: EnumTipoAprovadorRegra.Usuario, text: "*Tipo do Aprovador: ", visible: _CONFIGURACAO_TMS.UtilizarAlcadaAprovacaoTabelaFretePorTabelaFreteCliente });
...
function loadRegrasAutorizacao() {
    ...
    new BuscarTabelasDeFrete(_regrasAutorizacao.TabelaFrete);

    // AdicionarTransportadorRetorno
    ...
    if (_CONFIGURACAO_TMS.TipoServicoMultisoftware == EnumTipoServicoMultisoftware.MultiTMS) {
        ...
        $("#liRegrasValorFrete").hide();
        $("#liRegrasAdValorem").hide();
        $("#liRegrasValorPedagio").hide();
    }
}
...
function obterObjetoRegraSalvar() {
    var dados = {
        ...
        TabelaFrete: _regrasAutorizacao.TabelaFrete.codEntity(),
