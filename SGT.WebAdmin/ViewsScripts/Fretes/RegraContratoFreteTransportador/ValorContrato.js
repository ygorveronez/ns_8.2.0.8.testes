...
/// <reference path="../../Enumeradores/EnumCondicaoAutorizaoContrato.js" />
/// <reference path="../../Enumeradores/EnumJuncaoAutorizaoContrato.js" />
/// <reference path="RegrasAutorizacaoContrato.js" />
...
function loadValorContrato() {
    ...
    KoBindings(_valorContrato, "knockoutRegraValorContrato");
    ...
    $("#" + _valorContrato.Alcadas.idGrid).on('sortstop', function () {
        LinhasReordenadasContrato(_valorContrato);
    });
}
