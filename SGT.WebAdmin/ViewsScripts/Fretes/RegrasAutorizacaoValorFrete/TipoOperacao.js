...
function loadTipoOperacao() {
    ...
    //-- Grid Regras
    _gridRegrasTipoOperacao = new GridReordering(_configRegras.infoTable, _tipoOperacao.Regras.idGrid, GeraHeadTable("TipoOperacao"));
    _gridRegrasTipoOperacao.CarregarGrid();
    $("#" + _tipoOperacao.Regras.idGrid).on('sortstop', function () {
        LinhasReordenadasTabelaFrete(_tipoOperacao);
    });
}
