...
function LoadConexaoSignalRFechamento() {
    SignalRFechamentoAlteradaEvent = VerificarFechamentoAlteradaEvent;
}

function VerificarFechamentoAlteradaEvent(retorno) {
    if (retorno.CodigoFechamento == _fechamentoFrete.Codigo.val()) {
        _RequisicaoIniciada = true;
        BuscarFechamentoPorCodigo(retorno.CodigoFechamento, function () {
