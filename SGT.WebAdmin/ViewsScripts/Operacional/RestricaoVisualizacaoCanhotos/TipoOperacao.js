...
var TipoOperacao = function () {
    ...
    this.Operacao = PropertyEntity({ type: types.event, text: Localization.Resources.Operacional.RestricaoVisualizacaoCanhotos.AdicionarTipoOperacao, idBtnSearch: guid() });
    this.PossuiFiltroTipoOperacao = PropertyEntity({ getType: typesKnockout.bool, val: ko.observable(false), def: false, text: Localization.Resources.Operacional.RestricaoVisualizacaoCanhotos.EsteoperadorDeveFiltrarCargasPorOperacao });
    this.VisualizaCargasSemTipoOperacao = PropertyEntity({ getType: typesKnockout.bool, val: ko.observable(false), def: false, text: Localization.Resources.Operacional.RestricaoVisualizacaoCanhotos.OperadorVisualizaCargasNaoPossuemTipoOperacao });
}
