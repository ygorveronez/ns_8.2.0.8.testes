...
var BuscarClienteProspect = function (knout, callbackRetorno) {

    var idDiv = guid();
    var GridConsulta;
    
    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: "Buscar Cliente Prospect", type: types.local });
        this.TituloGrid = PropertyEntity({ text: "Cliente Prospect", type: types.local });
    ...
    GridConsulta = new GridView(idDiv + "_tabelaEntidades", "ClienteProspect/Pesquisa", knoutOpcoes, divBusca.OpcaoPadrao(callback), null);
