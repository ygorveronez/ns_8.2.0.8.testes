var BuscarTipoComprovante = function (knout, callbackRetorno, basicGrid) {
    ...
    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: "Buscar Comprovante", type: types.local });
        this.TituloGrid = PropertyEntity({ text: "Comprovante", type: types.local });
    ...
    if (multiplaEscolha) {
        ...
        GridConsulta = new GridView(idDiv + "_tabelaEntidades", "TipoComprovante/Pesquisa", knoutOpcoes, null, null, null, null, null, null, objetoBasicGrid);
    } else {
        GridConsulta = new GridView(idDiv + "_tabelaEntidades", "TipoComprovante/Pesquisa", knoutOpcoes, divBusca.OpcaoPadrao(callback), null);
    }
