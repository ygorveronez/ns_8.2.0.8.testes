var BuscarTipoPagamentoRecebimento = function (knout, callbackRetorno, basicGrid) {
    ...
    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: Localization.Resources.Consultas.TipoPagamentoRecebido.PesquisaDeTipoDePagamentoRecebimento, type: types.local });
        this.TituloGrid = PropertyEntity({ text: Localization.Resources.Consultas.TipoPagamentoRecebido.TipoDePagamentoRecebimento, type: types.local });
    ...
    var url = "TipoPagamentoRecebimento/Pesquisa";
