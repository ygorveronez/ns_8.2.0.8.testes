...
var BuscarMotivoSucateamentoPneu = function (knout, callbackRetorno) {
    var idDiv = guid();
    var GridConsulta;

    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: "Buscar Motivo de Sucateamento do Pneu", type: types.local });
        this.TituloGrid = PropertyEntity({ text: "Motivos de Sucateamento do Pneu", type: types.local });
    ...
    GridConsulta = new GridView(idDiv + "_tabelaEntidades", "MotivoSucateamentoPneu/Pesquisa", knoutOpcoes, divBusca.OpcaoPadrao(callback), null);
