var BuscarTipoSinistro = function (knout, callbackRetorno) {

    var idDiv = guid();
    var GridConsulta;

    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: 'Busca de Tipos de Sinistros', type: types.local });
        this.TituloGrid = PropertyEntity({ text: 'Tipos de Sinistros', type: types.local });
    ...
    GridConsulta = new GridView(idDiv + "_tabelaEntidades", "TipoSinistro/Pesquisa", knoutOpcoes, divBusca.OpcaoPadrao(callback));
