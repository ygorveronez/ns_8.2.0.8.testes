...
var BuscarCargos = function (knout, callbackRetorno, basicGrid, afterDefaultCallback) {
    ...
    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: Localization.Resources.Consultas.Cargo.PesquisaDeCargos, type: types.local });
        this.TituloGrid = PropertyEntity({ text: Localization.Resources.Consultas.Cargo.Cargos, type: types.local });
