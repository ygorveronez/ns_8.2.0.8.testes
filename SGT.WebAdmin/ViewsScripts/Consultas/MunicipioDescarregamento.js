...
var BuscarMunicipios = function (knout, callbackRetorno, basicGrid, afterDefaultCallback) {
    ...
    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: "Pesquisa de Municípios", type: types.local });
        this.TituloGrid = PropertyEntity({ text: "Município", type: types.local });
