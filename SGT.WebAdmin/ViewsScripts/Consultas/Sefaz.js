...
var BuscarSefaz = function (knout, callbackRetorno, basicGrid, afterDefaultCallback) {
    ...
    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: "Sefaz", type: types.local });
        this.TituloGrid = PropertyEntity({ text: "Sefaz", type: types.local });
