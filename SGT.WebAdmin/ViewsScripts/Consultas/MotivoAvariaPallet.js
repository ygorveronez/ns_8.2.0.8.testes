...
var BuscarMotivoAvariaPallet = function (knout, callbackRetorno) {
    var idDiv = guid();
    var GridConsulta;
    ...
    GridConsulta = new GridView(idDiv + "_tabelaEntidades", "MotivoAvariaPallet/Pesquisa", knoutOpcoes, divBusca.OpcaoPadrao(callback), null);
