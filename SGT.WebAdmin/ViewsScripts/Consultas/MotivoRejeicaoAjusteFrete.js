...
var BuscarMotivoRejeicaoAjusteFrete = function (knout, callbackRetorno) {

    var idDiv = guid();
    var GridConsulta;

    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: "Buscar Motivo de Rejeição", type: types.local });
    ...
    GridConsulta = new GridView(idDiv + "_tabelaEntidades", "MotivoRejeicaoAjuste/Pesquisa", knoutOpcoes, divBusca.OpcaoPadrao(callback), null);
