...
var BuscarTaxaTerceiro = function (knout, callbackRetorno, basicGrid, knoutCodigoCarga) {
    ...
    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: "Buscar Taxas de Terceiro", type: types.local });
    ...
    if (knoutCodigoCarga != null) {
        funcaoParamentroDinamico = function () {
            if (knoutCodigoCarga != null) {
                knoutOpcoes.Carga.codEntity(knoutCodigoCarga.val());
                knoutOpcoes.Carga.val(knoutCodigoCarga.val());
            }
        };
    }
    ...
    if (multiplaEscolha) {
        ...
        GridConsulta = new GridView(idDiv + "_tabelaEntidades", "TaxaTerceiro/Pesquisa", knoutOpcoes, null, null, null, null, null, null, objetoBasicGrid);
    } else {
        GridConsulta = new GridView(idDiv + "_tabelaEntidades", "TaxaTerceiro/Pesquisa", knoutOpcoes, divBusca.OpcaoPadrao(callback));
    }
