...
var BuscarCanhotosSemVinculo = function (knout, callbackRetorno, knoutEntrega) {
    var idDiv = guid();
    var GridConsulta;
    ...
    var OpcoesKnout = function () {
        ...
        this.NumeroCanhoto = PropertyEntity({ text: "Número:", col: 12 });
    ...
    GridConsulta = new GridView(idDiv + "_tabelaEntidades", "Canhoto/Pesquisa", knoutOpcoes, divBusca.OpcaoPadrao(callback), null);
    divBusca.AddEvents(GridConsulta);

    divBusca.AddTabPressEvent(function (outraPressionada) {
        if (outraPressionada) {
            knoutOpcoes.NumeroCanhoto.val(knout.val());
        }
