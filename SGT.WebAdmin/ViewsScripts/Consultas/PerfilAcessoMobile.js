...
var BuscarPerfilAcessoMobile = function (knout, callbackRetorno) {
    var idDiv = guid();
    var GridConsulta;

    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: Localization.Resources.Consultas.PerfilAcessoMobile.BuscarPerfilDeAcessoMobile, type: types.local });
        this.TituloGrid = PropertyEntity({ text: Localization.Resources.Consultas.PerfilAcessoMobile.PerfilDeAcessoMobile, type: types.local });
    ...
    GridConsulta = new GridView(idDiv + "_tabelaEntidades", "PerfilAcessoMobile/Pesquisa", knoutOpcoes, divBusca.OpcaoPadrao(callback), null);
