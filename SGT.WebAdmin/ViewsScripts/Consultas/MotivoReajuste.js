...
var BuscarMotivoReajuste = function (knout, callbackRetorno) {

    var idDiv = guid();
    var GridConsulta;

    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: "Buscar Motivo do Reajuste", type: types.local });
        this.TituloGrid = PropertyEntity({ text: "Motivos do Reajuste", type: types.local });
    ...
    GridConsulta = new GridView(idDiv + "_tabelaEntidades", "MotivoReajuste/Pesquisa", knoutOpcoes, divBusca.OpcaoPadrao(callback), null);
