...
var BuscarMotivoAdicionalFrete = function (knout, callbackRetorno) {

    var idDiv = guid();
    var GridConsulta;

    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: "Buscar Motivo do Adicional de Frete", type: types.local });
    ...
    GridConsulta = new GridView(idDiv + "_tabelaEntidades", "MotivoAdicionalFrete/Pesquisa", knoutOpcoes, divBusca.OpcaoPadrao(callback), null);
