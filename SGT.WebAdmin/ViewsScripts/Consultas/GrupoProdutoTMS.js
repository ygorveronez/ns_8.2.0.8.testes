...
var BuscarGruposProdutosTMS = function (knout, callbackRetorno, basicGrid) {
    ...
    if (multiplaEscolha) {
        ...
        gridConsulta = new GridView(idDiv + "_tabelaEntidades", "GrupoProdutoTMS/Pesquisa", knoutOpcoes, null, { column: 0, dir: orderDir.desc }, null, null, null, null, objetoBasicGrid);
    } else {
        gridConsulta = new GridView(idDiv + "_tabelaEntidades", "GrupoProdutoTMS/Pesquisa", knoutOpcoes, divBusca.OpcaoPadrao(callback), { column: 1, dir: orderDir.asc });
    }
