...
var BuscarMarcaPneu = function (knout, callbackRetorno) {
    var idDiv = guid();
    var GridConsulta;

    var OpcoesKnout = function () {
        this.Titulo = PropertyEntity({ text: "Buscar Marca de Pneu", type: types.local });
        this.TituloGrid = PropertyEntity({ text: "Marcas de Pneu", type: types.local });
    ...
    GridConsulta = new GridView(idDiv + "_tabelaEntidades", "MarcaPneu/Pesquisa", knoutOpcoes, divBusca.OpcaoPadrao(callback), null);
