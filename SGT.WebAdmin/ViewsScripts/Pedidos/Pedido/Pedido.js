...
/// <reference path="CancelamentoPedido.js" />
...
var ccvSelecionado = null;
var duplicarPedidoParaDevolucaoTotal = false;
...
var PesquisaPedido = function () {
    ...
    this.SituacaoComercialPedido = PropertyEntity({ type: types.entity, codEntity: ko.observable(0), text: Localization.Resources.Consultas.SituacaoComercialPedido.SituacaoComercialDoPedido.getFieldDescription(), idBtnSearch: guid(), visible: ko.observable(_CONFIGURACAO_TMS.ExisteSituacaoComercialPedido) });
    ...
    this.ProvedorOS = PropertyEntity({ type: types.entity, codEntity: ko.observable(0), text: "Provedor", idBtnSearch: guid(), visible: ko.observable(_CONFIGURACAO_TMS.UsuarioUtilizaSegregacaoPorProvedor) });
    ...
    this.NumeroOrdem = PropertyEntity({ getType: typesKnockout.string, val: ko.observable(""), def: "", text: Localization.Resources.Pedidos.Pedido.NumeroOrdem.getFieldDescription(), configInt: { precision: 0, allowZero: true, thousands: "" }, maxlength: 10, visible: ko.observable(false) });
    this.CategoriaOS = PropertyEntity({ getType: typesKnockout.selectMultiple, val: ko.observable(""), options: EnumCategoriaOS.obterOpcoes(), def: ko.observable([]), text: Localization.Resources.Pedidos.Pedido.CategoriaOS.getFieldDescription(), visible: ko.observable(_HabilitarFuncionalidadesProjetoGollum) });
    this.TipoOSConvertido = PropertyEntity({ getType: typesKnockout.selectMultiple, val: ko.observable(""), options: EnumTipoOSConvertido.obterOpcoes(), def: ko.observable([]), text: Localization.Resources.Pedidos.Pedido.TipoOSConvertido.getFieldDescription(), visible: ko.observable(_HabilitarFuncionalidadesProjetoGollum) });
...
var Pedido = function () {
    ...
    this.MotivoPedido = PropertyEntity({
        type: types.entity,
        codEntity: ko.observable(0),
        required: _CONFIGURACAO_TMS.UtilizarCampoDeMotivoDePedido === true,
        text: "Motivo do Pedido",
        idBtnSearch: guid(),
        issue: 0,
        visible: _CONFIGURACAO_TMS.UtilizarCampoDeMotivoDePedido === true,
        enable: true
    });
    //this.CentroCarregamento = PropertyEntity({ type: types.entity, codEntity: ko.observable(0), required: false, text: ko.observable( Localization.Resources.Pedidos.Pedido.CentroCarregamento.getFieldDescription()), idBtnSearch: guid(), issue: 0, visible: ko.observable(true), enable: ko.observable(true) });
    this.CentroCarregamento = PropertyEntity({ type: types.entity, codEntity: ko.observable(0), required: false, text: ko.observable(Localization.Resources.Pedidos.Pedido.CentroCarregamento.getFieldDescription()), issue: 70, idBtnSearch: guid(), visible: ko.observable(true) });
    ...
    this.Fronteiras = PropertyEntity({ type: types.map, required: false, text: Localization.Resources.Pedidos.Pedido.InformarFronteira, getType: typesKnockout.dynamic, idBtnSearch: guid(), idGrid: guid(), enable: ko.observable(true), visible: ko.observable(true) });
    ...
    this.Destino = PropertyEntity({ type: types.entity, codEntity: ko.observable(0), text: Localization.Resources.Gerais.Geral.Destino.getFieldDescription(), idBtnSearch: guid(), required: false, issue: 16, visible: ko.observable(_CONFIGURACAO_TMS.TipoServicoMultisoftware === EnumTipoServicoMultisoftware.MultiTMS) });
    ...
    this.ListaFronteiras = PropertyEntity({ type: types.map, getType: typesKnockout.dynamic, val: ko.observable(""), def: "", idGrid: guid(), required: false });
    ...
    this.ListaContatos = PropertyEntity({ type: types.map, getType: typesKnockout.dynamic, val: ko.observable([]), def: [], idGrid: guid() });
...
var CRUDPedido = function () {
    ...
    this.ImportarBIDTransporte = PropertyEntity({
        type: types.local,
        text: "Importar BID Transporte",
        visible: ko.observable(false),
        accept: ".xls,.xlsx,.csv,.txt",
        cssClass: "btn-default",
        ManterArquivoServidor: true,
        UrlImportacao: "Pedido/ImportarBIDTransportePedido",
        UrlConfiguracao: "Pedido/ConfiguracaoImportacaoBIDTransporte",
        CodigoControleImportacao: EnumCodigoControleImportacao.O071_ImportacaoBIDTransportePedido,
    });
};
...
function loadPedido() {
    ...
    let telaPedidosResumido = _CONFIGURACAO_TMS.TelaPedidosResumido === true;

    let permiteAdicionarPessoa = true;
    ...
    BuscarGruposPessoas(_pedido.GrupoPessoa, RetornoGrupoPessoa, null, null, EnumTipoGrupoPessoas.Clientes);
    BuscarClientes(_pedido.Remetente, retornoRemetente, permiteAdicionarPessoa);
    BuscarClientes(_pedido.Remetentes, retornoRemetente);
    BuscarLocalidades(_pedido.Origem, null, null, RetornoSelecaoOrigem);
    BuscarLocalidades(_pedido.Destino, null, null, null);
    BuscarClientes(_pedido.Destinatario, retornoDestinatario, permiteAdicionarPessoa);
    BuscarClientes(_pedido.Destinatarios, retornoDestinatario);
    BuscarClientes(_pedido.ClienteDeslocamento);
    BuscarTiposdeCarga(_pedido.TipoCarga, null, _pedido.GrupoPessoa, null, _pedido.Remetente, null, null, null, null, _pedido.TipoOperacao);

    if (_CONFIGURACAO_TMS.PermitirSelecionarReboquePedido)
        BuscarVeiculos(_pedido.Veiculo, RetornoVeiculoBuscarDetalhes, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, "0", null, null, true, null, tipoPropriedade, null, _pedido.TipoOperacao);
    else
        BuscarVeiculos(_pedido.Veiculo, RetornoVeiculo, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, tipoPropriedade, null, _pedido.TipoOperacao);

    if (_CONFIGURACAO_TMS.VisualizarTipoOperacaoDoPedidoPorTomador)
        BuscarTiposOperacao(_pedido.TipoOperacao, RetornoTipoOperacao, _pedido.GrupoPessoa, null, null, null, null, null, null, RetornoTomadorPedido, null, null, _pedido.TipoCarga);
    else
        BuscarTiposOperacao(_pedido.TipoOperacao, RetornoTipoOperacao, null, null, null, null, null, null, null, null, null, null, _pedido.TipoCarga);

    BuscarProdutos(_pedido.ProdutoEmbarcador, RetornoProdutoEmbarcador, _pedido.GrupoPessoa, _pedido.Remetente);
    BuscarModelosVeicularesCarga(_pedido.ModeloVeicularCarga, null, null);
    BuscarModelosVeicularesCarga(_pedido.ModelosVeicularesCarga, null, null);
    BuscarFilial(_pedido.Filial);
    BuscarTransportadores(_pedido.Empresa, retornoEmpresa, null, true);

    if (_CONFIGURACAO_TMS.TipoServicoMultisoftware === EnumTipoServicoMultisoftware.MultiTMS)
        _buscarRotasFrete = new BuscarRotasFrete(_pedido.Rota, null, null, _pedido.GrupoPessoa, _pedido.Remetente, null, null, null, null, _pedido.Remetente, _pedido.Destinatario, _pedido.Recebedor, _pedido.Expedidor);
    else
        BuscarRotasFrete(_pedido.Rota, null, null, _pedido.GrupoPessoa, _pedido.Remetente);

    BuscarClientes(_pedido.Recebedor, retornoRecebedor, permiteAdicionarPessoa);
    BuscarClientes(_pedido.Expedidor, retornoExpedidor, permiteAdicionarPessoa);
    BuscarClientes(_pedido.Terceiro, null, permiteAdicionarPessoa);
    BuscarCentroResultado(_pedido.CentroResultado, null, null, null, EnumAnaliticoSintetico.Analitico);
    BuscarCentrosCarregamento(_pedido.CentroCarregamento, retornoCentroCarregamento);

    BuscarMotivoPedido(_pedido.MotivoPedido, null, EnumTipoMotivoPedido.LancamentoPedido);
    ...
    BuscarClientes(_pesquisaPedido.Remetente);
    BuscarGruposPessoas(_pesquisaPedido.GrupoPessoa, null, null, null, EnumTipoGrupoPessoas.Clientes);
    BuscarLocalidades(_pesquisaPedido.Origem);
    BuscarClientes(_pesquisaPedido.Destinatario);
    BuscarClientes(_pesquisaPedido.Expedidor);
    BuscarClientes(_pesquisaPedido.ProvedorOS);
    BuscarClientes(_pesquisaPedido.Recebedor);
    BuscarClientes(_pesquisaPedido.Tomador);
    BuscarVeiculos(_pesquisaPedido.Veiculo, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, tipoPropriedade);
    BuscarMotorista(_pesquisaPedido.Motorista);
    BuscarLocalidades(_pesquisaPedido.Destino);
    BuscarLocalidadesPolo(_pesquisaPedido.CidadePoloOrigem);
    BuscarLocalidadesPolo(_pesquisaPedido.CidadePoloDestino);
    BuscarFilial(_pesquisaPedido.Filial);
    BuscarPaises(_pesquisaPedido.PaisOrigem);
    BuscarPaises(_pesquisaPedido.PaisDestino);
    BuscarTiposdeCarga(_pesquisaPedido.TipoCarga);
    BuscarCanaisEntrega(_pesquisaPedido.CanalEntrega);
    BuscarPedidoEmpresaResponsavel(_pesquisaPedido.PedidoEmpresaResponsavel);
    BuscarPedidoCentroCusto(_pesquisaPedido.PedidoCentroCusto);
    BuscarContainers(_pesquisaPedido.Container);
    BuscarTiposOperacao(_pesquisaPedido.TipoOperacao);
    BuscarFuncionario(_pesquisaPedido.FuncionarioVendedor);
    BuscarEmpresa(_pesquisaPedido.Transportador);
    BuscarSituacaoComercialPedido(_pesquisaPedido.SituacaoComercialPedido);
    ...
    if (!_HabilitarFluxoPedidoEcommerce) {
        $("#tabEcommerce").hide();
    }
    ...
    obterTiposIntegracao().then(function (data) {
        let visibilidadeImportarISISReturn = data.filter(function (tipo) {
    ...
    if (_CONFIGURACAO_TMS.PermitirSelecionarCentroDeCarregamentoNoPedido) {
        _pedido.CentroCarregamento.visible(true);
    } else {
        _pedido.CentroCarregamento.visible(false);
...
function configurarLayoutPedidoPorTipoSistema() {
    if (_CONFIGURACAO_TMS.TipoServicoMultisoftware === EnumTipoServicoMultisoftware.MultiEmbarcador) {
        ...
        _pesquisaPedido.NumeroOrdem.visible(true);
        ...
        executarReST("Pedido/ObterConfiguracoesGeraisPedido", null, function (arg) {
            ...
            _CRUDPedido.ImportarBIDTransporte.visible(arg.Data.HabilitarBIDTransportePedido);
        });
    }
...
function RetornoTipoOperacao(data) {
    ...
    _pedido.TipoOperacao.recriarControleDeEntregasAoConfirmarEnvioDocumentos = data.RecriarControleDeEntregasAoConfirmarEnvioDocumentos;
...
function tipoOperacaoBlur() {
    if (_pedido.TipoOperacao.val() == "") {
        ...
        _pedido.TipoOperacao.recriarControleDeEntregasAoConfirmarEnvioDocumentos = false;
        ...
        if (arg.Success) {
            if (arg.Data) {
                if (!arg.Data.PedidoDuplicado) {
                    if (arg.Data.NumeroPedidoEmbarcadorDuplicado) {
                        exibirConfirmacao(Localization.Resources.Gerais.Geral.Confirmacao, Localization.Resources.Pedidos.Pedido.NumeroPedidoEmbarcadorDuplicado, cb);
                    } else cb();
                } else exibirConfirmacao(Localization.Resources.Gerais.Geral.Confirmacao, Localization.Resources.Pedidos.Pedido.PedidoDuplicado, cb);
...
async function salvarClick() {
    ...
    if (verificarOrigemDestino() && verificarDadosAdicionais() && SetarPassagens() && VerificarDadosImportacao() && validarProdutosInformadosPedido() && validarQuantidadeDiasDataColeta()) {
        if (!ValidarCamposObrigatorios(_pedido)) {
            ...
            _pedido.TipoOperacao.recriarControleDeEntregasAoConfirmarEnvioDocumentos &&
            _pedido.Destino.val().length == 0 &&
            _pedido.Destinatario.val().length == 0) {
            exibirMensagem(tipoMensagem.atencao, Localization.Resources.Gerais.Geral.CampoObrigatorio, Localization.Resources.Gerais.Geral.DestinatarioOuDestinoEhObrigatorioParaEsseTipoDeOperacao);
            return;
        } else if (!(await verificarTipoTomador())) {
            return;
        } else if (_pedido.Fronteiras.visible() && !contemFronteiras()) {
            exibirMensagem(tipoMensagem.atencao, Localization.Resources.Gerais.Geral.CampoObrigatorio,
                Localization.Resources.Pedidos.Pedido.InformarFronteira);
            return;
        }
    }
...
function retornoDestinatario(data) {
    ...
    _pedido.Destino.codEntity(data.CodigoLocalidade);
    _pedido.Destino.val(data.Localidade);
...
function retornoCentroCarregamento(registroSelecionado) {
    _pedido.CentroCarregamento.val(registroSelecionado.Descricao);
    _pedido.CentroCarregamento.codEntity(registroSelecionado.Codigo);

    _pedido.Filial.val(registroSelecionado.Filial);
    _pedido.Filial.codEntity(registroSelecionado.CodigoFilial);
}
...
function preencherRotaFreteAutomaticamente() {
    if (_CONFIGURACAO_TMS.TipoServicoMultisoftware === EnumTipoServicoMultisoftware.MultiTMS && !_CONFIGURACAO_TMS.NaoPreencherRotaFreteAutomaticamente && ((_pedido.Recebedor.codEntity() > 0 && _pedido.Expedidor.codEntity() > 0) || (_pedido.Remetente.codEntity() > 0 && _pedido.Destinatario.codEntity() > 0)))
...
function verificarFronteira() {
    ...
    if ((origemExterior || destinoExterior) && !_CONFIGURACAO_TMS.UtilizaEmissaoMultimodal) {
        ...
        _pedido.Fronteiras.visible(campoFronteiraObrigatorio);
    }
    else {
        _pedido.Fronteiras.visible(false);
    }
}

function buscarPedidos() {

    var menuOpcoes = obterOpcoesMenu();

    _gridPedido = new GridView(_pesquisaPedido.Pesquisar.idGrid, "Pedido/Pesquisa", _pesquisaPedido, menuOpcoes, null, null, null);
    _gridPedido.CarregarGrid();
}

function editarPedido(pedidoGrid, duplicar, duplicarParaDevolucaoTotal, duplicarParaDevolucaoParcial) {

    limparCamposPedido();

    duplicarPedidoParaDevolucaoTotal = duplicarParaDevolucaoTotal;

    executarReST("Pedido/BuscarPorCodigo", { Codigo: pedidoGrid.Codigo, Duplicar: duplicar, DuplicarParaDevolucaoTotal: duplicarParaDevolucaoTotal, DuplicarParaDevolucaoParcial: duplicarParaDevolucaoParcial }, function (arg) {
        ...
        executarReST("Pedido/BuscarPorCodigoParteComplementar1", { Codigo: pedidoGrid.Codigo, Duplicar: duplicar, DuplicarParaDevolucaoParcial: duplicarParaDevolucaoParcial }, (argComplementar) => {
            ...
            if (_pedido.TipoPessoa.val() === EnumTipoPessoaGrupo.Pessoa) {
                ...
                if (_pedido.UsarOutroEnderecoOrigem.val()) {
                    ...
                    if (_pedido.LocalidadeClienteOrigem.codEntity() == 0) {
                        ...
                        if (dataPrincipal.OutroEnderecoOrigem != null) {
                            let outroEndereco = dataPrincipal.OutroEnderecoOrigem;
                            _localidadeOrigem.DetalheEnderecoOutroEndereco.val(outroEndereco.Endereco);
                            _localidadeOrigem.DetalheLocalidadeOutroEndereco.val(outroEndereco.Localidade);
                            _localidadeOrigem.DetalheCidadePoloOutroEndereco.val(outroEndereco.CidadePolo);
                            _localidadeOrigem.DetalheTelefoneOutroEndereco.val(outroEndereco.Telefone);

                            if (outroEndereco.Telefone)
                                _localidadeOrigem.DetalheTelefoneOutroEndereco.visible(true);

                            if (outroEndereco.CidadePolo)
                                _localidadeOrigem.DetalheCidadePoloOutroEndereco.visible(true);
                        }
                    }
                }
                else
                ...
                if (_pedido.UsarOutroEnderecoDestino.val()) {
                    ...
                    if (_pedido.LocalidadeClienteDestino.codEntity() == 0) {
                        ...
                        if (dataPrincipal.OutroEnderecoDestino != null) {
                            let outroEndereco = dataPrincipal.OutroEnderecoDestino;
                            _localidadeDestino.DetalheEnderecoOutroEndereco.val(outroEndereco.Endereco);
                            _localidadeDestino.DetalheLocalidadeOutroEndereco.val(outroEndereco.Localidade);
                            _localidadeDestino.DetalheCidadePoloOutroEndereco.val(outroEndereco.CidadePolo);
                            _localidadeDestino.DetalheTelefoneOutroEndereco.val(outroEndereco.Telefone);

                            if (outroEndereco.Telefone)
                                _localidadeDestino.DetalheTelefoneOutroEndereco.visible(true);

                            if (outroEndereco.CidadePolo)
                                _localidadeDestino.DetalheCidadePoloOutroEndereco.visible(true);
                        }
                    }
                }
                else
            ...
            preecherEcommercePedido(dataPrincipal.DadosEcommerce);
            ...
            preencherContatos(dataPrincipal.Contatos);
            if (dataPrincipal.ContainerAdicional != null && dataPrincipal.ContainerAdicional != undefined)
                preencherContainer(dataPrincipal.ContainerAdicional)

            preencherDadosCrtMicDta(dataPrincipal.DadosAdicionais);
            RecarregarListaMotoristas();
            RecarregarListaReboques();
            ...
            CarregarGridHistoricoPedido(dataPrincipal.Historico);

            _importacao.NumeroContainer.val(_container.NumeroContainer.val());
            ...
            let exibirCampos = (_CONFIGURACAO_TMS.UtilizaEmissaoMultimodal || dataPrincipal.OperacaoDeImportacaoExportacao);

            SetarCampoAbaImportacao(exibirCampos);
            SetarCampoAbaAdicionais(exibirCampos);
...
function limparCamposPedido() {
    ...
    _localidadeDestino.DetalheTelefoneOutroEndereco.visible(false);
    _localidadeDestino.DetalheCidadePoloOutroEndereco.visible(false);
    _localidadeOrigem.DetalheTelefoneOutroEndereco.visible(false);
    _localidadeOrigem.DetalheCidadePoloOutroEndereco.visible(false);
    ...
    limparCamposCrtMicDta();
    limparCamposDadosAdicionais();
    limparCamposEcommercePedido();
...
function preencherListaContatos() {
    _pedido.ListaContatos.val(obterLisaContatos());
}

function obterPedidoSalvar() {
    preencherListaMotorista();
    preencherListaFronteira();
    ...
    let pedido = RetornarObjetoPesquisa(_pedido);

    preencherDadosAdicionaisSalvar(pedido);
    preencherNotaParcialSalvar(pedido);
    preencherNotaFiscaisSalvar(pedido);
    preencherCteParcialSalvar(pedido);
    preencherDadosEcommerceSalvar(pedido);
    preencherContainerSalvar(pedido);
    preencherDadosCrtMicDtaSalvar(pedido);

    pedido["DuplicarPedidoParaDevolucaoTotal"] = duplicarPedidoParaDevolucaoTotal;
...
async function verificarTipoTomador() {
    return new Promise(resolve => {
        var tipoTomador = null;

        if (!_adicional.UsarTipoTomadorPedido.val()) {
            resolve(true);
            return;
        } else {
            tipoTomador = _adicional.TipoTomador.val();
        }

        var dados = {
            TipoTomador: tipoTomador,
            TipoOperacao: _pedido.TipoOperacao.codEntity(),
            Remetente: _pedido.Remetente.codEntity(),
            GrupoPessoa: _pedido.GrupoPessoa.codEntity()
        };

        executarReST("Pedido/ValidarTipoTomadorComTipoOperacao", dados, function (arg) {
            if (arg.Success) {
                resolve(true);
            } else {
                exibirMensagem(tipoMensagem.falha, Localization.Resources.Gerais.Geral.Falha, arg.Msg);
...
function validarProdutosInformadosPedido() {

    if (_ObrigatorioInformarProdutoPedido) {
        if (_produtoEmbarcador.ProdutosEmbarcador.list == undefined || _produtoEmbarcador.ProdutosEmbarcador.list.length == 0) {
            exibirMensagem(tipoMensagem.atencao, Localization.Resources.Gerais.Geral.CampoObrigatorio, Localization.Resources.Pedidos.Pedido.ObrigatorioInformarProdutoPedido);
            return false;
        }
    }
...
function validarQuantidadeDiasDataColeta() {
    var [mes, dia, ano] = _pedido.DataColeta.val().split('/');
    var d1 = new Date(`${dia}/${mes}/${ano}`);

    var diffDias = Math.floor(Math.abs(d1 - new Date()) / (24 * 60 * 60 * 1000));

    if (diffDias > _CONFIGURACAO_TMS.ConfiguracaoPedido.QuantidadeDiasDataColeta) {
        exibirMensagem(tipoMensagem.aviso, Localization.Resources.Gerais.Geral.Aviso, "A diferença de dias entre data de coleta e a data de hoje não deve ultrapassar " + _CONFIGURACAO_TMS.ConfiguracaoPedido.QuantidadeDiasDataColeta + " dias. Diferença atual: " + diffDias + " dias.");
        return false;
    }
...
function obterOpcoesMenu(){
    ...
    var duplicarDevolucaoTotal = { descricao: Localization.Resources.Gerais.Geral.DuplicarDevolucaoTotal, id: guid(), evento: "onclick", metodo: function (pedidoGrid) { duplicarPedidoDevolucaoTotal(pedidoGrid); }, tamanho: "10", icone: "" };
    var duplicarDevolucaoParcial = { descricao: Localization.Resources.Gerais.Geral.DuplicarDevolucaoParcial, id: guid(), evento: "onclick", metodo: function (pedidoGrid) { duplicarPedidoDevolucaoParcial(pedidoGrid); }, tamanho: "10", icone: "" };
    ...
    if (!_CONFIGURACAO_TMS.UsuarioAdministrador && VerificaSePossuiPermissaoEspecial(EnumPermissaoPersonalizada.Pedido_BloquearDuplicarPedido, _PermissoesPersonalizadas) || _CONFIGURACAO_TMS.BloquearDuplicarPedido)
        menuOpcoes = { tipo: TypeOptionMenu.list, opcoes: [editar], tamanho: 10 };
    else {

        if (_CONFIGURACAO_TMS.ConfiguracaoPedido.HabilitarOpcoesDeDuplicacaoDoPedidoParaDevolucaoTotalParcial)
            menuOpcoes = { tipo: TypeOptionMenu.list, opcoes: [editar, duplicar, duplicarDevolucaoTotal, duplicarDevolucaoParcial], tamanho: 10 };
        else
            menuOpcoes = { tipo: TypeOptionMenu.list, opcoes: [editar, duplicar], tamanho: 10 };
    }

    return menuOpcoes;
}

function duplicarPedidoDevolucaoTotal(pedidoGrid) {
    exibirConfirmacao(Localization.Resources.Gerais.Geral.Confirmacao, Localization.Resources.Pedidos.Pedido.DuplicarPedidoParaDevolucaoTotal.format(pedidoGrid.NumeroPedidoEmbarcador), function () {
        editarPedido(pedidoGrid, true, true, false);
    });
}

function duplicarPedidoDevolucaoParcial(pedidoGrid) {
    exibirConfirmacao(Localization.Resources.Gerais.Geral.Confirmacao, Localization.Resources.Pedidos.Pedido.DuplicarPedidoParaDevolucaoParcial.format(pedidoGrid.NumeroPedidoEmbarcador), function () {
        editarPedido(pedidoGrid, true, false, true);
    });
}