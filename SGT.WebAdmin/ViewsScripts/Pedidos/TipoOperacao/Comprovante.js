...
var Comprovante = function () {
    ...
    this.Comprovante = PropertyEntity({ type: types.event, text: Localization.Resources.Pedidos.TipoOperacao.AdicionarComprovante, idBtnSearch: guid() });
    this.NaoUtilizarConfiguracoesDeComprovantesDoGrupoPessoa = PropertyEntity({ getType: typesKnockout.bool, text: Localization.Resources.Pedidos.TipoOperacao.NaoUtilizarConfiguracoesDeComprovantesDoGrupoPessoa });
    this.ExigirComprovantesLiberacaoPagamentoContratoFrete = PropertyEntity({ getType: typesKnockout.bool, text: Localization.Resources.Pedidos.TipoOperacao.ExigirComprovantesLiberacaoPagamentoContratoFrete });
}
...
function recarregarGridComprovante() {
    ...
    if (!string.IsNullOrWhiteSpace(_tipoOperacao.Comprovantes.val())) {

        $.each(_tipoOperacao.Comprovantes.val(), function (i, comprovante) {
