...
function BuscarAndamentoPedido(numOv, codEmpresa, CodUserSap) {
...
function preencherKnoutAndamentoPedido(data) {
    ...
    _acompanhamentoPedido.TpCarregamento.val(data.DescricaoTipoCarregamento);
    _acompanhamentoPedido.CodCentro.val(data.DescricaoCentro);
    ...
    if (etapas != undefined && Array.isArray(etapas) && etapas.length > 0) {
        ...
        etapas.forEach(function (etapa, i) {
            ...
            if (etapa.dataRegistro == undefined || etapa.dataRegistro == null)
                etapa.dataRegistro = "&nbsp;";

            if (etapa.horaRegistro == undefined || etapa.horaRegistro  == null)
                etapa.horaRegistro = "&nbsp;";
    ...
    if (remessas != undefined && Array.isArray(remessas) && remessas.length > 0) {
        remessas.forEach(function (remessa, i) {
            ...
            remessa.FluxoRemessa.forEach(function (fluxo, i) {
                ...
                if (fluxo.dataRegistro == undefined || fluxo.dataRegistro == null)
                    fluxo.dataRegistro = "&nbsp;";

                if (fluxo.horaRegistro == undefined || fluxo.horaRegistro == null)
                    fluxo.horaRegistro = "&nbsp;";
