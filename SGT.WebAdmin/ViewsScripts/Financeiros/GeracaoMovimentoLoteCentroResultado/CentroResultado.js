...
function LoadCentroResultado() {
    ...
    KoBindings(_centroResultado, "knockoutCentrosResultado");
    ...
    var excluir = {
        descricao: "Remover", id: guid(), evento: "onclick", metodo: function (data) {
            RemoverCentroResultadoClick(_geracaoMovimentoFinanceiroCentroResultado.CentrosResultado, data);
        }, tamanho: "10", icone: ""
    };
...
function GetCentrosResultado() {
    return _geracaoMovimentoFinanceiroCentroResultado.CentrosResultado.list.slice();
}

function SetCentrosResultado(data) {
    return _geracaoMovimentoFinanceiroCentroResultado.CentrosResultado.list = data.slice();
}
            ...
            if (arg.Success) {
                if (arg.Data) {
                    ...
                    for (var j = 0; j < retorno.length; j++) {
                        ...
                        _geracaoMovimentoFinanceiroCentroResultado.CentrosResultado.list.push(itemGrid);
                    }
