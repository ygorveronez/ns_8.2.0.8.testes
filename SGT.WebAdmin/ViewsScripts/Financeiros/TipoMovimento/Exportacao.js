...
var ConfiguracaoExportacao = function () {
    ...
    this.Tipo = PropertyEntity({ text: "Tipo:", options: EnumTipoExportacao.ObterOpcoes(), val: ko.observable(EnumTipoExportacao.Debito), def: EnumTipoExportacao.Debito, issue: 0, visible: ko.observable(true) });
...
function LoadConfiguracaoExportacao() {
    ...
    var header = [
        ...
        { data: "PlanoConta", title: "Plano de Conta", width: "16%" },
        { data: "ContaContabil", title: "Código da Conta", width: "16%" },
        { data: "CentroResultado", title: "Centro de Resultado", width: "16%" },
        { data: "CodigoCentroResultado", title: "Código do Centro de Resultado", width: "20%" },
        { data: "Tipo", title: "Tipo", width: "16%" }
    ];
...
function RecarregarGridConfiguracaoExportacao() {
    ...
    $.each(_tipoMovimento.ConfiguracoesExportacao.val(), function (i, config) {
        ...
        configGrid.Tipo = EnumTipoExportacao.ObterDescricao(config.Tipo);
...
function ExcluirConfiguracaoExportacaoClick(data) {
    var configuracoes = _tipoMovimento.ConfiguracoesExportacao.val();
    ...
    _tipoMovimento.ConfiguracoesExportacao.val(configuracoes);
