...
var _configuracaoRegras = {
    ...
    Alcadas: [
        ...
        {
            descricao: "Configuração Boleto",
            prop: "BoletoConfiguracao",
            tipoPropriedadeAlcada: EnumTipoPropriedadeAlcada.Entidade,
            busca: function (ko) {
                new BuscarBoletoConfiguracao(ko);
            }
        },
        {
            descricao: "Valor",
...
var _nomeControllerRegrasAutorizacao = "RegraAutorizacaoPagamentoEletronico";
