...
function AdicionarCentroResultadoTipoDespesaClick() {
    ...
    _documentoEntrada.CentrosResultadoTiposDespesa.list.push(SalvarListEntity(_centroResultadoTipoDespesa));
...
function ExcluirCentroResultadoTipoDespesaClick(data) {
    exibirConfirmacao("Atenção!", "Deseja realmente excluir o registro?", function () {
        for (var i = 0; i < _documentoEntrada.CentrosResultadoTiposDespesa.list.length; i++) {
            if (data.Codigo == _documentoEntrada.CentrosResultadoTiposDespesa.list[i].Codigo.val) {
                _documentoEntrada.CentrosResultadoTiposDespesa.list.splice(i, 1);
                break;
            }
        }
...
function RecarregarGridCentroResultadoTipoDespesa() {
    ...
    $.each(_documentoEntrada.CentrosResultadoTiposDespesa.list, function (i, item) {
