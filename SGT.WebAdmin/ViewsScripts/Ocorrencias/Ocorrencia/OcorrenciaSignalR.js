...
function LoadConexaoSignalROcorrencia() {
    SignalROcorrenciaAlteradaEvent = VerificarOcorrenciaAlteradaEvent;
}

function VerificarOcorrenciaAlteradaEvent(retorno) {
    if (retorno.CodigoOcorrencia == _ocorrencia.Codigo.val()) {
