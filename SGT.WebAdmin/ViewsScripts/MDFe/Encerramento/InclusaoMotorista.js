...
function AdicionarEventoInclusaoMotoristaClick(e, sender) {
    Salvar(e, "Encerramento/AdicionarMotoristaMDFe", function (arg) {
        if (arg.Success) {
            if (arg.Data) {
...
function VisibilidadeEncerramentoMDFe(dataRow) {
    return (dataRow.Status === EnumSituacaoMDFe.Autorizado);
}