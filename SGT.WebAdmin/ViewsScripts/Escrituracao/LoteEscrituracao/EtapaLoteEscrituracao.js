...
var _etapaLoteEscrituracao;

var EtapaLoteEscrituracao = function () {
...
function loadEtapasLoteEscrituracao() {
    _etapaLoteEscrituracao = new EtapaLoteEscrituracao();
    KoBindings(_etapaLoteEscrituracao, "knockoutEtapaLoteEscrituracao");
    Etapa1Liberada();
}
...
function SetarEtapasLoteEscrituracao() {
    ...
    //if (situacao == EnumSituacaoLoteEscrituracao.Cancelada)
        //situacao = _etapaLoteEscrituracao.SituacaoNoCancelamento.val();
...
function Etapa1Liberada() {
    $("#" + _etapaLoteEscrituracao.Etapa1.idTab).attr("data-bs-toggle", "tab");
    $("#" + _etapaLoteEscrituracao.Etapa1.idTab + " .step").attr("class", "step yellow");
    Etapa2Desabilitada();
}

function Etapa1Aprovada() {
    $("#" + _etapaLoteEscrituracao.Etapa1.idTab).attr("data-bs-toggle", "tab");
    $("#" + _etapaLoteEscrituracao.Etapa1.idTab + " .step").attr("class", "step green");
}

//*******Etapa 2*******

function Etapa2Desabilitada() {
    $("#" + _etapaLoteEscrituracao.Etapa2.idTab).removeAttr("data-bs-toggle");
    $("#" + _etapaLoteEscrituracao.Etapa2.idTab + " .step").attr("class", "step");
    _etapaLoteEscrituracao.Etapa2.eventClick = function () { };
}
function Etapa2Aguardando() {
    $("#" + _etapaLoteEscrituracao.Etapa2.idTab).attr("data-bs-toggle", "tab");
    $("#" + _etapaLoteEscrituracao.Etapa2.idTab + " .step").attr("class", "step yellow");
    _etapaLoteEscrituracao.Etapa2.eventClick = BuscarDadosIntegracoesLoteEscrituracao;
    Etapa1Aprovada();
}

function Etapa2Reprovada() {
    $("#" + _etapaLoteEscrituracao.Etapa2.idTab).attr("data-bs-toggle", "tab");
    $("#" + _etapaLoteEscrituracao.Etapa2.idTab + " .step").attr("class", "step red");
    _etapaLoteEscrituracao.Etapa2.eventClick = BuscarDadosIntegracoesLoteEscrituracao;
    Etapa1Aprovada();
}
...
function Etapa2Aprovada() {
    $("#" + _etapaLoteEscrituracao.Etapa2.idTab).attr("data-bs-toggle", "tab");
    $("#" + _etapaLoteEscrituracao.Etapa2.idTab + " .step").attr("class", "step green");
    _etapaLoteEscrituracao.Etapa2.eventClick = BuscarDadosIntegracoesLoteEscrituracao;
    Etapa1Aprovada();
}