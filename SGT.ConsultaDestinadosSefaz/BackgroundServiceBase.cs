namespace SGT.ConsultaDestinadosSefaz
{
    public class BackgroundServiceBase : BackgroundService
    {
        ...
        {
            string conectionString = $"Application Name=SGT.ConsultaDestinadosSefaz;Data Source={configuracao.DBServidor};Initial Catalog={configuracao.DBBase};User Id={configuracao.DBUsuario};Password={configuracao.DBSenha};";
            if (maxPoolSize != 0)
