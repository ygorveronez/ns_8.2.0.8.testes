...
{
    public class RelatorioPagamentoMotoristaController : ApiController
    {
        ...
        {
            return (from obj in this.BuscarPaginasUsuario() where obj.Pagina.Formulario.ToLower().Equals("relatoriopagamentomotorista.aspx") select obj).FirstOrDefault();
        }
        ...
        public ActionResult DownloadRelatorio()
        {
            ...
            try
            {
                ...
                List<Dominio.Entidades.PagamentoMotorista> listaPagamentos = repPagamentoMotorista.Relatorio(this.EmpresaUsuario.Codigo, dataInicial, dataFinal, codigoMotorista, status);
                ...
                Dominio.ObjetosDeValor.Relatorios.Relatorio arquivo = svcRelatorio.GerarWeb("Relatorios/RelatorioPagamentoMotorista.rdlc", tipoArquivo, parametros, dataSources);
        ...
        {
            Dominio.Entidades.PagamentoMotorista aux = new Dominio.Entidades.PagamentoMotorista();
            aux.Status = status;
