...
{
    public sealed class FaturaImpressaoPorCte : FaturaImpressao
    {
        #region Construtores

        public FaturaImpressaoPorCte(Repositorio.UnitOfWork unitOfWork, AdminMultisoftware.Dominio.Enumeradores.TipoServicoMultisoftware tipoServicoMultisoftware, Dominio.Entidades.Embarcador.Configuracao.ConfiguracaoTMS configuracaoEmbarcador)
            : base (unitOfWork, tipoServicoMultisoftware, configuracaoEmbarcador, "FaturaPorCte.rpt", CodigoControleRelatorios.R199_FaturaPorCte)
        {
        }
        ...
        public override void GerarRelatorio(Dominio.Entidades.Embarcador.Fatura.Fatura fatura, Dominio.Entidades.Embarcador.Relatorios.RelatorioControleGeracao relatorioControleGeracao, Dominio.Entidades.Embarcador.Relatorios.Relatorio relatorioTemporario, Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoImpressaoFatura? tipoImpressaoFatura = null)
        {
            ...
            var report = ReportRequest.WithType(ReportType.FaturaImpressaoPorCte)
