...
{
    public sealed class FaturaImpressaoPadrao : FaturaImpressao
    {
        #region Construtores

        public FaturaImpressaoPadrao(Repositorio.UnitOfWork unitOfWork, AdminMultisoftware.Dominio.Enumeradores.TipoServicoMultisoftware tipoServicoMultisoftware, Dominio.Entidades.Embarcador.Configuracao.ConfiguracaoTMS configuracaoEmbarcador)
            : base(unitOfWork, tipoServicoMultisoftware, configuracaoEmbarcador, "FaturaPadrao.rpt", CodigoControleRelatorios.R010_Fatura)
        {
        }
        ...
        public override void GerarRelatorio(Dominio.Entidades.Embarcador.Fatura.Fatura fatura, Dominio.Entidades.Embarcador.Relatorios.RelatorioControleGeracao relatorioControleGeracao, Dominio.Entidades.Embarcador.Relatorios.Relatorio relatorioTemporario, Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoImpressaoFatura? tipoImpressaoFatura = null)
        {
            ...
            var report = ReportRequest.WithType(ReportType.FaturaImpressaoPadrao)
        ...
        public override Dominio.Entidades.Embarcador.Relatorios.Relatorio ObterRelatorioTemporario(Dominio.Entidades.Embarcador.Relatorios.Relatorio relatorio)
        {
            ...
            if (_tipoServicoMultisoftware == AdminMultisoftware.Dominio.Enumeradores.TipoServicoMultisoftware.MultiEmbarcador)
                relatorioTemporario.Colunas.Add(ObterRelatorioTemporarioColuna(relatorioTemporario, "Peso", relatorioTemporario.Colunas.Count, "Peso", Alinhamento.right, 8));

            relatorioTemporario.Colunas.Add(ObterRelatorioTemporarioColuna(relatorioTemporario, "Notas", relatorioTemporario.Colunas.Count, "Notas", Alinhamento.left, (_configuracaoEmbarcador.NaoExibirNotasFiscaisNaFatura ? 0 : 15)));
            ...
            relatorioTemporario.Colunas.Add(ObterRelatorioTemporarioColuna(relatorioTemporario, "ValorSemICMS", relatorioTemporario.Colunas.Count, "Valor s/ Imposto", Alinhamento.right, (exibirImpostos ? 12 : 0), tipoSumarizacao));
            ...
            relatorioTemporario.Colunas.Add(ObterRelatorioTemporarioColuna(relatorioTemporario, "TotalCobrado", relatorioTemporario.Colunas.Count, "Total Cobrado", Alinhamento.center, (exibirImpostos ? 12 : 0), tipoSumarizacao));
            relatorioTemporario.Colunas.Add(ObterRelatorioTemporarioColuna(relatorioTemporario, "PedidoNavioDirecao", relatorioTemporario.Colunas.Count));
            relatorioTemporario.Colunas.Add(ObterRelatorioTemporarioColuna(relatorioTemporario, "NumeroControleCTe", relatorioTemporario.Colunas.Count));
            relatorioTemporario.Colunas.Add(ObterRelatorioTemporarioColuna(relatorioTemporario, "Trecho", relatorioTemporario.Colunas.Count));
