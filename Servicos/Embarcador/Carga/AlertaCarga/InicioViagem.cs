...
{
    public class InicioViagem : AbstractAlertaCarga
    {
        #region Métodos públicos

        public InicioViagem(Repositorio.UnitOfWork unitOfWork, string stringConexao) : base(unitOfWork, stringConexao, Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoAlertaCarga.InicioViagem) { }
        ...
        public void ProcessarEvento(Dominio.Entidades.Embarcador.Cargas.Carga carga)
        {
            ...
            if (EstaAtivo() && carga.DataInicioViagem.HasValue)
            {
                ...
                {
                    string texto = "Carga " + carga.CodigoCargaEmbarcador + " Início viagem em " + carga.DataInicioViagem.Value.ToString("dd/MM/yyyy HH:mm:ss");
