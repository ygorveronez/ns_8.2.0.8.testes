...
{
    public class NotaDeDebito : ServicoBase
    {
        #region Construtores

        public NotaDeDebito(UnitOfWork unitOfWork) : base(unitOfWork) { }
        public NotaDeDebito() : base() { }
        
        #endregion Construtores

        #region Métodos Públicos

        public List<Dominio.ObjetosDeValor.Embarcador.Importacao.ConfiguracaoImportacao> ConfiguracaoNotaDebito(Repositorio.UnitOfWork unitOfWork, AdminMultisoftware.Dominio.Enumeradores.TipoServicoMultisoftware tipoServicoMultisoftware)
        {
            ...
            {
                new Dominio.ObjetosDeValor.Embarcador.Importacao.ConfiguracaoImportacao() { Id = 1, Descricao = "Número Referencia", Propriedade = "NumeroReferencia", Tamanho = 20, Obrigatorio = false },
                new Dominio.ObjetosDeValor.Embarcador.Importacao.ConfiguracaoImportacao() { Id = 2, Descricao = "Nome Cliente", Propriedade = "NomeCliente", Tamanho = 500, Obrigatorio = false },
                ...
                new Dominio.ObjetosDeValor.Embarcador.Importacao.ConfiguracaoImportacao() { Id = 4, Descricao = "Navio/Viagem/Direção", Propriedade = "Viagem", Tamanho = 300, Obrigatorio = false },
                new Dominio.ObjetosDeValor.Embarcador.Importacao.ConfiguracaoImportacao() { Id = 5, Descricao = "POL", Propriedade = "PortoOrigem", Tamanho = 200, Obrigatorio = false  },
                new Dominio.ObjetosDeValor.Embarcador.Importacao.ConfiguracaoImportacao() { Id = 6, Descricao = "POD", Propriedade = "PortoDestino", Tamanho = 200, Obrigatorio = false  },
                new Dominio.ObjetosDeValor.Embarcador.Importacao.ConfiguracaoImportacao() { Id = 7, Descricao = "Tipo de Proposta", Propriedade = "TipoProposta", Tamanho = 200, Obrigatorio = true, Regras = new List<string> { "required" }  },
                new Dominio.ObjetosDeValor.Embarcador.Importacao.ConfiguracaoImportacao() { Id = 8, Descricao = "Tipo de Operacao", Propriedade = "TipoOperacao", Tamanho = 200, Obrigatorio = true, Regras = new List<string> { "required" }  },
                new Dominio.ObjetosDeValor.Embarcador.Importacao.ConfiguracaoImportacao() { Id = 9, Descricao = "Valor", Propriedade = "Valor", Tamanho = 200, Obrigatorio = true, Regras = new List<string> { "required" }  },
                new Dominio.ObjetosDeValor.Embarcador.Importacao.ConfiguracaoImportacao() { Id = 10, Descricao = "Observação", Propriedade = "Observacao", Tamanho = 2000, Obrigatorio = true, Regras = new List<string> { "required" } },
        ...
        public static bool GerarNotaDebito(out Dominio.ObjetosDeValor.Embarcador.Importacao.RetornoImportacao retorno, string nomeArquivo, string dadosArquivo, Dominio.Entidades.Usuario usuario, Dominio.ObjetosDeValor.Embarcador.Auditoria.Auditado auditado, Repositorio.UnitOfWork unitOfWork)
        {
            ...
            Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebito notaDebito = new Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebito
            {
            ...
            repNotaDeDebito.Inserir(notaDebito, auditado);

            for (int i = 0; i < notaDebito.QuantidadeLinhas; i++)
            {
                Dominio.ObjetosDeValor.Embarcador.Importacao.DadosLinha dadosLinhaArquivo = linhas[i];

                Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebitoLinha linha = new Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebitoLinha()
                {
                    NotaDeDebito = notaDebito,
                    Numero = i + 1,
                    Situacao = Dominio.ObjetosDeValor.Embarcador.Enumeradores.SituacaoImportacaoPedido.Pendente
                };

                repNotaDeDebitoLinha.Inserir(linha);
                ...
                for (int j = 0; j < dadosLinhaArquivo.Colunas.Count; j++)
                {
                    ...
                    Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebitoLinhaColuna coluna = new Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebitoLinhaColuna()
                    {
                        Linha = linha,
                    ...
                    repNotaDeDebitoLinhaColuna.Inserir(coluna);
                }
            }
        ...
        public Dominio.ObjetosDeValor.Embarcador.Pedido.RetornoImportacaoPedidoGerarCarga ImportarPedidoGerarCargas(Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebito notaDebito, Dominio.Entidades.Usuario usuario, AdminMultisoftware.Dominio.Enumeradores.TipoServicoMultisoftware tipoServicoMultisoftware, string AdminStringConexao, Repositorio.UnitOfWork unitOfWork)
        {
            ...
            List<int> codigosLinhasGerar = repNotaDeDebitoLinha.BuscarCodigosLinhasPendentesGeracaoPedido(notaDebito.Codigo);
            List<Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebitoLinhaColuna> colunasGerar = repNotaDeDebitoLinhaColuna.BuscarPorNotaPendentesGeracaoPedido(notaDebito.Codigo);
            int contador = 0;
            ...
            try
            {
                ...
                {
                    Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebitoLinha linha = repNotaDeDebitoLinha.BuscarPorCodigo(codigosLinhasGerar[i], false);

                    unitOfWork.Start();
                    linha.Situacao = Dominio.ObjetosDeValor.Embarcador.Enumeradores.SituacaoImportacaoPedido.Processando;
                    repNotaDeDebitoLinha.Atualizar(linha);
                    unitOfWork.CommitChanges();

                    List<Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebitoLinhaColuna> colunas = colunasGerar.Where(o => o.Linha.Codigo == linha.Codigo).ToList();
                    Dominio.ObjetosDeValor.Embarcador.Importacao.DadosLinha dadosLinha = Servicos.Embarcador.Pedido.NotaDeDebito.ConverterParaImportacao(colunas);
                    ...
                    try
                    {
                        ...
                        if (retornoLinha.processou)
                        {
                            if (retornoLinha.codigo > 0)
                            {
                                ...
                                linha.Situacao = Dominio.ObjetosDeValor.Embarcador.Enumeradores.SituacaoImportacaoPedido.Sucesso;
                        ...
                        else
                        {
                            unitOfWork.Rollback();
                            unitOfWork.Start();
                            linha.Situacao = Dominio.ObjetosDeValor.Embarcador.Enumeradores.SituacaoImportacaoPedido.Erro;
                ...
                if (string.IsNullOrWhiteSpace(retornoFinaliza))//só vai gerar todas as cargas se todas as linhas forem processadas sem nenhum erro
                {
                    ...
                    List<Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebitoLinha> linhasGeradas = repNotaDeDebitoLinha.BuscarSemCargaPorNota(notaDebito.Codigo);

                    // Gera uma carga para cada grupo de pedidos agrupados por veículo e tipo de operação
                    foreach (Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebitoLinha agrupamentoLinhas in linhasGeradas)
                    {
                        ...
                        List<Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebitoLinha> linhas = repNotaDeDebitoLinha.BuscarPorPedido(codigosPedidos);
                        ...
                        try
                        {
                            ...
                            if (!string.IsNullOrWhiteSpace(mensagemRetornoCarga))
                            {
                                ...
                                {
                                    linhas[i].Situacao = Dominio.ObjetosDeValor.Embarcador.Enumeradores.SituacaoImportacaoPedido.Erro;
                                    linhas[i].Mensagem = (linhas[i].Mensagem + " " + mensagemRetornoCarga).Trim();
                                    repNotaDeDebitoLinha.Atualizar(linhas[i]);
                                }
                            }
                            if (carga != null)
                            {
                                repNotaDeDebitoLinha.SetarCargaLinhas(agrupamentoLinhas.Codigo, carga.Codigo);
                            }
                            unitOfWork.CommitChanges();
                            unitOfWork.FlushAndClear();
                        }
                    ...
                    retorno.TotalPedidos = repNotaDeDebitoLinha.ContarPedidosPorNotaDebito(notaDebito.Codigo);
                    retorno.TotalCargas = repNotaDeDebitoLinha.ContarCargasPorNotaDebito(notaDebito.Codigo);
        ...
        public static Dominio.ObjetosDeValor.Embarcador.Importacao.DadosLinha ConverterParaImportacao(List<Dominio.Entidades.Embarcador.Pedidos.NotaDeDebito.NotaDeDebitoLinhaColuna> colunas)
        {
        ...
        public Dominio.ObjetosDeValor.Embarcador.Importacao.RetonoLinha ImportarPedidoLinha(Dominio.ObjetosDeValor.Embarcador.Importacao.DadosLinha linha, (string Nome, string Guid) arquivoGerador, string prefixoPreCarga, List<Dominio.Entidades.Embarcador.PreCargas.PreCarga> preCargas, List<string> cargasParaCancelamento, string motivoCancelamentoCarga, Dominio.Entidades.Usuario usuario, Dominio.Entidades.Embarcador.Operacional.OperadorLogistica operadorLogistica, bool naoTentarGerarCarga, AdminMultisoftware.Dominio.Enumeradores.TipoServicoMultisoftware tipoServicoMultisoftware, Dominio.Entidades.Embarcador.Configuracao.ConfiguracaoTMS configuracaoTMS, Dominio.ObjetosDeValor.Embarcador.Auditoria.Auditado auditado, string AdminStringConexao, Repositorio.UnitOfWork unitOfWork)
        {
            ...
            try
            {
                ...
                Dominio.ObjetosDeValor.Embarcador.Importacao.DadosColuna colTipoProposta = (from obj in linha.Colunas where obj.NomeCampo == "TipoProposta" select obj).FirstOrDefault();
                if (colTipoProposta == null || string.IsNullOrWhiteSpace(colTipoProposta.Valor))
                    return RetornarFalhaLinha("O campo Tipo de Proposta é obrigatório e deve ser preenchido.");

                string tipoProposta = colTipoProposta.Valor.Trim();

                if (tipoProposta != "Nota de Débito" && tipoProposta != "Nota de Debito")
                    return RetornarFalhaLinha("O campo Tipo de Proposta deve conter apenas o valor: Nota de Débito.");
                ...
                if (tipoOperacao?.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade)
                {
                    if (empresa == null)
                ...
                if (tipoOperacao?.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade && (grupoPessoas == null || grupoPessoas.ClienteTomadorFatura == null))
                    ...
                    temGrupoPessoa = grupoPessoas.ClienteTomadorFatura != null && tipoOperacao?.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade;
                ...
                if (portoDestino == null && tipoOperacao?.TipoPropostaMultimodal != Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade)
                ...
                if (tipoCarga == null && tipoOperacao?.TipoPropostaMultimodal != Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade)
                ...
                if (unidadesContabilidade <= 0 && tipoOperacao?.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade)
                ...
                if (aliquotaICMSContabilidade <= 0 && tipoOperacao?.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade)
                ...
                if (valorICMSContabilidade <= 0 && tipoOperacao?.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade)
                ...
                if (ptaxContabilidade <= 0 && tipoOperacao?.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade)
                ...
                if (valorUSDContabilidade <= 0 && tipoOperacao?.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade)
                ...
                if (string.IsNullOrWhiteSpace(poNumberContabilidade) && tipoOperacao?.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade)
                ...
                if (string.IsNullOrWhiteSpace(observacaoParaFaturamento) && tipoOperacao?.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade)
        ...
        private Dominio.ObjetosDeValor.Embarcador.Frete.FreteValor ObterFreteValor(Dominio.ObjetosDeValor.Embarcador.Importacao.DadosLinha linha, Dominio.Entidades.Embarcador.Pedidos.TipoOperacao tipoOperacao, decimal valorUSD, Repositorio.UnitOfWork unitOfWork)
        {
            ...
            if (colValorFrete != null || (valorUSD > 0 && tipoOperacao?.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade))
            {
                Dominio.ObjetosDeValor.Embarcador.Frete.FreteValor freteValor = new Dominio.ObjetosDeValor.Embarcador.Frete.FreteValor();
                if (colValorFrete != null || (valorUSD > 0 && tipoOperacao?.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade))
                {
                    if (tipoOperacao?.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.FaturamentoContabilidade && valorUSD > 0)
                        ValorFrete = valorUSD;
                    else
        ...
        private Dominio.ObjetosDeValor.Embarcador.Importacao.RetonoLinha AdicionarPedidoImportacao(Dominio.ObjetosDeValor.Embarcador.Pedido.PedidoImportacaoSalvar pedidoImportacaoAdicionar, bool naoTentarGerarCarga, Repositorio.UnitOfWork unitOfWork, Dominio.Entidades.Embarcador.Configuracao.ConfiguracaoTMS configuracaoTMS, AdminMultisoftware.Dominio.Enumeradores.TipoServicoMultisoftware tipoServicoMultisoftware, Dominio.ObjetosDeValor.Embarcador.Auditoria.Auditado auditado)
        {
            ...
            if (pedido.TipoOperacao != null && pedido.TipoOperacao.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.DemurrageCabotagem)
                pedido.PedidoDemurrage = true;
            if (pedido.TipoOperacao != null && pedido.TipoOperacao.TipoPropostaMultimodal == Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoPropostaMultimodal.DetentionCabotagem)
