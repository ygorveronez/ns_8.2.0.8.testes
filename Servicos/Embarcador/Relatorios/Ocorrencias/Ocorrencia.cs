...
{
    public class Ocorrencia : RelatorioBase<Dominio.ObjetosDeValor.Embarcador.Ocorrencia.FiltroPesquisaRelatorioOcorrencia, Dominio.Relatorios.Embarcador.DataSource.Ocorrencias.Ocorrencia.Ocorrencia>
    {
        #region Atributos

        private readonly Repositorio.Embarcador.Ocorrencias.CargaOcorrencia _repCargaOcorrencia;

        #endregion

        #region Construtores

        public Ocorrencia(Repositorio.UnitOfWork unitOfWork, AdminMultisoftware.Dominio.Enumeradores.TipoServicoMultisoftware tipoServicoMultisoftware, AdminMultisoftware.Dominio.Entidades.Pessoas.Cliente clienteMultisoftware) : base(unitOfWork, tipoServicoMultisoftware, clienteMultisoftware)
        {

            _repCargaOcorrencia = new Repositorio.Embarcador.Ocorrencias.CargaOcorrencia(_unitOfWork);
        }

        #endregion
        // TODO: ToList metodo override
        protected override List<Dominio.Relatorios.Embarcador.DataSource.Ocorrencias.Ocorrencia.Ocorrencia> ConsultarRegistros(Dominio.ObjetosDeValor.Embarcador.Ocorrencia.FiltroPesquisaRelatorioOcorrencia filtrosPesquisa, List<PropriedadeAgrupamento> propriedadesAgrupamento, ParametroConsulta parametrosConsulta)
        {
            return _repCargaOcorrencia.ConsultarRelatorio(filtrosPesquisa, propriedadesAgrupamento, parametrosConsulta).ToList();
        }

        protected override int ContarRegistros(Dominio.ObjetosDeValor.Embarcador.Ocorrencia.FiltroPesquisaRelatorioOcorrencia filtrosPesquisa, List<PropriedadeAgrupamento> propriedadesAgrupamento)
        {
            return _repCargaOcorrencia.ContarConsultaRelatorio(filtrosPesquisa, propriedadesAgrupamento);
        }

        protected override string ObterCaminhoPaginaRelatorio()
        {
            return "Relatorios/Ocorrencias/Ocorrencia";
        }

        protected override List<Parametro> ObterParametros(Dominio.ObjetosDeValor.Embarcador.Ocorrencia.FiltroPesquisaRelatorioOcorrencia filtrosPesquisa, ParametroConsulta parametrosConsulta)
        {
            List<Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro> parametros = new List<Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro>();

            Repositorio.Usuario repositorioUsuario = new Repositorio.Usuario(_unitOfWork);

            parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("EtapaEstadia", string.Join(", ", filtrosPesquisa.EtapaEstadia?.Select(o => o.ObterDescricao()))));
            parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("OcorrenciaEstadia", filtrosPesquisa.OcorrenciaEstadia));
            ...
            {
                Dominio.Entidades.Usuario usuario = repositorioUsuario.BuscarPorCodigo(filtrosPesquisa.CodigoResponsavelChamado);
                parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("ResponsavelChamado", usuario.Nome, true));
            }
            else
            ...
            if (filtrosPesquisa.DataSolicitacaoInicial.HasValue)
                parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("DataSolicitacaoInicial", filtrosPesquisa.DataSolicitacaoInicial.Value.ToString("dd/MM/yyyy"), true));
            else
            ...
            if (filtrosPesquisa.DataSolicitacaoFinal.HasValue)
                parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("DataSolicitacaoFinal", filtrosPesquisa.DataSolicitacaoFinal.Value.ToString("dd/MM/yyyy"), true));
            else
            ...
            if (filtrosPesquisa.DataOcorrenciaInicial.HasValue)
                parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("DataOcorrenciaInicial", filtrosPesquisa.DataOcorrenciaInicial.Value.ToString("dd/MM/yyyy"), true));
            else
                parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("DataOcorrenciaInicial", false));

            if (filtrosPesquisa.DataOcorrenciaFinal.HasValue)
                parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("DataOcorrenciaFinal", filtrosPesquisa.DataOcorrenciaFinal.Value.ToString("dd/MM/yyyy"), true));
            else
            ...
            if (filtrosPesquisa.DataCancelamentoInicial.HasValue)
                parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("DataCancelamentoInicial", filtrosPesquisa.DataCancelamentoInicial.Value.ToString("dd/MM/yyyy"), true));
            else
            ...
            if (filtrosPesquisa.DataCancelamentoFinal.HasValue)
                parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("DataCancelamentoFinal", filtrosPesquisa.DataCancelamentoFinal.Value.ToString("dd/MM/yyyy"), true));
            else
            ...
            if (filtrosPesquisa.NumeroCTeOriginal > 0)
                parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("NumeroCTeOriginal", filtrosPesquisa.NumeroCTeOriginal.ToString(), true));
            else
                parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("NumeroCTeOriginal", false));

            if (filtrosPesquisa.NumeroCTeOriginal > 0)
                parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("NumeroCTeGerado", filtrosPesquisa.NumeroCTeGerado.ToString(), true));
            else
            ...
            if (filtrosPesquisa.CodigoGrupoOcorrencia.Count > 0)
            {
                ...
                List<Dominio.Entidades.Embarcador.Ocorrencias.GrupoTipoDeOcorrenciaDeCTe> grupoOcorrencia = repositorioGrupoOcorrencia.BuscarPorCodigos(filtrosPesquisa.CodigoGrupoOcorrencia, false);
            ...
            parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("TipoCreditoDebito",
                filtrosPesquisa.TipoDocumentoCreditoDebito != TipoDocumentoCreditoDebito.Todos ?
                    (filtrosPesquisa.TipoDocumentoCreditoDebito == TipoDocumentoCreditoDebito.Credito ? "Crédito" : "Débito") : null));

            parametros.Add(new Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro("TipoDocumento",
                filtrosPesquisa.TipoDocumentoEmissao != Dominio.Enumeradores.TipoDocumento.Todos ?
                    filtrosPesquisa.TipoDocumentoEmissao == Dominio.Enumeradores.TipoDocumento.CTe ? "CT-e" :
                    filtrosPesquisa.TipoDocumentoEmissao == Dominio.Enumeradores.TipoDocumento.NFSe ? "NFSe" : string.Empty : null));
        ...
        protected override string ObterPropriedadeOrdenarOuAgrupar(string propriedadeOrdenarOuAgrupar)
        {
            ...
            if (propriedadeOrdenarOuAgrupar == "DataRetornoReentregaFormatada")
                return "DataRetornoReentrega";
