...
{
    public class DespesaOrdemServicoProduto : RelatorioBase<Dominio.ObjetosDeValor.Embarcador.Frota.FiltroRelatorioDespesaOrdemServicoProduto, Dominio.Relatorios.Embarcador.DataSource.Frota.DespesaOrdemServicoProduto>
    {
        #region Atributos
        ...
        public DespesaOrdemServicoProduto(Repositorio.UnitOfWork unitOfWork, AdminMultisoftware.Dominio.Enumeradores.TipoServicoMultisoftware tipoServicoMultisoftware, AdminMultisoftware.Dominio.Entidades.Pessoas.Cliente clienteMultisoftware) : base(unitOfWork, tipoServicoMultisoftware, clienteMultisoftware)
        {
            _repositorioMovimentoFrota = new Repositorio.Embarcador.Frota.OrdemServicoFrota(_unitOfWork);
        }

        public DespesaOrdemServicoProduto(
        ...
        #region
        public async Task<IList<Dominio.Relatorios.Embarcador.DataSource.Frota.DespesaOrdemServicoProduto>> ConsultarRegistrosAsync(Dominio.ObjetosDeValor.Embarcador.Frota.FiltroRelatorioDespesaOrdemServicoProduto filtrosPesquisa, List<Dominio.Relatorios.Embarcador.ObjetosDeValor.PropriedadeAgrupamento> propriedadesAgrupamento, Dominio.ObjetosDeValor.Embarcador.Consulta.ParametroConsulta parametrosConsulta)
        {
            return await _repositorioMovimentoFrota.ConsultarRelatorioDespesaOrdemServicoProdutoAsync(filtrosPesquisa, propriedadesAgrupamento, parametrosConsulta.PropriedadeAgrupar, parametrosConsulta.DirecaoAgrupar, parametrosConsulta.PropriedadeOrdenar, parametrosConsulta.DirecaoOrdenar, parametrosConsulta.InicioRegistros, parametrosConsulta.LimiteRegistros);
        }
        #endregion

        #region Métodos Protegidos Sobrescritos
        // TODO: ToList meotodo override
        protected override List<Dominio.Relatorios.Embarcador.DataSource.Frota.DespesaOrdemServicoProduto> ConsultarRegistros(Dominio.ObjetosDeValor.Embarcador.Frota.FiltroRelatorioDespesaOrdemServicoProduto filtrosPesquisa, List<Dominio.Relatorios.Embarcador.ObjetosDeValor.PropriedadeAgrupamento> propriedadesAgrupamento, Dominio.ObjetosDeValor.Embarcador.Consulta.ParametroConsulta parametrosConsulta)
        {
            return _repositorioMovimentoFrota.ConsultarRelatorioDespesaOrdemServicoProduto(filtrosPesquisa, propriedadesAgrupamento, parametrosConsulta.PropriedadeAgrupar, parametrosConsulta.DirecaoAgrupar, parametrosConsulta.PropriedadeOrdenar, parametrosConsulta.DirecaoOrdenar, parametrosConsulta.InicioRegistros, parametrosConsulta.LimiteRegistros).ToList();
        }

        protected override int ContarRegistros(Dominio.ObjetosDeValor.Embarcador.Frota.FiltroRelatorioDespesaOrdemServicoProduto filtrosPesquisa, List<Dominio.Relatorios.Embarcador.ObjetosDeValor.PropriedadeAgrupamento> propriedadesAgrupamento)
        {
            return _repositorioMovimentoFrota.ContarConsultaRelatorioDespesaOrdemServicoProduto(filtrosPesquisa, propriedadesAgrupamento);
        }

        protected override string ObterCaminhoPaginaRelatorio()
        {
            return "Relatorios/Frotas/DespesaOrdemServicoProduto";
        }

        protected override List<Dominio.Relatorios.Embarcador.ObjetosDeValor.Parametro> ObterParametros(Dominio.ObjetosDeValor.Embarcador.Frota.FiltroRelatorioDespesaOrdemServicoProduto filtrosPesquisa, Dominio.ObjetosDeValor.Embarcador.Consulta.ParametroConsulta parametrosConsulta)
        {
