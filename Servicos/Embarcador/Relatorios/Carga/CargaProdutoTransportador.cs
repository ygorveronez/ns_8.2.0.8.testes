...
{
    public class CargaProdutoTransportador : RelatorioBase<Dominio.ObjetosDeValor.Embarcador.Carga.FiltroPesquisaCargaProdutoTransportador, Dominio.Relatorios.Embarcador.DataSource.Cargas.Carga.CargaProdutoTransportador>
    {
        #region Atributos

        private readonly Repositorio.Embarcador.Cargas.CargaPedidoProduto _repositorioCargaPedidoProduto;

        #endregion

        #region Construtores

        public CargaProdutoTransportador(Repositorio.UnitOfWork unitOfWork, AdminMultisoftware.Dominio.Enumeradores.TipoServicoMultisoftware tipoServicoMultisoftware, AdminMultisoftware.Dominio.Entidades.Pessoas.Cliente clienteMultisoftware) : base(unitOfWork, tipoServicoMultisoftware, clienteMultisoftware)
        {
            _repositorioCargaPedidoProduto = new Repositorio.Embarcador.Cargas.CargaPedidoProduto(_unitOfWork);
        }

        #endregion
        // TODO: ToList metodo override
        protected override List<Dominio.Relatorios.Embarcador.DataSource.Cargas.Carga.CargaProdutoTransportador> ConsultarRegistros(Dominio.ObjetosDeValor.Embarcador.Carga.FiltroPesquisaCargaProdutoTransportador filtrosPesquisa, List<PropriedadeAgrupamento> propriedadesAgrupamento, ParametroConsulta parametrosConsulta)
        {
            return _repositorioCargaPedidoProduto.ConsultarRelatorioCargasProdutosTransportador(filtrosPesquisa, propriedadesAgrupamento, parametrosConsulta, _tipoServicoMultisoftware, filtrosPesquisa.CodigoTransportador).ToList();
        }

        protected override int ContarRegistros(Dominio.ObjetosDeValor.Embarcador.Carga.FiltroPesquisaCargaProdutoTransportador filtrosPesquisa, List<PropriedadeAgrupamento> propriedadesAgrupamento)
        {
            return _repositorioCargaPedidoProduto.ContarConsultaRelatorioCargasProdutosTransportador(filtrosPesquisa, propriedadesAgrupamento, _tipoServicoMultisoftware, filtrosPesquisa.CodigoTransportador);
        }

        protected override string ObterCaminhoPaginaRelatorio()
        {
            return "Relatorios/Cargas/CargaProdutoTransportador";
        }

        protected override List<Parametro> ObterParametros(Dominio.ObjetosDeValor.Embarcador.Carga.FiltroPesquisaCargaProdutoTransportador filtrosPesquisa, ParametroConsulta parametrosConsulta)
        {
