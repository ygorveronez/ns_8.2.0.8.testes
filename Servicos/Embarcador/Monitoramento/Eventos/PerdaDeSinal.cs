...
{
    public class PerdaDeSinal : AbstractEvento
    {

        #region Métodos públicos

        public PerdaDeSinal(Repositorio.UnitOfWork unitOfWork) : base(unitOfWork, Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoAlerta.PerdaDeSinal)
        {
            ...
            if (monitoramentoProcessarEvento != null && monitoramentoProcessarEvento.DataVeiculoPosicao != null)
            {
                ...
                else
                {
                    ...
                    var parametrosPerdaSinal = new Dominio.ObjetosDeValor.Embarcador.Logistica.ParametrosPerdaSinalMonitoramento
                    {
                        ...
                        Latitude = monitoramentoProcessarEvento.LatitudePosicao.HasValue ? monitoramentoProcessarEvento.LatitudePosicao.Value : 0,
                        Longitude = monitoramentoProcessarEvento.LongitudePosicao.HasValue ? monitoramentoProcessarEvento.LongitudePosicao.Value : 0,
                    };
