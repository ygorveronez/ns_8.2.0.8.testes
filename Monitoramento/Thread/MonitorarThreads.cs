...
namespace Monitoramento.Thread
{
    public class MonitorarThreads : AbstractThreadProcessamento
    {
        ...
        {
            if (enable)
                MonitorarThread = base.IniciarThread(stringConexao, ambiente, tipoServicoMultisoftware, clienteMultisoftware, null, tempoSleep, cancellationToken);
