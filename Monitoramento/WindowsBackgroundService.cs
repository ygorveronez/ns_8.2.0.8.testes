namespace Monitoramento
{
    ...
    {
        public WindowsBackgroundService(MonitoramentoService monitoramentoService, ILogger<WindowsBackgroundService> logger, IConfiguration configuration) : base(monitoramentoService, logger, configuration) { }
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            try
            {
                ...
                _monitoramentoService.SetarExecucaoThreads(Cliente, StringConexao, stoppingToken);
