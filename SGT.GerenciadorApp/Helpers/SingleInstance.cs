...

    {
        ...
        private static IList<string> GetCommandLineArgs(string uniqueApplicationName)
        {
            ...
            else
            {
                ...
                // shared location               
                string appFolderPath = Utilidades.IO.FileStorageService.Storage.Combine(
                    Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), uniqueApplicationName);

                string cmdLinePath = Utilidades.IO.FileStorageService.Storage.Combine(appFolderPath, "cmdline.txt");
                if (Utilidades.IO.FileStorageService.Storage.Exists(cmdLinePath))
                {
                    try
                    {
                        ...
                        Utilidades.IO.FileStorageService.Storage.Delete(cmdLinePath);
                    }
                    catch (IOException)
                    {
                    }
