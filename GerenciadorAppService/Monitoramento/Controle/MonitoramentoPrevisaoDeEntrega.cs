...
{
    public class MonitoramentoPrevisaoDeEntrega : IMonitoramento
    {
        ...
        private void Processar(Repositorio.UnitOfWork unidadeDeTrabalho)
        {
            ...
            try
            {
                foreach (Dominio.Entidades.Embarcador.Logistica.Monitoramento cargaMonitorada in cargasMonitoradas)
                {
                    ...
                    Dominio.Entidades.Embarcador.Cargas.CargaRotaFrete cargaRotaFrete = repCargaRotaFrete.BuscarPorCarga(cargaMonitorada.Carga.Codigo);
