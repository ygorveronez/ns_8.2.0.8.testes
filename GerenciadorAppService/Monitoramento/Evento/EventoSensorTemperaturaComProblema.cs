...
{
    public class EventoSensorTemperaturaComProblema
    {
        ...
        private Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoAlerta tipoAlerta = Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoAlerta.SensorTemperaturaComProblema;
        ...
        private void InserirAlertas(List<Dominio.Entidades.Embarcador.Logistica.AlertaMonitor> listaAlertas)
        {
            ...
            catch (Exception ex)
            {
                ...
                Servicos.Log.TratarErro("Erro ao gravar EventoSensorTempraturaComProbelma: " + ex);
                throw;
            }
        }
        ...
        private void InicializarParametro()
        {
            ...
            parametro = repMonitoramentoEvento.BuscarParametorPorTipo(Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoMonitoramentoEvento.SensorTemperaturaComProblema);
        }
        private void Inicializar()
        {
            ...
            ultimoAlerta = repAlerta.BuscarUltimoAlertaVeiculo(Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoAlerta.SensorTemperaturaComProblema);
        ...
        private void Processar()
        {
            ...
            foreach (Dominio.Entidades.Embarcador.Logistica.Monitoramento cargaMonitorada in cargasMonitoradas)
            {
                ...
                foreach (var posicaoVeiculo in posicoesVeiculo)
                {
                    ...
                    var sensorComProblema = !(posicaoVeiculo.SensorTemperatura ?? false);
                    if (sensorComProblema)
                    {
                    ...
                    if (tempoMinimo && sensorComProblema)
                    {
