...
namespace SGT.Monitoramento.Thread
{
    ...
    public class ImportarPosicoesPendentesIntegracao : AbstractThreadProcessamento
    {
        ...
        {
            if (enable)
                PosicoesPendentesThread = base.IniciarThread(stringConexao, ambiente, tipoServicoMultisoftware, clienteMultisoftware, arquivoNivelLog, tempoSleep);
