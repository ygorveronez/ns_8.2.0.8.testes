<%@ Page Title="Relatório de CT-es Redespacho" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="RelatorioCTesRedespacho.aspx.cs" Inherits="EmissaoCTe.WebAdmin.RelatorioCTesRedespacho" %>
    ...
    <script defer="defer" type="text/javascript">
        ...
        function GerarRelatorio() {
            var dados = {
                ...
                SerieEmissaoCte: $("#txtSerieEmissaoCte").val(),
                Arquivo: $("#selArquivo").val(),
                CnpjEmbarcador: $("#hddCodigoEmbarcador").val(),
                Empresa: $("#hddCodigoEmpresa").val()
            };

            executarDownload('/RelatorioCTesRedespacho/DownloadRelatorio', dados);
        }
    </script>
</asp:Content>
    ...
    <div id="page-layout">
        <div id="page-content" style="min-height: 500px;">
            <div class="inner-page-title">
                <h3>Relatório de CT-es Redespacho
                </h3>
            </div>
                    ...
                    <div class="fields" style="margin-top: 15px;">
                        ...
                        <div class="fieldzao">
                            ...
                            <div class="field fielddois">
                                ...
                                <div class="input">
                                    <input type="text" id="txtSerieEmissaoCte" />
                                </div>
                            </div>
                            <div class="field fielddois">
                                <div class="label">
