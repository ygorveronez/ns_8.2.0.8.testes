<%@ Page Title="Relatório Averbação MDFe" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="RelatorioAverbacaoMDFe.aspx.cs" Inherits="EmissaoCTe.WebAdmin.RelatorioAverbacaoMDFe" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        ...
        function ValidaCampos(){
            var data_inicial = $("#txtDataInicial").val();
            var data_final = $("#txtDataFinal").val();
            var valido = true;

            if (data_inicial == null || data_inicial == "") {
                valido = false;
                ExibirMensagemAlerta("Data inicial não pode ser vazia.", "Atenção!");
            } else
                if (data_final == null || data_final == "") {
                    valido = false;
                    ExibirMensagemAlerta("Data final não pode ser vazia.", "Atenção!");
                } else {
                    ...
                    if (intervaloDias > 30) {
                        valido = false;
                        ExibirMensagemAlerta("Intervalo de dias não pode ser superior a 30 dias.", "Atenção!");
                    }
                }
    ...
    <div style="display: none;">
        <div id="divRelatorio">
            <asp:UpdatePanel ID="uppRelatorio" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <rsweb:ReportViewer ID="rvwRelatorioAverbacaoMDFe" runat="server" AsyncRendering="true" Width="800" Height="700" ExportContentDisposition="AlwaysInline" EnableTheming="true" PromptAreaCollapsed="true" ShowFindControls="false"
                        ShowWaitControlCancelLink="false" ZoomMode="PageWidth" ShowZoomControl="false">
                        <LocalReport ReportPath="Relatorios/RelatorioAverbacaoMDFe.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </ContentTemplate>
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="rvwRelatorioAverbacaoMDFe" />
