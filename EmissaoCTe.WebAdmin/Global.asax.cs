...
namespace EmissaoCTe.WebAdmin
{
    public class Global : System.Web.HttpApplication
    {
        protected void Application_Start(object sender, EventArgs e)
        {
            ...
            //API.ServicoImportacaoPreCTe.GetInstance().Start(Conexao.StringConexao);
        ...
        protected void Session_End(object sender, EventArgs e)
        {
            ...
            Repositorio.UnitOfWork unitOfWork = new Repositorio.UnitOfWork(EmissaoCTe.WebAdmin.Conexao.StringConexao);
            ...
            try
            {
                ...
                //Request não fica disponível neste contexto, por isso não é salvo. Para identificar qual a sessão de início deve-se verificar pelo SessionID.
                logAcesso.IPAcesso = string.Empty;
