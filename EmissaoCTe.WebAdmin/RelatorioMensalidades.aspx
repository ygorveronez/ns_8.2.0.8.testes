<%@ Page Title="Relatório de Mensalidades" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="RelatorioMensalidades.aspx.cs" Inherits="EmissaoCTe.WebAdmin.RelatorioMensalidades" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        ...
        function SetarDadosPadroes() {
            var data = new Date();
            
            $("#selMes").val(data.getMonth());
            $("#selAno").val(data.getFullYear());
        }
    </script>
</asp:Content>
                    ...
                    <div class="fields" style="margin-top: 15px;">
                        ...
                        <div class="fieldzao">
                            <div class="field fielddois">
                                ...
                                <div class="input">
                                    <asp:DropDownList ID="selMes" ClientIDMode="Static" CssClass="select" runat="server">
                            ...
                            <div class="field fielddois">
                                ...
                                <div class="input">
                                    <asp:DropDownList ID="selAno" ClientIDMode="Static" CssClass="select" runat="server">
                                    </asp:DropDownList>
                                </div>
                            </div>
    ...
    <div style="display: none;">
        <div id="divRelatorio">
            <asp:UpdatePanel ID="uppRelatorio" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <rsweb:ReportViewer ID="rvwRelatorioMensalidades" runat="server" AsyncRendering="true" Width="800" Height="700" ExportContentDisposition="AlwaysInline" EnableTheming="true" PromptAreaCollapsed="true" ShowFindControls="false"
                        ShowWaitControlCancelLink="false" ZoomMode="PageWidth" ShowZoomControl="false">
                        <LocalReport ReportPath="Relatorios/RelatorioMensalidades.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </ContentTemplate>
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="rvwRelatorioMensalidades" />
