<%@ Page Title="Relatório de MDF-es Emitidos" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="RelatorioMDFesEmitidos.aspx.cs" Inherits="EmissaoCTe.WebAdmin.RelatorioMDFesEmitidos" %>
    ...
    <div id="page-layout">
        <div id="page-content" style="min-height: 500px;">
            <div class="inner-page-title">
                <h3>Relatório de MDF-es Emitidos
                </h3>
            </div>
    ...
    <div style="display: none;">
        <div id="divRelatorio">
            <asp:UpdatePanel ID="uppRelatorio" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <rsweb:ReportViewer ID="rvwRelatorioMDFesEmitidos" runat="server" AsyncRendering="true" Width="800" Height="700" ExportContentDisposition="AlwaysInline" EnableTheming="true" PromptAreaCollapsed="true" ShowFindControls="false"
                        ShowWaitControlCancelLink="false" ZoomMode="PageWidth" ShowZoomControl="false">
                        <LocalReport ReportPath="Relatorios/RelatorioMDFesEmitidos.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </ContentTemplate>
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="rvwRelatorioMDFesEmitidos" />
