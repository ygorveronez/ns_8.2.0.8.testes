<%@ Page Title="Relatório de Emissão Por Usuário" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="RelatorioEmissaoPorUsuario.aspx.cs" Inherits="EmissaoCTe.WebAdmin.RelatorioEmissaoPorUsuario" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        $(document).ready(function () {
            //$("#txtDataInicial").mask("99/99/9999").datepicker({ changeMonth: true, changeYear: true });
            //$("#txtDataFinal").mask("99/99/9999").datepicker({ changeMonth: true, changeYear: true });
            $("#txtDataInicial").mask("99/99/9999 99:99");
            $("#txtDataFinal").mask("99/99/9999 99:99");
            SetaDataAtual();
        ...
        function SetaDataAtual() {
            var date = new Date();
            $("#txtDataInicial").val(Globalize.format(date, "dd/MM/yyyy 00:00"));
            $("#txtDataFinal").val(Globalize.format(date, "dd/MM/yyyy 23:59"));
        }

        function RetornoConsultaUsuario(usuario) {
            $("#hddCodigoUsuario").val(usuario.Codigo);
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div style="display: none;">
        <asp:HiddenField ID="hddCodigoUsuario" Value="0" runat="server" ClientIDMode="Static" />
        <asp:Button ID="btnGerarRelatorio" runat="server" OnClick="btnGerarRelatorio_Click" ClientIDMode="Static" />
    </div>
    <div id="page-layout">
        <div id="page-content" style="min-height: 500px;">
            <div class="inner-page-title">
                <h3>Relatório de Emissão Por Usuário</h3>
            </div>
                    ...
                    <div class="fields" style="margin-top: 15px;">
                        ...
                        <div class="fieldzao">
                            <div class="field fielddois">
                                ...
                                <div class="input">
                                    <asp:DropDownList ID="selRealtorioGrafico" CssClass="select" runat="server" ClientIDMode="Static">
                                        <asp:ListItem Value="false" Text="Totais Por Data"></asp:ListItem>
                                        <asp:ListItem Value="true" Text="Gráfico Por Usuário"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
    ...
    <div style="display: none;">
        <div id="divRelatorio">
            <asp:UpdatePanel ID="uppRelatorio" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <rsweb:ReportViewer ID="rvwRelatorioEmissaoPorUsuarioDetalhado" runat="server" AsyncRendering="true" Width="800" Height="700" ExportContentDisposition="AlwaysInline" EnableTheming="true" PromptAreaCollapsed="true" ShowFindControls="false"
                        ShowWaitControlCancelLink="false" ZoomMode="PageWidth" ShowZoomControl="false">
                        <LocalReport ReportPath="Relatorios/RelatorioEmissaoPorUsuarioDetalhado.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <rsweb:ReportViewer ID="rvwRelatorioEmissaoPorUsuarioGrafico" runat="server" AsyncRendering="true" Width="800" Height="700" ExportContentDisposition="AlwaysInline" EnableTheming="true" PromptAreaCollapsed="true" ShowFindControls="false"
                        ShowWaitControlCancelLink="false" ZoomMode="PageWidth" ShowZoomControl="false">
                        <LocalReport ReportPath="Relatorios/RelatorioEmissaoPorUsuarioGrafico.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </ContentTemplate>
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="rvwRelatorioEmissaoPorUsuarioDetalhado" />
                    <asp:AsyncPostBackTrigger ControlID="rvwRelatorioEmissaoPorUsuarioGrafico" />
