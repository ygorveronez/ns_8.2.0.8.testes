<%@ Page Title="Relatório de CT-es Emitidos por Embarcador" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="RelatorioCTesEmitidosPorEmbarcador.aspx.cs" Inherits="EmissaoCTe.WebAdmin.RelatorioCTesEmitidosPorEmbarcador" %>
    ...
    <script defer="defer" type="text/javascript">
        ...
        function GerarRelatorio() {
            var dados = {
                ...
                DataInicialAutorizacao: $("#txtDataAutorizacaoInicial").val(),
                DataFinalAutorizacao: $("#txtDataAutorizacaoFinal").val(),
                CnpjEmbarcador: $("#hddCodigoEmbarcador").val(),
                CnpjRaiz: $("#selTodosCNPJRaiz").val(),
                TipoEmissao: $("#selTipoEmissao").val(),
                TipoRelatorio: $("#selTipoRelatorio").val(),
                Arquivo: $("#selArquivo").val(),
                Empresa: $("#hddCodigoEmpresa").val(),
                TipoCliente: $("#selTipoCliente").val() 
            };
            executarDownload('/RelatorioCTesEmitidos/DownloadRelEmitidosEmbarcador', dados);
        }
    </script>
</asp:Content>
    ...
    <div id="page-layout">
        <div id="page-content" style="min-height: 500px;">
            <div class="inner-page-title">
                <h3>Relatório de CT-es Emitidos por Embarcador
                </h3>
            </div>
                    ...
                    <div class="fields" style="margin-top: 15px;">
                           ...
                           <div class="field fielddois">
                                ...
                                <div class="input">
                                    <asp:DropDownList ID="selTipoEmissao" CssClass="select" runat="server" ClientIDMode="Static">
                                        ...
                                        <asp:ListItem Value="0" Text="Manuais"></asp:ListItem>
                        ...
                        <div class="fieldzao">
                            <div class="field fielddois">
                                ...
                                <div class="input">
                                    <asp:DropDownList ID="selTipoCliente" CssClass="select" runat="server" ClientIDMode="Static">
                                        <asp:ListItem Value="0" Text="Embarcador/Remetente"></asp:ListItem>
                                        ...
                                        <asp:ListItem Value="4" Text="Tomador"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="field fielddois">
                                ...
                                <div class="input">
                                    <asp:DropDownList ID="selTipoRelatorio" CssClass="select" runat="server" ClientIDMode="Static">
                                        <asp:ListItem Value="" Text="Detalhado"></asp:ListItem>
                                        <asp:ListItem Value="Sum" Text="Sumarizado"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="field fielddois">
                                ...
                                <div class="input">
                                    <asp:DropDownList ID="selArquivo" CssClass="select" runat="server" ClientIDMode="Static">
