<%@ Page Title="Importação de Motoristas" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="ImportacaoDeMotoristas.aspx.cs" Inherits="EmissaoCTe.WebAdmin.ImportacaoDeMotoristas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnImportarMotoristas").click(function () {
                ImportarMotoristas();
            });
        ...
        function ImportarMotoristas() {
            if (ValidarDados()) {
                ...
                executarRest("/ImportacaoMotorista/Importar?callback=?", dados, function (r) {
                    if (r.Sucesso) {
    ...
    <div id="page-layout">
        <div id="page-content" style="min-height: 500px;">
            <div class="inner-page-title">
                <h3>Importação de Motoristas das Empresas
                </h3>
            </div>
                ...
                <div class="form">
                    <div class="fields" style="margin-top: 15px;">
                        ...
                        <div class="buttons" style="margin-left: 5px;">
                            <input type="button" id="btnImportarMotoristas" value="Importar Motoristas" />
                        </div>
                    </div>
                </div>
            </div>
