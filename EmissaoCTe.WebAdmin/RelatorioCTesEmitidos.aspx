<%@ Page Title="Relatório de CT-es Emitidos" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="RelatorioCTesEmitidos.aspx.cs" Inherits="EmissaoCTe.WebAdmin.RelatorioCTesEmitidos" %>
    ...
    <div id="page-layout">
        <div id="page-content" style="min-height: 500px;">
            <div class="inner-page-title">
                <h3>Relatório de CT-es Emitidos
                </h3>
            </div>
                    ...
                    <div class="fields" style="margin-top: 15px;">
                        ...
                        <div class="fieldzao">
                            <div class="field fielddois">
                                ...
                                <div class="input">
                                    <asp:TextBox ID="txtDataAutorizacaoInicial" runat="server" ClientIDMode="Static"></asp:TextBox>
                                </div>
                            </div>
                            <div class="field fielddois">
                                <div class="label">
                                ...
                                <div class="input">
                                    <asp:TextBox ID="txtDataAutorizacaoFinal" runat="server" ClientIDMode="Static"></asp:TextBox>
                                </div>
                            </div>
                            <div class="field fielddois">
                                <div class="label">
                                ...
                                <div class="input">
                                    <asp:TextBox ID="txtSerie" runat="server" ClientIDMode="Static"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="fieldzao">
                            <div class="field fielddois">
                                ...
                                <div class="input">
                                    <asp:DropDownList ID="selTipoEmissao" CssClass="select" runat="server" ClientIDMode="Static">
                                        <asp:ListItem Value="0" Text="Todos"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="Integrados"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="Manuais"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="field fielddois">
                                ...
                                <div class="input">
                                    <asp:DropDownList ID="selEmissaoPor" CssClass="select" runat="server" ClientIDMode="Static">
                                        <asp:ListItem Value="" Text="Todos"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="CallCenter"></asp:ListItem>
                            ...
                            <div class="field fielddois">
                                ...
                                <div class="input">
                                    <asp:DropDownList ID="selRealtorioGrafico" CssClass="select" runat="server" ClientIDMode="Static">
                                        <asp:ListItem Value="false" Text="Detalhado"></asp:ListItem>
                                        <asp:ListItem Value="true" Text="Gráfico"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
    ...
    <div style="display: none;">
        <div id="divRelatorio">
            <asp:UpdatePanel ID="uppRelatorio" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <rsweb:ReportViewer ID="rvwRelatorioCTesEmitidos" runat="server" AsyncRendering="true" Width="800" Height="700" ExportContentDisposition="AlwaysInline" EnableTheming="true" PromptAreaCollapsed="true" ShowFindControls="false"
                        ShowWaitControlCancelLink="false" ZoomMode="PageWidth" ShowZoomControl="false">
                        <LocalReport ReportPath="Relatorios/RelatorioCTesEmitidos.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <rsweb:ReportViewer ID="rvwRelatorioCTesEmitidosGrafico" runat="server" AsyncRendering="true" Width="800" Height="700" ExportContentDisposition="AlwaysInline" EnableTheming="true" PromptAreaCollapsed="true" ShowFindControls="false"
                        ShowWaitControlCancelLink="false" ZoomMode="PageWidth" ShowZoomControl="false">
                        <LocalReport ReportPath="Relatorios/RelatorioCTesEmitidosGrafico.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </ContentTemplate>
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="rvwRelatorioCTesEmitidos" />
                    <asp:AsyncPostBackTrigger ControlID="rvwRelatorioCTesEmitidosGrafico" />
