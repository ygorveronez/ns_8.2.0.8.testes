<%@ Page Title="Cadastro de Tipos de Custos Fixos" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="TiposDeCustosFixos.aspx.cs" Inherits="EmissaoCTe.WebApp.TiposDeCustosFixos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        $(document).ready(function () {
            CarregarConsultaDeTiposDeCustosFixos("default-search", "default-search", "", RetornoConsultaTipoDeCustoFixo, true, false);
        ...
        function Salvar() {
            if (ValidarCampos()) {
                executarRest("/TipoDeCustoFixo/Salvar?callback=?", { Codigo: $("#hddCodigo").val(), Descricao: $("#txtDescricao").val(), Status: $("#selStatus").val() }, function (r) {
                    if (r.Sucesso) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="page-header">
        <h2>Cadastro de Tipos de Custos Fixos
        </h2>
    </div>
