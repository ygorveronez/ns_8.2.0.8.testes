<%@ Page Title="Cadastro de Marcas de Pneus" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="MarcasDePneus.aspx.cs" Inherits="EmissaoCTe.WebApp.MarcasDePneus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        $(document).ready(function () {
            CarregarConsultaDeMarcasDePneus("default-search", "default-search", "", RetornoConsultaMarcaDePneu, true, false);
        ...
        function RetornoConsultaMarcaDePneu(tipo) {
        ...
        function Salvar() {
            if (ValidarCampos()) {
                executarRest("/MarcaDePneu/Salvar?callback=?", { Codigo: $("#hddCodigo").val(), Descricao: $("#txtDescricao").val(), Status: $("#selStatus").val() }, function (r) {
                    if (r.Sucesso) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="page-header">
        <h2>Cadastro de Marcas de Pneus
        </h2>
    </div>
