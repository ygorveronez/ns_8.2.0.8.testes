<%@ Page Title="Cadastro de Tipos de Ocorrências" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="TiposDeOcorrencias.aspx.cs" Inherits="EmissaoCTe.WebApp.TiposDeOcorrencias" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        $(document).ready(function () {
            CarregarConsultaDeTiposDeOcorrencias("default-search", "default-search", "", RetornoConsultaTipoDeOcorrencia, true, false);
        ...
        function Salvar() {
            if (ValidarCampos()) {
                executarRest("/TipoDeOcorrencia/Salvar?callback=?", { Codigo: $("#hddCodigo").val(), Descricao: $("#txtDescricao").val(), Status: $("#selStatus").val(), Tipo: $("#selTipo").val() }, function (r) {
                    if (r.Sucesso) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="page-header">
        <h2>Cadastro de Tipos de Ocorrências
        </h2>
    </div>
