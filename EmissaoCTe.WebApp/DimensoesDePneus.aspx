<%@ Page Title="Cadastro de Dimensões de Pneus" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="DimensoesDePneus.aspx.cs" Inherits="EmissaoCTe.WebApp.DimensoesDePneus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        $(document).ready(function () {
            CarregarConsultaDeDimensoesDePneus("default-search", "default-search", "", RetornoConsultaDimensaoDePneu, true, false);
        ...
        function RetornoConsultaDimensaoDePneu(tipo) {
        ...
        function Salvar() {
            if (ValidarCampos()) {
                executarRest("/DimensaoDePneu/Salvar?callback=?", { Codigo: $("#hddCodigo").val(), Descricao: $("#txtDescricao").val(), Status: $("#selStatus").val() }, function (r) {
                    if (r.Sucesso) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="page-header">
        <h2>Cadastro de Dimensões de Pneus
        </h2>
    </div>
