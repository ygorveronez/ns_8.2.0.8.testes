<%@ Page Title="Relatório de Pagamentos de Motoristas por CT-e" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="RelatorioPagamentoMotorista.aspx.cs" Inherits="EmissaoCTe.WebApp.RelatorioPagamentoMotorista" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function DownloadRelatorio() {
            ...
            executarDownload("/RelatorioPagamentoMotorista/DownloadRelatorio", dados);
        }
    </script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="page-header">
        <h2>Relatório de Pagamentos de Motoristas por CT-e
        </h2>
    </div>
