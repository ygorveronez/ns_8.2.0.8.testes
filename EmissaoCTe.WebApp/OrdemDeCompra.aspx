<%@ Page Title="Ordem De Compra" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="OrdemDeCompra.aspx.cs" Inherits="EmissaoCTe.WebApp.OrdemDeCompra" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <asp:PlaceHolder runat="server">
        ...
        <%: System.Web.Optimization.Scripts.Render("~/bundle/scripts/blockui",
                           ...
                           "~/bundle/scripts/ordemDeCompra") %>
    </asp:PlaceHolder>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="page-header">
        <h2>Requisição de Serviço</h2>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="input-group">
                <span class="input-group-addon">Veículo:</span>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            <div class="input-group">
                <span class="input-group-addon">
                    <abbr title="Modelo do Veículo">Modelo</abbr>:
                </span>
                <input type="text" id="txtModelo" class="form-control" autocomplete="off">
                <span class="input-group-btn">
