<%@ Page Title="Cadastro de Marcas de Veículos" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="MarcasDeVeiculos.aspx.cs" Inherits="EmissaoCTe.WebApp.MarcasDeVeiculos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        $(document).ready(function () {
            CarregarConsultaDeMarcasDeVeiculos("default-search", "default-search", "", RetornoConsultaMarcaDeVeiculo, true, false);
        ...
        function RetornoConsultaMarcaDeVeiculo(tipo) {
        ...
        function Salvar() {
            if (ValidarCampos()) {
                executarRest("/MarcaDeVeiculo/Salvar?callback=?", { Codigo: $("#hddCodigo").val(), Descricao: $("#txtDescricao").val(), Status: $("#selStatus").val() }, function (r) {
                    if (r.Sucesso) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="page-header">
        <h2>Cadastro de Marcas de Veículos
        </h2>
    </div>
