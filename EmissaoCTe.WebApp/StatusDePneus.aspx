<%@ Page Title="Cadastro de Status de Pneus" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="StatusDePneus.aspx.cs" Inherits="EmissaoCTe.WebApp.StatusDePneus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        $(document).ready(function () {
            CarregarConsultaDeStatusDePneus("default-search", "default-search", "", "", RetornoConsultaStatusPneu, true, false);
        ...
        function RetornoConsultaStatusPneu(tipo) {
            $("#txtDescricao").val(tipo.Descricao);
            $("#selTipo").val(tipo.Tipo);
        ...
        function Salvar() {
            if (ValidarCampos()) {
                executarRest("/StatusDePneu/Salvar?callback=?", { Codigo: $("#hddCodigo").val(), Descricao: $("#txtDescricao").val(), Status: $("#selStatus").val(), Tipo: $("#selTipo").val() }, function (r) {
                    if (r.Sucesso) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="page-header">
        <h2>Cadastro de Status de Pneus
        </h2>
    </div>
