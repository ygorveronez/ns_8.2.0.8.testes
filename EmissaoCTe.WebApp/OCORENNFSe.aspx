<%@ Page Title="Geração de Arquivos de Integração - OCOREN NFS-e" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="OCORENNFSe.aspx.cs" Inherits="EmissaoCTe.WebApp.OCORENNFSe" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        ...
        function GerarOCOREN() {
            ...
            executarDownload("/OCOREN/GerarNFSe", dados);
        }
