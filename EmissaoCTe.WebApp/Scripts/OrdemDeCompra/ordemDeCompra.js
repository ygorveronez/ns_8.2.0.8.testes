...
function LimparCampos() {
    ...
    $("#txtVeiculo").val("");
    $("#txtVeiculo").data("codigo", 0);

    $("#txtModelo").val("");
    $("#txtModelo").data("codigo", 0);
...
function BuscarProximoNumero() {
    executarRest("/OrdemCompra/ObterProximoNumero?callback=?", '', function (r) {
        if (r.Sucesso) {
...
function DownloadOrdem() {
    executarDownload("/OrdemCompra/DownloadOrdem", { Codigo: $("body").data("codigo"), Tipo: "1" });
}
