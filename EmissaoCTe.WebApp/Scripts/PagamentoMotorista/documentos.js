...
$(document).ready(function () {
    $("#txtCTeDataEmissaoInicio").datepicker();
    $("#txtCTeDataEmissaoFim").datepicker();
    $("#txtCTeDataEmissaoInicio").mask("99/99/9999");
    $("#txtCTeDataEmissaoFim").mask("99/99/9999");
