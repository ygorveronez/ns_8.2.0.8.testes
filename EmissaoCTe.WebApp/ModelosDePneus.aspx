<%@ Page Title="Cadastro de Modelos de Pneus" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="ModelosDePneus.aspx.cs" Inherits="EmissaoCTe.WebApp.ModelosDePneus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        $(document).ready(function () {
            CarregarConsultaDeModelosDePneus("default-search", "default-search", "", RetornoConsultaModeloDePneu, true, false);
        ...
        function RetornoConsultaModeloDePneu(tipo) {
        ...
        function Salvar() {
            if (ValidarCampos()) {
                executarRest("/ModeloDePneu/Salvar?callback=?", { Codigo: $("#hddCodigo").val(), Descricao: $("#txtDescricao").val(), Status: $("#selStatus").val() }, function (r) {
                    if (r.Sucesso) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="page-header">
        <h2>Cadastro de Modelos de Pneus
        </h2>
    </div>
