<%@ Page Title="Relatório de Históricos de Pneus" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="RelatorioHistoricosPneus.aspx.cs" Inherits="EmissaoCTe.WebApp.RelatorioHistoricosPneus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        ...
        function DownloadRelatorio() {
            ...
            executarDownload("/RelatorioHistoricosPneus/DownloadRelatorio", dados);
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="page-header">
        <h2>Relatório de Históricos de Pneus
        </h2>
    </div>
