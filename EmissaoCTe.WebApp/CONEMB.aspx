<%@ Page Title="Geração de Arquivos de Integração - CONEMB" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="CONEMB.aspx.cs" Inherits="EmissaoCTe.WebApp.CONEMB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        ...
        function GerarCONEMB() {
            executarRest("/CONEMB/PreparaGerarao?callback=?", { CTes: $("body").data("ctesSelecionados") != null ? JSON.stringify($("body").data("ctesSelecionados")) : "" }, function (r) {
                if (r.Sucesso) {
                    executarDownload("/CONEMB/Gerar", {
        ...
        function CarregarLayoutsEDI() {
            executarRest("/LayoutEDI/BuscarTodosPorTipo?callback=?", { TipoLayout: 0 }, function (r) {
                if (r.Sucesso) {
    ...
    <script id="ScriptConsultaCTe" type="text/javascript">
        ...
        function SelecionarTodos() {
            ...
            executarRest("/CONEMB/SelecionarTodos?callback=?", dados, function (r) {
                if (r.Sucesso) {
                    for (var i = 0; i < r.Objeto.length; i++) {
                        var cte = r.Objeto[i];
        ...
        function AtualizarGridCTes() {
            ...
            CriarGridView("/CONEMB/Consultar?callback=?", dados, "tbl_ctes_consulta_table", "tbl_ctes_consulta", "tbl_ctes_consulta_paginacao", [{ Descricao: "Selecionar", Evento: RetornoConsultaCTe }], [0], null);
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="page-header">
        <h2>Geração de Arquivos de Integração - CONEMB
        </h2>
    </div>
    ...
    <button type="button" id="btnGerarCONEMB" class="btn btn-primary">Gerar CONEMB</button>
