...
namespace Dominio.ObjetosDeValor.Embarcador.Integracao.EMP
{
    public class CTeManual
    {
        ...
        public string NumeroContainerAnulado { get; set; }
        public string NumeroLacreAnulado { get; set; }
        public int NumeroCTeAnulado { get; set; }
        public int SerieCTeAnulado { get; set; }
        public decimal PesoCTeAnulado { get; set; }
        public string CNPJEmitente { get; set; }
        public int NumeroCTeSubstituto { get; set; }
        public int SerieCTeSubstituto { get; set; }
        public decimal PesoCTeSubstituto { get; set; }
        public string NumeroConatainerCTeSubstituto { get; set; }
        public string NumeroLacreCTeSubstituto { get; set; }
