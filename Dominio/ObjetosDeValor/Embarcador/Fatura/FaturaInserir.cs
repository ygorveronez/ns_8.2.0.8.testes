...
namespace Dominio.ObjetosDeValor.Embarcador.Fatura
{
    public class FaturaInserir
    {
        ...
        public List<Dominio.ObjetosDeValor.Embarcador.Fatura.FaturaIntegracaoParcela> Parcelas { get; set; }
        ...
        public ObjetosDeValor.Embarcador.Enumeradores.EtapaFatura Etapa { get; set; }
        ...
        public Dominio.ObjetosDeValor.Embarcador.Financeiro.CentroResultado CentroDeResultado { get; set; }
        public List<ObjetosDeValor.Embarcador.Enumeradores.TipoOSConvertido> TipoOSConvertido { get; set; }
    }
    public class RetornoFaturaInserir
    {
        public int Codigo { get; set; }
        public virtual ObjetosDeValor.Embarcador.Enumeradores.SituacaoFatura Situacao { get; set; }
        public int Numero { get; set; }
