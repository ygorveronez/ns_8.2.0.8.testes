...
{
    public sealed class FiltroPesquisaRelatorioNFeCTeContainer
    {
        ...
        public OpcaoSimNaoPesquisa FoiAnulado { get; set; }
        public OpcaoSimNaoPesquisa FoiSubstituido { get; set; }
    }
}
