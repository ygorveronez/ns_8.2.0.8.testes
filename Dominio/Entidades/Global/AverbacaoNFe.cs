...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_NFE_AVERBACAO", EntityName = "AverbacaoNFe", Name = "Dominio.Entidades.AverbacaoNFe", NameType = typeof(AverbacaoNFe))]
    public class AverbacaoNFe : EntidadeBase
    {
        ...
        [NHibernate.Mapping.Attributes.Set(0, Name = "ArquivosTransacao", Cascade = "none", Lazy = NHibernate.Mapping.Attributes.CollectionLazy.True, Table = "T_AVERBACAO_NFE_INTEGRACAO_ARQUIVO_ARQUIVO")]
        ...
        [NHibernate.Mapping.Attributes.Set(0, Name = "ArquivosTransacaoCancelamento", Cascade = "none", Lazy = NHibernate.Mapping.Attributes.CollectionLazy.True, Table = "T_AVERBACAO_NFE_INTEGRACAO_ARQUIVO_CANCELAMENTO_ARQUIVO")]
        [NHibernate.Mapping.Attributes.Key(1, Column = "AVN_CODIGO")]
        [NHibernate.Mapping.Attributes.ManyToMany(2, Class = "AverbacaoIntegracaoArquivo", Column = "AIA_CODIGO")]
