...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_MENSAGEM_AVISO", EntityName = "MensagemAviso", Name = "Dominio.Entidades.MensagemAviso", NameType = typeof(MensagemAviso))]
    public class MensagemAviso : EntidadeBase, Interfaces.Embarcador.Entidade.IEntidade, IEquatable<MensagemAviso>
    {
        ...
        [NHibernate.Mapping.Attributes.ManyToMany(2, Class = "MensagemAvisoAnexo", Column = "ANX_CODIGO")]
        public virtual IList<Dominio.Entidades.MensagemAvisoAnexo> Anexos { get; set; }
