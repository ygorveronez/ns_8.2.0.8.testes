...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_CTE_ITEM_NFSE", EntityName = "NFSeItem", Name = "Dominio.Entidades.NFSeItem", NameType = typeof(NFSeItem))]
    public class NFSeItem : EntidadeBase
    {
        ...
        public virtual Dominio.Entidades.NFSeItem Clonar()
        {
            return (Dominio.Entidades.NFSeItem)this.MemberwiseClone();
        }
    }
}
