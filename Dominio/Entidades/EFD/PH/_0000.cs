...
namespace Dominio.Entidades.EFD.PH
{
    public class _0000 : RegistroPH
    {
        ...
        public Dominio.Enumeradores.FinalidadeDoArquivoPH FinalidadeArquivo { get; set; }
        ...
        public override string ObterDadosParaArquivo()
        {
            ...
            this.EscreverDado(this.IDE_PH); //IDE_PH
            this.EscreverDado(this.ID_UNICO); //ID_UNICO
