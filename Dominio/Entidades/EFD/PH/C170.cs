...
namespace Dominio.Entidades.EFD.PH
{
    public class C170 : RegistroPH
    {
        ...
        public Dominio.Entidades.Embarcador.Financeiro.DocumentoEntradaItem Item { get; set; }
        ...
        public override string ObterDadosParaArquivo()
        {
            ...
            this.EscreverDado(UnidadeDeMedidaHelper.ObterSigla(this.Item.UnidadeMedida), 6); //UNID
            this.EscreverDado(this.Item.ValorTotal); //VL_ITEM
            this.EscreverDado(this.Item.Desconto); //VL_DESC
            this.EscreverDado("1"); //IND_MOV
            this.EscreverDado(this.Item.CSTICMS, 3); //CST_ICMS
