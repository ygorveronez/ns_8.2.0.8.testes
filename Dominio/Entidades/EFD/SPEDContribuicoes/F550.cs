...
{
    public class F550 : Registro
    {
        #region Contrutores

        public F550() : base("F550") { }

        #endregion

        #region Propriedades

        public decimal ValorTotalDaReceitaAuferida { get; set; }
        ...
        {
            this.EscreverDado(this.ValorTotalDaReceitaAuferida); //VL_REC_COMP
