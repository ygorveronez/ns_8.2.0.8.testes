...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_FECHAMENTO_FRETE_INTEGRACAO", EntityName = "FechamentoFreteIntegracao", Name = "Dominio.Entidades.Embarcador.Fechamento.FechamentoFreteIntegracao", NameType = typeof(FechamentoFreteIntegracao))]
    public class FechamentoFreteIntegracao : EntidadeBase
    {
        [NHibernate.Mapping.Attributes.Id(0, Name = "Codigo", Type = "System.Int32", Column = "FFI_CODIGO")]
