...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_FECHAMENTO_FRETE_VEICULO_UTILIZADO", EntityName = "FechamentoFreteVeiculoUtilizado", Name = "Dominio.Entidades.Embarcador.Fechamento.FechamentoFreteVeiculoUtilizado", NameType = typeof(FechamentoFreteVeiculoUtilizado))]
    public class FechamentoFreteVeiculoUtilizado : EntidadeBase
    {
