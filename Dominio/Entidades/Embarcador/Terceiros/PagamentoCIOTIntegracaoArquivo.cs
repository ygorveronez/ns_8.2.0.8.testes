...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_PAGAMENTO_CIOT_INTEGRACAO_ARQUIVO", EntityName = "PagamentoCIOTIntegracaoArquivo", Name = "Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracaoArquivo", NameType = typeof(PagamentoCIOTIntegracaoArquivo))]
    public class PagamentoCIOTIntegracaoArquivo : Integracao.IntegracaoArquivo
    {
