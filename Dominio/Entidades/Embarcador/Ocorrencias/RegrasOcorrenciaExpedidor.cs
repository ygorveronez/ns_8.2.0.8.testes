...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_REGRA_OCORRENCIA_EXPEDIDOR", EntityName = "RegrasOcorrenciaExpedidor", Name = "Dominio.Entidades.Embarcador.Ocorrencias.RegrasOcorrenciaExpedidor", NameType = typeof(RegrasOcorrenciaExpedidor))]
    public class RegrasOcorrenciaExpedidor : EntidadeBase
    {
        ...
        [NHibernate.Mapping.Attributes.ManyToOne(0, Class = "Cliente", Column = "CLI_CODIGO_EXPEDIDOR", NotNull = true, Lazy = NHibernate.Mapping.Attributes.Laziness.Proxy)]
