...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_REGRA_OCORRENCIA_COMPONENTE_FRETE", EntityName = "RegrasOcorrenciaComponenteFrete", Name = "Dominio.Entidades.Embarcador.Ocorrencias.RegrasOcorrenciaComponenteFrete", NameType = typeof(RegrasOcorrenciaComponenteFrete))]
    public class RegrasOcorrenciaComponenteFrete : EntidadeBase
    {
        ...
        [NHibernate.Mapping.Attributes.Property(0, Name = "Condicao", Column = "RCF_CONDICAO", TypeType = typeof(ObjetosDeValor.Embarcador.Enumeradores.CondicaoAutorizaoOcorrencia), NotNull = true)]
        public virtual ObjetosDeValor.Embarcador.Enumeradores.CondicaoAutorizaoOcorrencia Condicao { get; set; }

        [NHibernate.Mapping.Attributes.Property(0, Name = "Juncao", Column = "RCF_JUNCAO", TypeType = typeof(ObjetosDeValor.Embarcador.Enumeradores.JuncaoAutorizaoOcorrencia), NotNull = true)]
