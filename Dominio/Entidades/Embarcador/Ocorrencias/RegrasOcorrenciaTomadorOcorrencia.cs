...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_REGRA_OCORRENCIA_TOMADOR_OCORRENCIA", EntityName = "RegrasOcorrenciaTomadorOcorrencia", Name = "Dominio.Entidades.Embarcador.Ocorrencias.RegrasOcorrenciaTomadorOcorrencia", NameType = typeof(RegrasOcorrenciaTomadorOcorrencia))]
    public class RegrasOcorrenciaTomadorOcorrencia : EntidadeBase
    {
