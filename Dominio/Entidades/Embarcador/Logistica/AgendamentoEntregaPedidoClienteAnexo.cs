...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_AGENDAMENTO_ENTREGA_PEDIDO_CLIENTE_ANEXOS", EntityName = "AgendamentoEntregaPedidoClienteAnexo", Name = "Dominio.Entidades.Embarcador.Logistica.AgendamentoEntregaPedidoClienteAnexo", NameType = typeof(AgendamentoEntregaPedidoClienteAnexo))]
    public class AgendamentoEntregaPedidoClienteAnexo : Anexo.Anexo<Pedidos.Pedido>
    {
        #region Propriedades
