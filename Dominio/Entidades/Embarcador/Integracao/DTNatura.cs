...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_INTEGRACAO_NATURA_DOCUMENTO_TRANSPORTE", EntityName = "DTNatura", Name = "Dominio.Entidades.Embarcador.Integracao.DTNatura", NameType = typeof(DTNatura))]
    public class DTNatura : EntidadeBase
    {
        ...
        [NHibernate.Mapping.Attributes.Set(0, Name = "Integracoes", Cascade = "none", Lazy = NHibernate.Mapping.Attributes.CollectionLazy.True, Table = "T_INTEGRACAO_NATURA_DOCUMENTO_TRANSPORTE_INTEGRACAO")]
        ...
        [NHibernate.Mapping.Attributes.Bag(0, Name = "Cargas", Cascade = "none", Lazy = NHibernate.Mapping.Attributes.CollectionLazy.True, Table = "T_CARGA_INTEGRACAO_NATURA")]
        [NHibernate.Mapping.Attributes.Key(1, Column = "IDT_CODIGO")]
        [NHibernate.Mapping.Attributes.ManyToMany(2, Class = "CargaIntegracaoNatura", Column = "CNA_CODIGO")]
        public virtual IList<Dominio.Entidades.Embarcador.Cargas.CargaIntegracaoNatura> Cargas { get; set; }

        [NHibernate.Mapping.Attributes.Bag(0, Name = "NotasFiscais", Cascade = "none", Lazy = NHibernate.Mapping.Attributes.CollectionLazy.True, Table = "T_INTEGRACAO_NATURA_DOCUMENTO_TRANSPORTE_NOTA_FISCAL")]
        [NHibernate.Mapping.Attributes.Key(1, Column = "IDT_CODIGO")]
        [NHibernate.Mapping.Attributes.ManyToMany(2, Class = "NotaFiscalDTNatura", Column = "INF_CODIGO")]
        public virtual IList<Dominio.Entidades.Embarcador.Integracao.NotaFiscalDTNatura> NotasFiscais { get; set; }
