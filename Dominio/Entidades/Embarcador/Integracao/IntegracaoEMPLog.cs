...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_INTEGRACAO_EMP_LOG", EntityName = "IntegracaoEMPLog", Name = "Dominio.Entidades.Embarcador.Integracao.IntegracaoEMPLog", NameType = typeof(IntegracaoEMPLog))]
    public class IntegracaoEMPLog : EntidadeBase
    {
        ...
        [NHibernate.Mapping.Attributes.Property(0, Name = "Fatura", Column = "IEM_FATURA", TypeType = typeof(string), Length = 2000, NotNull = false)]
        public virtual string Fatura { get; set; }

        [NHibernate.Mapping.Attributes.Property(0, Name = "Boleto", Column = "IEM_BOLETO", TypeType = typeof(string), Length = 2000, NotNull = false)]
