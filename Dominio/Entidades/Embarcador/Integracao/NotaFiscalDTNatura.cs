...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_INTEGRACAO_NATURA_DOCUMENTO_TRANSPORTE_NOTA_FISCAL", EntityName = "NotaFiscalDTNatura", Name = "Dominio.Entidades.Embarcador.Integracao.NotaFiscalDTNatura", NameType = typeof(NotaFiscalDTNatura))]
    public class NotaFiscalDTNatura : EntidadeBase
    {
