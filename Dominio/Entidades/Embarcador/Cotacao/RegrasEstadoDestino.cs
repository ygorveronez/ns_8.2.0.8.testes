...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_REGRA_COTACAO_ESTADO_DESTINO", EntityName = "RegrasEstadoDestino", Name = "Dominio.Entidades.Embarcador.Cotacao.RegrasEstadoDestino", NameType = typeof(RegrasEstadoDestino))]
    public class RegrasEstadoDestino : RegraAutorizacao.AlcadaSemPadronizacao
    {
        ...
        [NHibernate.Mapping.Attributes.Property(0, Name = "Ordem", Column = "RED_ORDEM", TypeType = typeof(int), NotNull = true)]
        public virtual int Ordem { get; set; }

        [NHibernate.Mapping.Attributes.Property(0, Name = "Condicao", Column = "RED_CONDICAO", TypeType = typeof(ObjetosDeValor.Embarcador.Enumeradores.CondicaoAutorizao), NotNull = true)]
        public virtual ObjetosDeValor.Embarcador.Enumeradores.CondicaoAutorizao Condicao { get; set; }

        [NHibernate.Mapping.Attributes.Property(0, Name = "Juncao", Column = "RED_JUNCAO", TypeType = typeof(ObjetosDeValor.Embarcador.Enumeradores.JuncaoAutorizao), NotNull = true)]
        ...
        {
            return IsCondicaoVerdadeiraEntidade(Estado.Sigla, valor, (ObjetosDeValor.Embarcador.Enumeradores.CondicaoAutorizao)Condicao);
        }
