...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_PROGRAMACAO_ALOCACAO", EntityName = "ProgramacaoAlocacao", Name = "Dominio.Entidades.Embarcador.Frota.Programacao.ProgramacaoAlocacao", NameType = typeof(ProgramacaoAlocacao))]
    public class ProgramacaoAlocacao : EntidadeBase
    {
        [NHibernate.Mapping.Attributes.Id(0, Name = "Codigo", Type = "System.Int32", Column = "PAL_CODIGO")]
        [NHibernate.Mapping.Attributes.Generator(1, Class = "native")]
        public virtual int Codigo { get; set; }

        [NHibernate.Mapping.Attributes.Property(0, Column = "PAL_DESCRICAO", TypeType = typeof(string), Length = 200, NotNull = false)]
        public virtual string Descricao { get; set; }

        [NHibernate.Mapping.Attributes.Property(0, Name = "TipoEntidadeProgramacao", Column = "PLI_TIPO", TypeType = typeof(ObjetosDeValor.Embarcador.Enumeradores.TipoEntidadeProgramacao), NotNull = false)]
