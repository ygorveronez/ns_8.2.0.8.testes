...
{
    [NHibernate.Mapping.Attributes.Class(0, DynamicUpdate = true, Table = "T_CONFIGURACAO_INTEGRACAO_VALORES_CTE_LOGGI", EntityName = "IntegracaoValoresCTeLoggi", Name = "Dominio.Entidades.Embarcador.Configuracoes.IntegracaoValoresCTeLoggi", NameType = typeof(IntegracaoValoresCTeLoggi))]
    public class IntegracaoValoresCTeLoggi : EntidadeBase
    {
