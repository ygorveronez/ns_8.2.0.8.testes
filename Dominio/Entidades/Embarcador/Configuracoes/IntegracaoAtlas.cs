...
{
    [NHibernate.Mapping.Attributes.Class(0, DynamicUpdate = true, Table = "T_CONFIGURACAO_INTEGRACAO_ATLAS", EntityName = "IntegracaoAtlas", Name = "Dominio.Entidades.Embarcador.Configuracoes.IntegracaoAtlas", NameType = typeof(IntegracaoAtlas))]
    public class IntegracaoAtlas : EntidadeBase
    {
        ...
        [NHibernate.Mapping.Attributes.Property(0, Name = "URLAcesso", Column = "CIA_URL_ACESSO", TypeType = typeof(string), Length = 250, NotNull = false)]
        public virtual string URLAcesso { get; set; }

        [NHibernate.Mapping.Attributes.Property(0, Column = "CIA_ATIVA", TypeType = typeof(bool), NotNull = false)]
        public virtual bool Ativa { get; set; }

        [NHibernate.Mapping.Attributes.Property(0, Name = "CodigoCliente", Column = "CIA_CODIGO_CLIENTE", TypeType = typeof(string), Length = 100, NotNull = false)] 
        ...
        */
        public virtual string Descricao
        {
            get
            {
                return "Configuração Integração Atlas";
            }
        }
    }
}
