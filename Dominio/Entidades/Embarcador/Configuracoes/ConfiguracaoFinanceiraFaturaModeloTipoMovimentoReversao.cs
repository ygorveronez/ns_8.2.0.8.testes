...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_CONFIGURACAO_FINANCEIRA_FATURA_MODELO_TIPO_MOVIMENTO_REVERSAO", EntityName = "ConfiguracaoFinanceiraFaturaModeloTipoMovimentoReversao", Name = "Dominio.Entidades.Embarcador.Configuracoes.ConfiguracaoFinanceiraFaturaModeloTipoMovimentoReversao", NameType = typeof(ConfiguracaoFinanceiraFaturaModeloTipoMovimentoReversao))]
    public class ConfiguracaoFinanceiraFaturaModeloTipoMovimentoReversao : EntidadeBase
    {
