...
{
    [NHibernate.Mapping.Attributes.Class(0, DynamicUpdate = true, Table = "T_CONFIGURACAO_INTEGRACAO_CTE_PAGAMENTO_LOGGI", EntityName = "IntegracaoCTePagamentoLoggi", Name = "Dominio.Entidades.Embarcador.Configuracoes.IntegracaoCTePagamentoLoggi", NameType = typeof(IntegracaoCTePagamentoLoggi))]
    public class IntegracaoCTePagamentoLoggi : EntidadeBase
    {
        ...
        [NHibernate.Mapping.Attributes.Property(0, Name = "IntegrarCTeSubstituto", Column = "CIL_INTEGRAR_CTE_SUBSTITUTO", TypeType = typeof(bool), NotNull = false)]
        public virtual bool IntegrarCTeSubstituto { get; set; }
