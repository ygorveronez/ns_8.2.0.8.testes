...
{
    [NHibernate.Mapping.Attributes.Class(0, DynamicUpdate = true, Table = "T_CONFIGURACAO_INTEGRACAO_SKYMARK", EntityName = "IntegracaoSkyMark", Name = "Dominio.Entidades.Embarcador.Configuracoes.IntegracaoRiskMark", NameType = typeof(IntegracaoSkyMark))]
    public class IntegracaoSkyMark : EntidadeBase
    {
