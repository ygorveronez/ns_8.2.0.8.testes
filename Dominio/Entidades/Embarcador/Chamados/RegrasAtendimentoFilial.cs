...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_REGRA_ATENDIMENTO_FILIAL", EntityName = "RegrasAtendimentoFilial", Name = "Dominio.Entidades.Embarcador.Chamados.RegrasAtendimentoFilial", NameType = typeof(RegrasAtendimentoFilial))]
    public class RegrasAtendimentoFilial : EntidadeBase
    {
