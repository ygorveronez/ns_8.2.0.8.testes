...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_REGRA_CHAMADO_FILIAL", EntityName = "RegrasChamadosFilial", Name = "Dominio.Entidades.Embarcador.Chamados.RegrasChamadosFilial", NameType = typeof(RegrasChamadosFilial))]
    public class RegrasChamadosFilial : EntidadeBase
    {
