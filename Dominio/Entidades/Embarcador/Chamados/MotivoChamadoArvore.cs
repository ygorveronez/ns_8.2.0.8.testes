...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_MOTIVO_CHAMADO_ARVORE", EntityName = "MotivoChamadoArvore", Name = "Dominio.Entidades.Embarcador.Chamados.MotivoChamadoArvore", NameType = typeof(MotivoChamadoArvore))]
    public class MotivoChamadoArvore : EntidadeBase
    {
