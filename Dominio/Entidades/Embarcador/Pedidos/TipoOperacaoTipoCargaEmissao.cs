...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_TIPO_OPERACAO_TIPO_CARGA_EMISSAO", EntityName = "TipoOperacaoTipoCargaEmissao", Name = "Dominio.Entidades.Embarcador.Pedidos.TipoOperacaoTipoCargaEmissao", NameType = typeof(TipoOperacaoTipoCargaEmissao))]
    public class TipoOperacaoTipoCargaEmissao: EntidadeBase
    {
        [NHibernate.Mapping.Attributes.Id(0, Name = "Codigo", Type = "System.Int32", Column = "TTE_CODIGO")]
