...
{
    [NHibernate.Mapping.Attributes.Class(0, DynamicUpdate = true, Table = "T_IMPORTACAO_PEDIDO", EntityName = "ImportacaoPedido", Name = "Dominio.Entidades.Embarcador.Pedidos.ImportacaoPedido", NameType = typeof(ImportacaoPedido))]
    public class ImportacaoPedido : EntidadeBase, Interfaces.Embarcador.Entidade.IEntidade
    {
        ...
        [NHibernate.Mapping.Attributes.Property(0, Name = "Situacao", Column = "IMP_SITUACAO", TypeType = typeof(ObjetosDeValor.Embarcador.Enumeradores.SituacaoImportacaoPedido), NotNull = true)]
        ...
        [NHibernate.Mapping.Attributes.Property(0, Name = "TotalSegundosProcessamento", Column = "IMP_TOTAL_SEGUNDOS_PROCESSAMENTO", TypeType = typeof(int), NotNull = false)]
