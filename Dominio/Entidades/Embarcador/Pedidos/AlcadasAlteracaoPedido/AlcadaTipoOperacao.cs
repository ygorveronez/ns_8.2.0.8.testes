...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_ALCADA_ALTERACAO_PEDIDO_TIPO_OPERACAO", EntityName = "AlcadasAlteracaoPedido.AlcadaTipoOperacao", Name = "Dominio.Entidades.Embarcador.Pedidos.AlcadasAlteracaoPedido.AlcadaTipoOperacao", NameType = typeof(AlcadaTipoOperacao))]
    public class AlcadaTipoOperacao : RegraAutorizacao.Alcada<RegraAutorizacaoAlteracaoPedido, TipoOperacao>
    {
        ...
        public override TipoOperacao PropriedadeAlcada { get; set; }
