...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_REGRA_PEDIDO_MODELO_VEICULAR", EntityName = "RegrasPedidoModeloVeicular", Name = "Dominio.Entidades.Embarcador.Pedidos.RegrasPedidoModeloVeicular", NameType = typeof(RegrasPedidoModeloVeicular))]
    public class RegrasPedidoModeloVeicular : EntidadeBase
    {
        ...
        [NHibernate.Mapping.Attributes.Property(0, Name = "Ordem", Column = "RMV_ORDEM", TypeType = typeof(int), NotNull = false)]
        public virtual int Ordem { get; set; }

        [NHibernate.Mapping.Attributes.Property(0, Name = "Condicao", Column = "RMV_CONDICAO", TypeType = typeof(ObjetosDeValor.Embarcador.Enumeradores.CondicaoAutorizaoOcorrencia), NotNull = false)]
        public virtual ObjetosDeValor.Embarcador.Enumeradores.CondicaoAutorizaoOcorrencia Condicao { get; set; }

        [NHibernate.Mapping.Attributes.Property(0, Name = "Juncao", Column = "RMV_JUNCAO", TypeType = typeof(ObjetosDeValor.Embarcador.Enumeradores.JuncaoAutorizaoOcorrencia), NotNull = false)]
