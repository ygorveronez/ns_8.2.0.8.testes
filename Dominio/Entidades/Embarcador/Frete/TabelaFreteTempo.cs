...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_TABELA_FRETE_TEMPO", EntityName = "TabelaFreteTempo", Name = "Dominio.Entidades.Embarcador.Frete.TabelaFreteTempo", NameType = typeof(TabelaFreteTempo))]
    public class TabelaFreteTempo : EntidadeBase
    {
