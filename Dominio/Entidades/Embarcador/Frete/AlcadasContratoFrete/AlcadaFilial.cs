...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_ALCADA_FILIAL", EntityName = "Frete.AlcadaFilial", Name = "Dominio.Entidades.Embarcador.WMS.AlcadaFilial", NameType = typeof(AlcadaFilial))]
