...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_ALCADA_TABELA_FRETE_TRANSPORTADOR", EntityName = "AlcadasTabelaFrete.AlcadaTransportador", Name = "Dominio.Entidades.Embarcador.Frete.AlcadasTabelaFrete.AlcadaTransportador", NameType = typeof(AlcadaTransportador))]
    public class AlcadaTransportador : RegraAutorizacao.Alcada<RegraAutorizacaoTabelaFrete, Empresa>
    {
