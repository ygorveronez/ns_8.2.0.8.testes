...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_ALCADA_TABELA_FRETE_FILIAL", EntityName = "AlcadasTabelaFrete.AlcadaFilial", Name = "Dominio.Entidades.Embarcador.Frete.AlcadasTabelaFrete.AlcadaFilial", NameType = typeof(AlcadaFilial))]
    public class AlcadaFilial : RegraAutorizacao.Alcada<RegraAutorizacaoTabelaFrete, Filiais.Filial>
    {
