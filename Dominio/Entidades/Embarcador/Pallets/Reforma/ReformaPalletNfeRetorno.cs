...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_PALLET_REFORMA_NFE_RETORNO", EntityName = "ReformaPalletNfeRetorno", Name = "Dominio.Entidades.Embarcador.Pallets.Reforma.ReformaPalletNfeRetorno", NameType = typeof(ReformaPalletNfeRetorno))]
    public class ReformaPalletNfeRetorno : EntidadeBase
    {
        [NHibernate.Mapping.Attributes.Id(0, Name = "Codigo", Type = "System.Int32", Column = "PNR_CODIGO")]
        ...
        public virtual bool Equals(ReformaPalletNfeRetorno other)
        {
