...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_NFS_MANUAL_CANCELAMENTO_INTEGRACAO_LOTE", EntityName = "NFSManualCancelamentoIntegracaoLote", Name = "Dominio.Entidades.Embarcador.NFS.NFSManualCancelamentoIntegracaoLote", NameType = typeof(NFSManualCancelamentoIntegracaoLote))]
    public class NFSManualCancelamentoIntegracaoLote: EntidadeBase
    {
        ...
        [NHibernate.Mapping.Attributes.Bag(0, Name = "CTes", Cascade = "none", Lazy = NHibernate.Mapping.Attributes.CollectionLazy.True, Table = "T_NFS_MANUAL_CANCELAMENTO_INTEGRACAO_CTE")]
        [NHibernate.Mapping.Attributes.Key(1, Column = "NIL_CODIGO")]
        [NHibernate.Mapping.Attributes.ManyToMany(2, Class = "NFSManualCancelamentoIntegracaoCTe", Column = "CCI_CODIGO")]
        public virtual ICollection<NFSManualCancelamentoIntegracaoCTe> CTes { get; set; }
