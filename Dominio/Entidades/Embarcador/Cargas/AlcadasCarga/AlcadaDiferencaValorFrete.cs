...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_ALCADA_CARGA_DIFERENCA_VALOR_FRETE", EntityName = "AlcadasCarga.AlcadaDiferencaValorFrete", Name = "Dominio.Entidades.Embarcador.Cargas.AlcadasCarga.AlcadaDiferencaValorFrete", NameType = typeof(AlcadaDiferencaValorFrete))]
    public class AlcadaDiferencaValorFrete : RegraAutorizacao.Alcada<RegraAutorizacaoCarga, decimal>
    {
