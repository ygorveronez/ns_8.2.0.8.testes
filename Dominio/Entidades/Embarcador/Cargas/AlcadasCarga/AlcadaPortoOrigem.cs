...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_ALCADA_CARGA_PORTO_ORIGEM", EntityName = "AlcadasCarga.AlcadaPortoOrigem", Name = "Dominio.Entidades.Embarcador.Cargas.AlcadasCarga.AlcadaPortoOrigem", NameType = typeof(AlcadaPortoOrigem))]
    public class AlcadaPortoOrigem : RegraAutorizacao.Alcada<RegraAutorizacaoCarga, Pedidos.Porto>
    {
