...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_ALCADA_CARGA_PERCENTUAL_FRETE_SOBRE_NOTA", EntityName = "AlcadasCarga.AlcadaPercentualFreteSobreNota", Name = "Dominio.Entidades.Embarcador.Cargas.AlcadasCarga.AlcadaPercentualFreteSobreNota", NameType = typeof(AlcadaPercentualFreteSobreNota))]
    public class AlcadaPercentualFreteSobreNota : RegraAutorizacao.Alcada<RegraAutorizacaoCarga, decimal>
    {
