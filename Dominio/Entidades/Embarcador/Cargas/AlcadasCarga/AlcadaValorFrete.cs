...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_ALCADA_CARGA_VALOR_FRETE", EntityName = "AlcadasCarga.AlcadaValorFrete", Name = "Dominio.Entidades.Embarcador.Cargas.AlcadasCarga.AlcadaValorFrete", NameType = typeof(AlcadaValorFrete))]
    public class AlcadaValorFrete : RegraAutorizacao.Alcada<RegraAutorizacaoCarga, decimal>
    {
