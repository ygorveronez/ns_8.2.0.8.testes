...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_ALCADA_CARREGAMENTO_PERCENTUAL_OCUPACAO_PESO", EntityName = "AlcadasMontagemCarga.AlcadaPercentualOcupacaoPeso", Name = "Dominio.Entidades.Embarcador.Cargas.AlcadasMontagemCarga.AlcadaPercentualOcupacaoPeso", NameType = typeof(AlcadaPercentualOcupacaoPeso))]
    public class AlcadaPercentualOcupacaoPeso : RegraAutorizacao.Alcada<RegraAutorizacaoCarregamento, decimal>
    {
