...
{
    [NHibernate.Mapping.Attributes.Class(0, DynamicUpdate = true, Table = "T_CARGA_ENTREGA_PRODUTO", EntityName = "CargaEntregaProduto", Name = "Dominio.Entidades.Embarcador.Cargas.ControleEntrega.CargaEntregaProduto", NameType = typeof(CargaEntregaProduto))]
    public class CargaEntregaProduto : EntidadeBase
    {
