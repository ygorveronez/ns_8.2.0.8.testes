...
{
    [NHibernate.Mapping.Attributes.Class(0, DynamicUpdate = true, Table = "T_CARGA_ENTREGA_ASSINATURA_RESPONSAVEL", EntityName = "CargaEntregaAssinaturaResponsavel", Name = "Dominio.Entidades.Embarcador.Cargas.ControleEntrega.CargaEntregaAssinaturaResponsavel", NameType = typeof(CargaEntregaAssinaturaResponsavel))]
    public class CargaEntregaAssinaturaResponsavel : EntidadeBase
    {
        ...
        public virtual string Descricao => "Assinatura  - " + Codigo.ToString();
