...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_ALCADA_CARGA_CANCELAMENTO_TIPO_OPERACAO", EntityName = "AlcadasCargaCancelamento.AlcadaTipoOperacao", Name = "Dominio.Entidades.Embarcador.Cargas.AlcadasCargaCancelamento.AlcadaTipoOperacao", NameType = typeof(AlcadaTipoOperacao))]
    public class AlcadaTipoOperacao : RegraAutorizacao.Alcada<RegraAutorizacaoCargaCancelamento, Pedidos.TipoOperacao>
    {
