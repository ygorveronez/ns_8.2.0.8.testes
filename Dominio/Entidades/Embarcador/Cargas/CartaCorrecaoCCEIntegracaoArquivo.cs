...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_CARTA_CORRECAO_CCE_INTEGRACAO_ARQUIVO", EntityName = "CartaCorrecaoCCEIntegracaoArquivo", Name = "Dominio.Entidades.Embarcador.Cargas.CartaCorrecaoCCEIntegracaoArquivo", NameType = typeof(CartaCorrecaoCCEIntegracaoArquivo))]
    public class CartaCorrecaoCCEIntegracaoArquivo : Integracao.IntegracaoArquivo
    {
