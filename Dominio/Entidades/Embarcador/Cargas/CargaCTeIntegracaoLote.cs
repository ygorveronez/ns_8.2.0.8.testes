...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_CARGA_CTE_INTEGRACAO_LOTE", EntityName = "CargaCTeIntegracaoLote", Name = "Dominio.Entidades.Embarcador.Cargas.CargaCTeIntegracaoLote", NameType = typeof(CargaCTeIntegracaoLote))]
    public class CargaCTeIntegracaoLote : EntidadeBase
    {
        ...
        [NHibernate.Mapping.Attributes.Property(0, Name = "ProblemaIntegracao", Column = "CCL_PROBLEMA_INTEGRACAO", Type = "StringClob", NotNull = false)]
        ...
        public virtual ICollection<CargaCTeIntegracao> CTes { get; set; }
