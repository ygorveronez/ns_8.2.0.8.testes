...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_REGRA_COTACAO_PEDIDO_TIPO_CARGA", EntityName = "RegrasCotacaoPedidoTipoCarga", Name = "Dominio.Entidades.Embarcador.CotacaoPedido.RegrasCotacaoPedidoTipoCarga", NameType = typeof(RegrasCotacaoPedidoTipoCarga))]
    public class RegrasCotacaoPedidoTipoCarga : EntidadeBase
    {
        ...
        [NHibernate.Mapping.Attributes.Property(0, Name = "Ordem", Column = "RCT_ORDEM", TypeType = typeof(int), NotNull = false)]
        public virtual int Ordem { get; set; }

        [NHibernate.Mapping.Attributes.Property(0, Name = "Condicao", Column = "RCT_CONDICAO", TypeType = typeof(ObjetosDeValor.Embarcador.Enumeradores.CondicaoAutorizaoOcorrencia), NotNull = false)]
        public virtual ObjetosDeValor.Embarcador.Enumeradores.CondicaoAutorizaoOcorrencia Condicao { get; set; }

        [NHibernate.Mapping.Attributes.Property(0, Name = "Juncao", Column = "RCT_JUNCAO", TypeType = typeof(ObjetosDeValor.Embarcador.Enumeradores.JuncaoAutorizaoOcorrencia), NotNull = false)]
