...
{
    [NHibernate.Mapping.Attributes.Class(0, Table = "T_HISTORICO_PROPRIEDADE", EntityName = "HistoricoPropriedade", Name = "Dominio.Entidades.Auditoria.HistoricoPropriedade", NameType = typeof(HistoricoPropriedade))]
    public class HistoricoPropriedade : EntidadeBase
    {
        ...
        [NHibernate.Mapping.Attributes.ManyToOne(0, Class = "HistoricoObjeto", Column = "HIO_CODIGO_PAI", NotNull = false, Lazy = Laziness.Proxy)]
