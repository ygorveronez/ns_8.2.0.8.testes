...
namespace Dominio.Relatorios.Embarcador.DataSource.Documentos
{
    public class CargaCIOT
    {
        ...
        public string DescricaoRegimeTributario
        {
            get { return Dominio.ObjetosDeValor.Embarcador.Enumeradores.RegimeTributarioHelper.ObterDescricao(this.RegimeTributario); }
        }
    }
}
