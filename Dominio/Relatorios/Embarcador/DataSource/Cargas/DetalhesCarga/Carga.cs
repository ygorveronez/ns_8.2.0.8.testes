...
namespace Dominio.Relatorios.Embarcador.DataSource.Cargas.DetalhesCarga
{
    public class Carga
    {
		...
		public bool AgruparPorDestinatario { get; set; }
        public string TipoOperacao { get; set; }
        public byte[] CodigoDeBarrasNumeroCarga { get; set; }
        public string LicencasVeiculos { get; set; }

        public bool ExibirLicencasDestinatario { get; set; }
    }
}
