...
{
    public class ConfiguracaoSubcontratacaoTabelaFreteClienteTerceiro
    {
        ...
        public decimal PercentualCobrancaPadrao { get; set; }
        public decimal ValorFixoSubcontratacaoParcial { get; set; }
