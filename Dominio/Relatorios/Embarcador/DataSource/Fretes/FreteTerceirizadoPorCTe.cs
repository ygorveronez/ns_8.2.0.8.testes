...
{
    public class FreteTerceirizadoPorCTe
    {
        #region Propriedades
        ...
        public int NumeroCTes { get; set; }
        public int QuantiaCTes { get; set; }
        ...
        public decimal ValorPagoPorCTeFormatado
        {
            get
            {
                decimal retorno = 0;

                if (this.QuantiaCTes != 0)
                {
                    { retorno = (this.ValorPago / this.QuantiaCTes); }
                }
