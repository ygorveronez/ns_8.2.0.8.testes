(function (d) {
    d.fn.priceFormat = function (a) {
        a = d.extend({ prefix: "R$ ", suffix: "", centsSeparator: ",", thousandsSeparator: ".", limit: !1, centsLimit: 2, clearPrefix: !1, clearSufix: !1, allowNegative: !1 }, a); return this.each(function () {
            function g(k) {
