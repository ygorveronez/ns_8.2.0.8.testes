<%@ Page Title="Usuários da Empresa" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="UsuariosEmpresa.aspx.cs" Inherits="EmissaoCTe.InternalWebAdmin.UsuariosEmpresa" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        $(document).ready(function () {
            ...
            CarregarConsultaDeUsuarios("default-search", "default-search", GetUrlParam("x"), 1, Editar, true, false);
                    ...
                    <div class="fields" style="margin-top: 15px;">
                        ...
                        <div class="fieldzao">
                            ...
                            <div class="field fielddois">
                                ...
                                <div class="input">
                                    <input type="text" id="txtTelefone" class="maskedInput" />
                                </div>
                            </div>
                        </div>
                        <div class="fieldzao">
