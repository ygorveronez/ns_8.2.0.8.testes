<%@ Page Title="Relatório de CT-es Emitidos" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="RelatorioCTesEmitidos.aspx.cs" Inherits="EmissaoCTe.InternalWebAdmin.RelatorioCTesEmitidos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script defer="defer" type="text/javascript">
        $(document).ready(function () {
            ...
            CarregarConsultaDeEmpresasGerenciadoras("btnBuscarEmpresa", "btnBuscarEmpresa", "A", RetornoConsultaEmpresa, true, false);
        });
