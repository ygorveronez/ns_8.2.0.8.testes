...
[UseReportType(ReportType.ComprovanteCargaInformada)]
public class ComprovanteCargaInformadaReport : ReportBase
{
    public ComprovanteCargaInformadaReport(UnitOfWork unitOfWork, RelatorioReportService servicoRelatorioReportService,
    ...
    public override ReportResult InternalProcess(Dictionary<string, string> extraData)
    {
        ...
        if (lojas.Count >= 2)
        {
            Dominio.Entidades.Cliente loja = lojas[1];

            if (loja != null)
            {
                dataSetComprovanteCargaInformada.LojaDoisCodigoSendas = loja.CodigoCompanhia;
                dataSetComprovanteCargaInformada.LojaDoisNumero = loja.CodigoIntegracao;
                ...
                if (clienteDescarga != null)
                {
                    dataSetComprovanteCargaInformada.LojaDoisHoraInicioDescarga = clienteDescarga.HoraInicioDescarga;
                    dataSetComprovanteCargaInformada.LojaDoisHoraLimiteDescarga = clienteDescarga.HoraLimiteDescarga;
                }
            }
        }
        ...
        if (lojas.Count >= 3)
        {
            Dominio.Entidades.Cliente loja = lojas[2];

            if (loja != null)
            {
                dataSetComprovanteCargaInformada.LojaTresCodigoSendas = loja.CodigoCompanhia;
                dataSetComprovanteCargaInformada.LojaTresNumero = loja.CodigoIntegracao;
                ...
                if (clienteDescarga != null)
                {
                    dataSetComprovanteCargaInformada.LojaTresHoraInicioDescarga = clienteDescarga.HoraInicioDescarga;
                    dataSetComprovanteCargaInformada.LojaTresHoraLimiteDescarga = clienteDescarga.HoraLimiteDescarga;
                }
            }
        }
        ...
        if (lojas.Count >= 4)
        {
            Dominio.Entidades.Cliente loja = lojas[3];

            if (loja != null)
            {
                dataSetComprovanteCargaInformada.LojaQuatroCodigoSendas = loja.CodigoCompanhia;
                dataSetComprovanteCargaInformada.LojaQuatroNumero = loja.CodigoIntegracao;
                ...
                if (clienteDescarga != null)
                {
                    dataSetComprovanteCargaInformada.LojaQuatroHoraInicioDescarga = clienteDescarga.HoraInicioDescarga;
                    dataSetComprovanteCargaInformada.LojaQuatroHoraLimiteDescarga = clienteDescarga.HoraLimiteDescarga;
                }
            }
        }
        ...
        byte[] pdfContent = RelatorioSemPadraoReportService.GerarRelatorio(
            @"Areas\Relatorios\Reports\Default\GestaoPatio\ComprovanteCargaInformada.rpt",
