...
[UseReportType(ReportType.FaturaImpressaoParcelasSeparadas)]
public class FaturaImpressaoParcelasSeparadasReport : ReportBase
{
    public FaturaImpressaoParcelasSeparadasReport(UnitOfWork unitOfWork,
    ...
    public override ReportResult InternalProcess(Dictionary<string, string> extraData)
    {
        ...
        IList<Dominio.Relatorios.Embarcador.DataSource.Fatura.RelatorioPadraoFaturaDados>
            listaRelatorioPadraoFaturaDados = repositorioFatura.BuscarRelatorioPadraoDados(fatura);
        ...
        CrystalDecisions.CrystalReports.Engine.ReportDocument relatorio = _servicoRelatorioReportService.CriarRelatorio(
            relatorioControleGeracao, relatorioTemporario, listaRelatorioPadraoFaturaDados, _unitOfWork,
            identificacaoCampos,
            new List<KeyValuePair<string, dynamic>>()
            {
                new KeyValuePair<string, dynamic>("Documentos", listaRelatorioPadraoFatura)
            }, false
        );
