...
namespace SGT.Italac
{
    ...
    {
        public readonly ItalacService _italacService;
        public readonly ILogger _logger;
        public readonly IConfiguration _configuration;

        public WindowsBackgroundServiceBase(ItalacService italacService, ILogger<WindowsBackgroundService> logger, IConfiguration configuration)
        {
            _italacService = italacService;
            _logger = logger;
