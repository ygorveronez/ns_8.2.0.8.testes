...
{
    public class ImportacaoTakePay : LongRunningProcessBase<ImportacaoTakePay>
    {
        #region Métodos protegidos

        protected override async Task ExecuteInternalAsync(Repositorio.UnitOfWork unitOfWork, AdminMultisoftware.Repositorio.UnitOfWork unitOfWorkAdmin, CancellationToken cancellationToken)
        {
            LocalizarProcessarImportacaoTakePayPendente(unitOfWork);
        ...
        private void LocalizarProcessarImportacaoTakePayPendente(Repositorio.UnitOfWork unitOfWork)
        {
            ...
            Dominio.Entidades.Embarcador.Pedidos.ImportacaoTakePay.ImportacaoTakePay importacaoPedidoPendente = repImportacaoTakePay.BuscarProximaImportacaoPendente();
            if (importacaoPedidoPendente != null)
            {

                // Registra o início do processamento da planilha, de "Pendente" para "Processando"
                IndicarInicioDoProcessamento(unitOfWork, repImportacaoTakePay, importacaoPedidoPendente);

                // Processa a planilha importada
                ProcessarImportacaoTakePay(unitOfWork, repImportacaoTakePay, importacaoPedidoPendente);
        ...
        public void ProcessarImportacaoTakePay(Repositorio.UnitOfWork unitOfWork, Repositorio.Embarcador.Pedidos.ImportacaoTakePay.ImportacaoTakePay repImportacaoTakePay, Dominio.Entidades.Embarcador.Pedidos.ImportacaoTakePay.ImportacaoTakePay importacaoPedidoPendente)
        {
            try
            {
                // Importa a planilha gerando pedidos e cargas
                Servicos.Embarcador.Pedido.ImportacaoTakePay serPedido = new Servicos.Embarcador.Pedido.ImportacaoTakePay();
                ...
                IndicarFimDoProcessamento(unitOfWork, repImportacaoTakePay, importacaoPedidoPendente, situacao, mensagem);
            ...
            catch (Exception ex)
            {
                ...
                unitOfWork.Start();
                IndicarFimDoProcessamento(unitOfWork, repImportacaoTakePay, importacaoPedidoPendente, Dominio.ObjetosDeValor.Embarcador.Enumeradores.SituacaoImportacaoPedido.Erro, ex.Message);
        ...
        private void IndicarInicioDoProcessamento(Repositorio.UnitOfWork unitOfWork, Repositorio.Embarcador.Pedidos.ImportacaoTakePay.ImportacaoTakePay repImportacaoTakePay, Dominio.Entidades.Embarcador.Pedidos.ImportacaoTakePay.ImportacaoTakePay importacaoPedidoPendente)
        {
            // Registra o início do processamento da planilha, de "Pendente" para "Processando"
            unitOfWork.Start();
            try
            {
                ...
                repImportacaoTakePay.Atualizar(importacaoPedidoPendente);
                unitOfWork.CommitChanges();
            }
            catch (Exception ex)
            {
