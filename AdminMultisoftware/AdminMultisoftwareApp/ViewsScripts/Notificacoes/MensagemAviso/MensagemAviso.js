...
function adicionarAnexoAvisoClick() {
    ...
    if (file.size > maxSize) {
        return exibirMensagem(tipoMensagem.atencao, "Anexos", "O arquivo selecionado excede o limite de 5MB.");
    }
...
function CarregarOpcoesTipoServicoMultisoftware() {
        _opcoesTipoServicoMultisoftware = [
            { text: "Todos", value: EnumTipoServicoMultisoftware.Todos },
        ...
        _mensagemAviso.TipoServicoMultisoftware.def = EnumTipoServicoMultisoftware.Todos;
        _mensagemAviso.TipoServicoMultisoftware.val(EnumTipoServicoMultisoftware.Todos);
