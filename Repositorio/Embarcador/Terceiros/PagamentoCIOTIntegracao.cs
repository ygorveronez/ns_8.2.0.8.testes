...
{
    public class PagamentoCIOTIntegracao : RepositorioBase<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao>
    {
        public PagamentoCIOTIntegracao(UnitOfWork unitOfWork) : base(unitOfWork) { }

        public Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao BuscarPorCodigo(int codigo)
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao>();
        ...
        public Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao BuscarPorCodigoArquivo(int codigoArquivo)
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao>();
        ...
        public List<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao> BuscarPorCarga(int codigoCarga)
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao>();
        ...
        public List<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao> BuscarPorContratoFrete(int codigoContratoFrete)
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao>();
        ...
        public List<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao> BuscarPorAutorizacaoPagamento(int codigoAutorizacaoPagamento)
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao>();
        ...
        public int ContarPorAutorizacaoPagamentoSituacaoIntegracao(int codigoAutorizacaoPagamento, List<SituacaoIntegracao> situacaoIntegracao)
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao>();

            var result = from obj in query where obj.AutorizacaoPagamentoContratoFrete.Codigo == codigoAutorizacaoPagamento && situacaoIntegracao.Contains(obj.SituacaoIntegracao) select obj;

            return result.ToList().Count();
        }

        public List<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao> BuscarPorCarga(int codigoCarga, Dominio.ObjetosDeValor.Embarcador.Enumeradores.SituacaoIntegracao? situacao, Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoIntegracao? tipo)
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao>();
        ...
        public List<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao> BuscarPagamentoContratoFreteIntegracaoPendente(int tentativasLimite, double tempoProximaTentativaMinutos, string propOrdenacao, string dirOrdenacao, int maximoRegistros, Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoEnvioIntegracao tipoEnvio)
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao>();
        ...
        public List<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao> BuscarIntegracoesPendentes(int numeroTentativas, double minutosACadaTentativa, string propOrdenacao, string dirOrdenacao, int numeroRegistrosPorVez)
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao>();
        ...
        public List<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao> Consultar(int codigoContratoFrete, SituacaoIntegracao? situacao, Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoIntegracao? tipo, string propOrdena, string dirOrdena, int inicio, int limite)
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao>();
        ...
        public List<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao> ConsultarPorAutorizacaoPagamento(int codigoAutorizacaoPagamento, SituacaoIntegracao? situacao, Dominio.ObjetosDeValor.Embarcador.Enumeradores.TipoIntegracao? tipo, string propOrdena, string dirOrdena, int inicio, int limite)
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Terceiros.PagamentoCIOTIntegracao>();
