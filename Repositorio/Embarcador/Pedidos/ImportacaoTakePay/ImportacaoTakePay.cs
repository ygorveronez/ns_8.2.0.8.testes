...
{
    public class ImportacaoTakePay : RepositorioBase<Dominio.Entidades.Embarcador.Pedidos.ImportacaoTakePay.ImportacaoTakePay>
    {
        #region Construtores

        public ImportacaoTakePay(UnitOfWork unitOfWork) : base(unitOfWork) { }

        #endregion

        #region Métodos Privados

        private IQueryable<Dominio.Entidades.Embarcador.Pedidos.ImportacaoTakePay.ImportacaoTakePay> Consultar(Dominio.ObjetosDeValor.Embarcador.Pedido.FiltroPesquisaImportacaoTakePay filtrosPesquisa)
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Pedidos.ImportacaoTakePay.ImportacaoTakePay>();
        ...
        public Dominio.Entidades.Embarcador.Pedidos.ImportacaoTakePay.ImportacaoTakePay BuscarPorCodigo(int codigo)
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Pedidos.ImportacaoTakePay.ImportacaoTakePay>();
        ...
        public Dominio.Entidades.Embarcador.Pedidos.ImportacaoTakePay.ImportacaoTakePay BuscarProximaImportacaoPendente()
        {
            var query = this.SessionNHiBernate.Query<Dominio.Entidades.Embarcador.Pedidos.ImportacaoTakePay.ImportacaoTakePay>();
        ...
        public List<Dominio.Entidades.Embarcador.Pedidos.ImportacaoTakePay.ImportacaoTakePay> Consultar(Dominio.ObjetosDeValor.Embarcador.Pedido.FiltroPesquisaImportacaoTakePay filtrosPesquisa, Dominio.ObjetosDeValor.Embarcador.Consulta.ParametroConsulta parametrosConsulta)
        {
        ...
        public int ContarConsulta(Dominio.ObjetosDeValor.Embarcador.Pedido.FiltroPesquisaImportacaoTakePay filtrosPesquisa)
        {
            var query = Consultar(filtrosPesquisa);
