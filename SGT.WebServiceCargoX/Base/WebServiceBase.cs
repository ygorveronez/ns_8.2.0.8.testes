...
namespace SGT.WebServiceCargoX
{
    public abstract class WebServiceBase
    {
        ...
        {
            StreamWriter outfile = new StreamWriter(ObterCaminhoArquivoLog());
        ...
        {
            return Path.Combine(ConfigurationManager.AppSettings["CaminhoTempArquivosImportacao"], Guid.NewGuid() + "_integracaoPedidos.txt");
        }
