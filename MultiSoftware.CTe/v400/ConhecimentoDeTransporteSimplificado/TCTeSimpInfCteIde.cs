namespace MultiSoftware.CTe.v400.ConhecimentoDeTransporteSimplificado
{
    ...
    public partial class TCTeSimpInfCteIde
    {
        ...
        private TCTeSimpInfCteIdeTpImp tpImpField;

        private TCTeSimpInfCteIdeTpEmis tpEmisField;

        private string cDVField;

        private TAmb tpAmbField;

        private TFinCTeSimp tpCTeField;
        ...
        private TModTranspSimp modalField;

        private TCTeSimpInfCteIdeTpServ tpServField;

        private TUf uFIniField;

        private TUf uFFimField;

        private TCTeSimpInfCteIdeRetira retiraField;
        ...
        /// <remarks/>
        public TCTeSimpInfCteIdeTpImp tpImp
        {
            get
            {
        ...
        /// <remarks/>
        public TCTeSimpInfCteIdeTpEmis tpEmis
        {
            get
            {
        ...
        /// <remarks/>
        public TCTeSimpInfCteIdeTpServ tpServ
        {
            get
            {
        ...
        /// <remarks/>
        public TCTeSimpInfCteIdeRetira retira
        {
            get
            {
