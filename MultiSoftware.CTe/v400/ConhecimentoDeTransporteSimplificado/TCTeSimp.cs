namespace MultiSoftware.CTe.v400.ConhecimentoDeTransporteSimplificado
{
    ...
    public partial class TCTeSimp
    {

        private TCTeSimpInfCte infCteField;

        private TCTeSimpInfCTeSupl infCTeSuplField;

        private Assinaturas.SignatureType signatureField;

        /// <remarks/>
        public TCTeSimpInfCte infCte
        {
            get
            {
        ...
        /// <remarks/>
        public TCTeSimpInfCTeSupl infCTeSupl
        {
            get
            {
