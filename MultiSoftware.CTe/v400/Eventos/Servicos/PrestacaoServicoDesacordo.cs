...
namespace MultiSoftware.CTe.v400.Eventos.PrestacaoServicoDesacordo.Servicos
{
    public class PrestacaoServicoDesacordo
    {
        public static MultiSoftware.CTe.v400.Eventos.Desacordo.TRetEvento EnviarDesacordoPrestacaoServico(string cnpj, MultiSoftware.CTe.v400.Eventos.TCOrgaoIBGE uf, MultiSoftware.CTe.v400.Eventos.TAmb tpAmb, string chaveCTe, DateTime dataEmissao, long idLote, string justificativa, string caminhoCertificado, string senhaCertificado, string urlSefaz, ref string xmlEvento, CTeRecepcaoEventoV4.CTeRecepcaoEventoV4Soap12Client parametroCTeRecepcaoEvento)
        {
            ...
            using (CTeRecepcaoEventoV4.CTeRecepcaoEventoV4Soap12Client svcRecepcaoEvento = parametroCTeRecepcaoEvento)
            {
                ...
                XmlNode dadosRetorno = svcRecepcaoEvento.cteRecepcaoEvento(doc.DocumentElement);
