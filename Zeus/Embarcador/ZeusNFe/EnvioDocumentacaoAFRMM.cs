...
namespace Zeus.Embarcador.ZeusNFe
{
    ...
    {
        public EnvioDocumentacaoAFRMM(string stringConexao) : base(stringConexao) { }
        ...
        public static void ProcessarEnvioAutomaticoDocumentacao(Repositorio.UnitOfWork unidadeTrabalho, string stringConexao, AdminMultisoftware.Dominio.Enumeradores.TipoServicoMultisoftware tipoServicoMultisoftware, string adminStringConexao, string host)
        {
            ...
            List<Dominio.ObjetosDeValor.Embarcador.Documentos.EnvioAutomaticoDocumentacaoAFRMM> documentacaoPendente = repCarga.BuscarDocumentacaoAutomaticaPendente(configuracaoDocumentacao.QuantidadeDiasAposDescarga);
            for (int i = 0; i < documentacaoPendente.Count; i++)
            {
                ...
                List<Dominio.ObjetosDeValor.Embarcador.Documentos.EnvioAutomaticoDocumentacaoAFRMCTe> conhecimentos = repCarga.BuscarDocumentacaoAutomaticaPendente(configuracaoDocumentacao.QuantidadeDiasAposDescarga, documentacaoPendente[i].CodigoViagem, documentacaoPendente[i].CodigoPortoDestino, documentacaoPendente[i].CodigoPortoOrigem);
            ...
            List<Dominio.ObjetosDeValor.Embarcador.Documentos.EnvioAutomaticoDocumentacaoAFRMM> documentacaoTransbordoPendente = repCarga.BuscarDocumentacaoTransbordoAutomaticaPendente(configuracaoDocumentacao.QuantidadeDiasAposDescarga, 5);
