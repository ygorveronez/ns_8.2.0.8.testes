...
namespace Servicos.Embarcador.Documentos
{
    ...
    {
        public EnvioDocumentacaoLote(string stringConexao) : base(stringConexao) { }
        ...
        private static bool ProcessarEnvioAutomaticoDocumentacao(Repositorio.UnitOfWork unidadeTrabalho, string stringConexao, AdminMultisoftware.Dominio.Enumeradores.TipoServicoMultisoftware tipoServicoMultisoftware, string adminStringConexao, string host)
        {
            ...
            List<Dominio.ObjetosDeValor.Embarcador.Documentos.EnvioAutomaticoDocumentacao> documentacaoPendente = repEnvioDocumentacaoLote.BuscarDocumentacaoAutomaticaPendente();
        ...
        private static bool EnviarDocumentacaoFinalizacaoCarga(out string erro, int codigoCarga, Repositorio.UnitOfWork unidadeTrabalho, string stringConexao, AdminMultisoftware.Dominio.Enumeradores.TipoServicoMultisoftware tipoServicoMultisoftware, string adminStringConexao, string host)
        {
            ...
            Servicos.Embarcador.Relatorios.Relatorio serRelatorio = new Servicos.Embarcador.Relatorios.Relatorio(unidadeTrabalho.StringConexao);
            ...
            if (emails != null && emails.Count > 0 && clientesGrupos != null && clientesGrupos.Count > 0)
            {
                ...
                Dominio.Entidades.Embarcador.Terceiros.ContratoFrete contratoFrete = new Dominio.Entidades.Embarcador.Terceiros.ContratoFrete(unitOfWork);
                ...
                byte[] pdfContent = new Servicos.Embarcador.Terceiros.ContratoFrete(stringConexao).GerarFaturaPadrao(contratoFrete, unidadeTrabalho, tipoServicoMultisoftware, relatorioTemp, codigoCarga);
